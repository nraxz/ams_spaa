...
function scHidePage(pageNo) {
	$("#id_form_files_upload_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dateofbirth" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_files_upload_mob_validate_dateofbirth(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_submitted" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_files_upload_mob_validate_submitted(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQMultiUploadAdd(iSeqRow) {
  $("#id_sc_field_image_upload" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_files_upload_mob_ul_save.php",
