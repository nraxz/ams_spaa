<?php
@session_start() ;
$_SESSION['scriptcase']['grid_venue_audition_nested']['sc_process_barr'] = true;
require_once('../grid_venue_audition_nested/index.php');
unset($_SESSION['scriptcase']['grid_venue_audition_nested']['sc_process_barr']);
$ExportCtrl = new grid_venue_audition_nested_export_control;
$ExportCtrl->Export_barr();

class grid_venue_audition_nested_export_control
{
