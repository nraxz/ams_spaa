...
<?php
   ...
   $Ord_Cmp = new grid_venue_audition_nested_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_venue_audition_nested_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       ...
       $tab_converte["address"]   = "address";
   }
   else
   {
       $tab_def_campos['address'] = "";
       $tab_converte[""]   = "address";
   }
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['labels']["address"] : "Address";
   $tab_ger_campos['country'] = "on";
   $tab_def_campos['country'] = "country";
   $tab_converte["country"]   = "country";
   $tab_labels["country"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['labels']["country"])) ? $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['labels']["country"] : "Country";
   $tab_ger_campos['address'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_venue_audition_nested']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_venue_audition_nested']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_venue_audition_nested']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_venue_audition_nested_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_venue_audition_nested']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
