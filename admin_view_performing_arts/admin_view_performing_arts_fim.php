...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_view_performing_arts"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_view_performing_arts"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_view_performing_arts</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_view_performing_arts']['embutida_filho'] as $ind => $sc_init)
          {
