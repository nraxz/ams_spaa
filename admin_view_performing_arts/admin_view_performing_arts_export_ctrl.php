<?php
@session_start() ;
$_SESSION['scriptcase']['admin_view_performing_arts']['sc_process_barr'] = true;
require_once('../admin_view_performing_arts/index.php');
unset($_SESSION['scriptcase']['admin_view_performing_arts']['sc_process_barr']);
$ExportCtrl = new admin_view_performing_arts_export_control;
$ExportCtrl->Export_barr();

class admin_view_performing_arts_export_control
{
