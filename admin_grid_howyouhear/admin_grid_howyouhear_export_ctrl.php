<?php
@session_start() ;
$_SESSION['scriptcase']['admin_grid_howyouhear']['sc_process_barr'] = true;
require_once('../admin_grid_howyouhear/index.php');
unset($_SESSION['scriptcase']['admin_grid_howyouhear']['sc_process_barr']);
$ExportCtrl = new admin_grid_howyouhear_export_control;
$ExportCtrl->Export_barr();

class admin_grid_howyouhear_export_control
{
...
<HEAD>
 <TITLE>How did you hear about :: Excel</TITLE>
