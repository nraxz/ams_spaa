<?php
@session_start() ;
$_SESSION['scriptcase']['admin_contact_detail']['sc_process_barr'] = true;
require_once('../admin_contact_detail/index.php');
unset($_SESSION['scriptcase']['admin_contact_detail']['sc_process_barr']);
$ExportCtrl = new admin_contact_detail_export_control;
$ExportCtrl->Export_barr();

class admin_contact_detail_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> contact_detail :: Excel</TITLE>
