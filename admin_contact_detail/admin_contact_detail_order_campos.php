...
<?php
   ...
   $Ord_Cmp = new admin_contact_detail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class admin_contact_detail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['full_address'] = "on";
   $tab_def_campos['full_address'] = "full_address";
   $tab_converte["full_address"]   = "full_address";
   $tab_labels["full_address"]   = (isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["full_address"])) ? $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["full_address"] : "Full Address";
   $tab_ger_campos['country'] = "on";
   $tab_def_campos['country'] = "country";
   $tab_converte["country"]   = "country";
   $tab_labels["country"]   = (isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["country"])) ? $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["country"] : "Country";
   $tab_ger_campos['contact_number'] = "on";
   $tab_def_campos['contact_number'] = "contact_number";
   $tab_converte["contact_number"]   = "contact_number";
   $tab_labels["contact_number"]   = (isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["contact_number"])) ? $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['labels']["contact_number"] : "Contact Number";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['admin_contact_detail']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['admin_contact_detail']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['admin_contact_detail']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "admin_contact_detail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['admin_contact_detail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
