<?php
@session_start() ;
$_SESSION['scriptcase']['grid_audition_panel_admin']['sc_process_barr'] = true;
require_once('../grid_audition_panel_admin/index.php');
unset($_SESSION['scriptcase']['grid_audition_panel_admin']['sc_process_barr']);
$ExportCtrl = new grid_audition_panel_admin_export_control;
$ExportCtrl->Export_barr();

class grid_audition_panel_admin_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> examiner_panel :: Excel</TITLE>
