...
<?php
   ...
   $Ord_Cmp = new grid_audition_panel_admin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_audition_panel_admin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['panel'] = "panel";
   $tab_converte["panel"]   = "panel";
   $tab_labels["panel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['labels']["panel"])) ? $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['labels']["panel"] : "Panel";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_audition_panel_admin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_audition_panel_admin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
