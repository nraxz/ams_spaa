...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "audition_id";$Nm_numeric[] = "id";$Nm_numeric[] = "audition_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_panel_cond" name="panel_cond" onChange="nm_campos_between(document.getElementById('id_vis_panel'), this, 'panel')">
      ...
      <br><span id="id_hide_panel"  <?php echo $str_hide_panel?>><?php
      if ($panel != "")
      {
      $panel_look = substr($this->Db->qstr($panel), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_audition_id_cond" name="audition_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_audition_id'), this, 'audition_id')">
      ...
      <br><span id="id_hide_audition_id"  <?php echo $str_hide_audition_id?>><INPUT  type="text" id="SC_audition_id" name="audition_id" value="<?php echo NM_encode_input($audition_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
