...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['admin_change_user_password_mob']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['admin_change_user_password_mob']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['admin_change_user_password_mob']['upload_field_info'][ $_POST['param_field'] ];
