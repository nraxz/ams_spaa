  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_admin_change_user_password_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_admin_change_user_password_mob_form();
	}

  // ---------- Validate email
  function do_ajax_admin_change_user_password_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_change_user_password_mob_validate_email(var_email, var_script_case_init, do_ajax_admin_change_user_password_mob_validate_email_cb);
  } // do_ajax_admin_change_user_password_mob_validate_email

  function do_ajax_admin_change_user_password_mob_validate_email_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_change_user_password_mob_validate_email_cb

  // ---------- Validate firstname
  function do_ajax_admin_change_user_password_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_change_user_password_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_admin_change_user_password_mob_validate_firstname_cb);
  } // do_ajax_admin_change_user_password_mob_validate_firstname

  function do_ajax_admin_change_user_password_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_change_user_password_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_admin_change_user_password_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_change_user_password_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_admin_change_user_password_mob_validate_lastname_cb);
  } // do_ajax_admin_change_user_password_mob_validate_lastname

  function do_ajax_admin_change_user_password_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_change_user_password_mob_validate_lastname_cb

  // ---------- Validate new_password
  function do_ajax_admin_change_user_password_mob_validate_new_password()
  {
    var nomeCampo_new_password = "new_password";
    var var_new_password = scAjaxGetFieldText(nomeCampo_new_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_change_user_password_mob_validate_new_password(var_new_password, var_script_case_init, do_ajax_admin_change_user_password_mob_validate_new_password_cb);
  } // do_ajax_admin_change_user_password_mob_validate_new_password

  function do_ajax_admin_change_user_password_mob_validate_new_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "new_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_change_user_password_mob_validate_new_password_cb

  // ---------- Validate confirm_pswd
  function do_ajax_admin_change_user_password_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_change_user_password_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_admin_change_user_password_mob_validate_confirm_pswd_cb);
  } // do_ajax_admin_change_user_password_mob_validate_confirm_pswd

  function do_ajax_admin_change_user_password_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_change_user_password_mob_validate_confirm_pswd_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_admin_change_user_password_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_admin_change_user_password_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_new_password = scAjaxGetFieldText("new_password");
    ...
    scAjaxProcOn();
    x_ajax_admin_change_user_password_mob_submit_form(var_email, var_firstname, var_lastname, var_new_password, var_confirm_pswd, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_admin_change_user_password_mob_submit_form_cb);
  } // do_ajax_admin_change_user_password_mob_submit_form

  function do_ajax_admin_change_user_password_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("new_password");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_admin_change_user_password_mob_submit_form_cb_after_alert);
  } // do_ajax_admin_change_user_password_mob_submit_form_cb
  function do_ajax_admin_change_user_password_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_admin_change_user_password_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_admin_change_user_password_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_admin_change_user_password_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_admin_change_user_password_mob_navigate_form_cb);
  } // do_ajax_admin_change_user_password_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_change_user_password_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_admin_change_user_password_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_admin_change_user_password_mob_navigate_form_cb_after_alert);
  } // do_ajax_admin_change_user_password_mob_navigate_form_cb
  function do_ajax_admin_change_user_password_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_admin_change_user_password_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_admin_change_user_password_mob_navigate_form_cb_after_alert
  function sc_hide_admin_change_user_password_mob_form()
  {
  ...
  ajax_field_list[3] = "new_password";
  ajax_field_list[4] = "confirm_pswd";
  ...
  var ajax_error_list = {
    ...
    "new_password": {"label": "New Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "confirm_pswd": {"label": "Confirm Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["new_password"][1] = "new_password";
  ...
  var ajax_field_id = {
    ...
    "new_password": new Array("hidden_field_label_new_password", "hidden_field_data_new_password"),
