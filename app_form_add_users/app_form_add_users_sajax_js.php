...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate firstname
  function do_ajax_app_form_add_users_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_firstname(var_firstname, var_script_case_init, do_ajax_app_form_add_users_validate_firstname_cb);
  } // do_ajax_app_form_add_users_validate_firstname

  function do_ajax_app_form_add_users_validate_firstname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_app_form_add_users_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_lastname(var_lastname, var_script_case_init, do_ajax_app_form_add_users_validate_lastname_cb);
  } // do_ajax_app_form_add_users_validate_lastname

  function do_ajax_app_form_add_users_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_lastname_cb
  ...
  // ---------- Event onblur email
  function do_ajax_app_form_add_users_event_email_onblur()
  {
    var var_email = scAjaxGetFieldText("email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_add_users_event_email_onblur(var_email, var_script_case_init, do_ajax_app_form_add_users_event_email_onblur_cb);
  } // do_ajax_app_form_add_users_event_email_onblur

  function do_ajax_app_form_add_users_event_email_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app_form_add_users_event_email_onblur_cb_after_alert);
  } // do_ajax_app_form_add_users_event_email_onblur_cb
  function do_ajax_app_form_add_users_event_email_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_form_add_users_event_email_onblur_cb_after_alert

  // ---------- Event onblur login
  function do_ajax_app_form_add_users_event_login_onblur()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_add_users_event_login_onblur(var_script_case_init, do_ajax_app_form_add_users_event_login_onblur_cb);
  } // do_ajax_app_form_add_users_event_login_onblur

  function do_ajax_app_form_add_users_event_login_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app_form_add_users_event_login_onblur_cb_after_alert);
  } // do_ajax_app_form_add_users_event_login_onblur_cb
  function do_ajax_app_form_add_users_event_login_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_form_add_users_event_login_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_add_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_submit_form(var_firstname, var_lastname, var_email, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_submit_form_cb);
