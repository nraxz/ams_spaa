<?php
@session_start() ;
$_SESSION['scriptcase']['admin_view_profile_grade']['sc_process_barr'] = true;
require_once('../admin_view_profile_grade/index.php');
unset($_SESSION['scriptcase']['admin_view_profile_grade']['sc_process_barr']);
$ExportCtrl = new admin_view_profile_grade_export_control;
$ExportCtrl->Export_barr();

class admin_view_profile_grade_export_control
{
...
<HEAD>
 <TITLE>Subjects & Grades :: Excel</TITLE>
