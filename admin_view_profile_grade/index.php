<?php
   include_once('admin_view_profile_grade_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class admin_view_profile_grade_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "admin_view_profile_grade"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/admin_view_profile_grade';
      ...
      if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['admin_view_profile_grade']['actual_lang']) || $_SESSION['scriptcase']['admin_view_profile_grade']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['admin_view_profile_grade']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("admin_view_profile_grade_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["admin_view_profile_grade"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["admin_view_profile_grade"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "admin_view_profile_grade_erro.class.php"); 
      $this->Erro = new admin_view_profile_grade_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('admin_view_profile_grade'); 
// 
      ...
      $str_button = (isset($_SESSION['scriptcase']['str_button_all'])) ? $_SESSION['scriptcase']['str_button_all'] : "scriptcase8_DarkGreen";
      ...
      if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']) && $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil']) && $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['admin_view_profile_grade']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['embutida_init']) 
      {
          if (!isset($_SESSION['p_academic_id'])) 
          {
              $this->nm_falta_var .= "p_academic_id; ";
          }
          if (!isset($_SESSION['mem_login'])) 
          {
              $this->nm_falta_var .= "mem_login; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'admin_view_profile_grade', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'admin_view_profile_grade', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'admin_view_profile_grade', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['admin_view_profile_grade']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class admin_view_profile_grade_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['admin_view_profile_grade']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['admin_view_profile_grade'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class admin_view_profile_grade_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['admin_view_profile_grade']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['admin_view_profile_grade'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_admin_view_profile_grade($cadapar[1]);
                       nm_protect_num_admin_view_profile_grade($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          if (isset($p_academic_id)) 
          {
              $_SESSION['p_academic_id'] = $p_academic_id;
              nm_limpa_str_admin_view_profile_grade($_SESSION["p_academic_id"]);
          }
          if (isset($mem_login)) 
          {
              $_SESSION['mem_login'] = $mem_login;
              nm_limpa_str_admin_view_profile_grade($_SESSION["mem_login"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_ibase'])) 
      { 
          $this->Ini = new admin_view_profile_grade_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_ibase'] = true;
      }
      $this->Ini->Proc_print      = false;
      $this->Ini->Export_html_zip = false;
      $this->Ini->Export_img_zip  = false;
      $this->Ini->Img_export_zip  = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['admin_view_profile_grade']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['admin_view_profile_grade'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['admin_view_profile_grade']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['admin_view_profile_grade']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('admin_view_profile_grade') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['admin_view_profile_grade']['label'] = "Subjects & Grades";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "admin_view_profile_grade")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("en_us");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "admin_view_profile_grade/admin_view_profile_grade_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "admin_view_profile_grade_erro.class.php"); 
      } 
      $this->Erro      = new admin_view_profile_grade_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "admin_view_profile_grade/admin_view_profile_grade_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "admin_view_profile_grade_lookup.class.php"); 
      } 
      $this->Lookup       = new admin_view_profile_grade_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_admin_view_profile_grade_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['save_grid'] = true;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "admin_view_profile_grade_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "admin_view_profile_grade_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['xls_return'] = ($nmgp_opcao == "xls") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['csv_return'] = ($nmgp_opcao == "csv") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['xml_return'] = ($nmgp_opcao == "xml") ? "volta_grid" : "resumo"; 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_admin_view_profile_grade_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_admin_view_profile_grade_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "xml_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['proc_pdf']      = (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['proc_pdf_vert'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['field_order'][] = "subject";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['field_order'][] = "grades";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['field_order'][] = "level";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel']['level'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['admin_view_profile_grade']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['admin_view_profile_grade']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['admin_view_profile_grade']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['admin_view_profile_grade']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['admin_view_profile_grade']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig'] = " where academic_id = '" . $_SESSION['p_academic_id'] . "' AND login= '" . $_SESSION['mem_login'] . "'";
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_pesq_ant']   = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['cond_pesq'] = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['tot_geral']);
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['where_pesq_ant'];  
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_admin_view_profile_grade_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_admin_view_profile_grade.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_admin_view_profile_grade_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_admin_view_profile_grade_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_admin_view_profile_grade_res_" . session_id() . ".doc";
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . admin_view_profile_grade . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new admin_view_profile_grade_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "admin_view_profile_grade_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "admin_view_profile_grade_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new admin_view_profile_grade_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "admin_view_profile_grade/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new admin_view_profile_grade_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_admin_view_profile_grade_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "admin_view_profile_grade/admin_view_profile_grade_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "admin_view_profile_grade_grid.class.php"); 
          } 
          $this->grid  = new admin_view_profile_grade_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if (!is_file($nm_arquivo_pdf_serv))
...
<?php
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp'] . "/");
...
<HEAD>
 <TITLE>Subjects & Grades :: Doc</TITLE>
...
<form name="Fdown" method="get" action="admin_view_profile_grade_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="admin_view_profile_grade"> 
...
$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
$_SESSION['sc_session'][$this->Ini->sc_page]['admin_view_profile_grade'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['admin_view_profile_grade']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_admin_view_profile_grade($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_admin_view_profile_grade($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['admin_view_profile_grade']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "admin_view_profile_grade") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
               $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['admin_view_profile_grade']['master_pai']) && $_SESSION['sc_session'][$init_filho]['admin_view_profile_grade']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['admin_view_profile_grade']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']);
               $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['admin_view_profile_grade']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['admin_view_profile_grade']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['admin_view_profile_grade']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['protect_modal']) && !empty($_SESSION['scriptcase']['admin_view_profile_grade']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['admin_view_profile_grade']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "admin_view_profile_grade";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'admin_view_profile_grade' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/admin_view_profile_grade/'))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "en_us";
   if (isset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetAmour/Sc9_SweetAmour";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'admin_view_profile_grade')
   {
       $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/admin_view_profile_grade_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = $nmgp_opcao ;  
       }   
       if (isset($_POST["p_academic_id"])) 
       {
           $_SESSION["p_academic_id"] = $_POST["p_academic_id"];
           nm_limpa_str_admin_view_profile_grade($_SESSION["p_academic_id"]);
       }
       if (isset($_GET["p_academic_id"])) 
       {
           $_SESSION["p_academic_id"] = $_GET["p_academic_id"];
           nm_limpa_str_admin_view_profile_grade($_SESSION["p_academic_id"]);
       }
       if (!isset($_SESSION["p_academic_id"])) 
       {
           $_SESSION["p_academic_id"] = "";
       }
       if (isset($_POST["mem_login"])) 
       {
           $_SESSION["mem_login"] = $_POST["mem_login"];
           nm_limpa_str_admin_view_profile_grade($_SESSION["mem_login"]);
       }
       if (isset($_GET["mem_login"])) 
       {
           $_SESSION["mem_login"] = $_GET["mem_login"];
           nm_limpa_str_admin_view_profile_grade($_SESSION["mem_login"]);
       }
       if (!isset($_SESSION["mem_login"])) 
       {
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['volta_redirect_tp'] = "";
           $nm_url_saida = "admin_view_profile_grade_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['sc_modal'] = true;
               }
               $nm_url_saida = "admin_view_profile_grade_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['admin_view_profile_grade'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['admin_view_profile_grade'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opc_psq'] && !isset($_SESSION['scriptcase']['admin_view_profile_grade']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['admin_view_profile_grade']) || $_SESSION['scriptcase']['sc_apl_seg']['admin_view_profile_grade'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("admin_view_profile_grade", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
...
<?php
       ...
       $contr_admin_view_profile_grade = new admin_view_profile_grade_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = "busca";
          $contr_admin_view_profile_grade->NM_ajax_flag = true;
          $contr_admin_view_profile_grade->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = "busca";
          $contr_admin_view_profile_grade->NM_ajax_flag = true;
          $contr_admin_view_profile_grade->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = "busca";
          $contr_admin_view_profile_grade->NM_ajax_flag = true;
          $contr_admin_view_profile_grade->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['opcao'] = "busca";
          $contr_admin_view_profile_grade->NM_ajax_flag = true;
          $contr_admin_view_profile_grade->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_admin_view_profile_grade->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['admin_view_profile_grade']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_admin_view_profile_grade(&$str)
   {
   ...
   function nm_protect_num_admin_view_profile_grade($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function admin_view_profile_grade_pack_protect_string($sString)
   {
