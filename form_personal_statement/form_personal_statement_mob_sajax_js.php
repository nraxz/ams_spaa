  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_personal_statement_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_personal_statement_mob_form();
	}

  // ---------- Validate label
  function do_ajax_form_personal_statement_mob_validate_label()
  {
  } // do_ajax_form_personal_statement_mob_validate_label

  function do_ajax_form_personal_statement_mob_validate_label_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_statement_mob_validate_label_cb

  // ---------- Validate explaination
  function do_ajax_form_personal_statement_mob_validate_explaination()
  {
    var nomeCampo_explaination = "explaination";
    var var_explaination = scAjaxGetFieldText(nomeCampo_explaination);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_personal_statement_mob_validate_explaination(var_explaination, var_script_case_init, do_ajax_form_personal_statement_mob_validate_explaination_cb);
  } // do_ajax_form_personal_statement_mob_validate_explaination

  function do_ajax_form_personal_statement_mob_validate_explaination_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "explaination";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_personal_statement_mob_validate_explaination_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_personal_statement_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_personal_statement_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_label = scAjaxGetFieldHidden("label");
    var var_explaination = scAjaxGetFieldText("explaination");
    ...
    scAjaxProcOn();
    x_ajax_form_personal_statement_mob_submit_form(var_label, var_explaination, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_personal_statement_mob_submit_form_cb);
  } // do_ajax_form_personal_statement_mob_submit_form

  function do_ajax_form_personal_statement_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("explaination");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_personal_statement_mob_submit_form_cb_after_alert);
  } // do_ajax_form_personal_statement_mob_submit_form_cb
  function do_ajax_form_personal_statement_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_personal_statement_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_personal_statement_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_personal_statement_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_personal_statement_mob_navigate_form_cb);
  } // do_ajax_form_personal_statement_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_personal_statement_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_personal_statement_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_personal_statement_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_personal_statement_mob_navigate_form_cb
  function do_ajax_form_personal_statement_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_personal_statement_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_personal_statement_mob_navigate_form_cb_after_alert
  function sc_hide_form_personal_statement_mob_form()
  {
  ...
  ajax_field_list[0] = "label";
  ajax_field_list[1] = "explaination";
  ...
  var ajax_error_list = {
    ...
    "explaination": {"label": "Personal Statement", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "label": new Array(),
    "explaination": new Array()
  };
  ajax_field_mult["label"][1] = "label";
  ajax_field_mult["explaination"][1] = "explaination";

  var ajax_field_id = {
    "label": new Array("hidden_field_label_label", "hidden_field_data_label"),
    "explaination": new Array("hidden_field_label_explaination", "hidden_field_data_explaination")
  };
