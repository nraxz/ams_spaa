<?php
   include_once('application_guide_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['application_guide']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['application_guide']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['application_guide']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['application_guide']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['application_guide']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['application_guide']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['application_guide']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['application_guide']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['application_guide']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['application_guide']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['application_guide']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class application_guide_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['application_guide']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "application_guide"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['application_guide']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['application_guide']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['application_guide']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['application_guide']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/application_guide';
      ...
      if (isset($_SESSION['scriptcase']['application_guide']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['application_guide']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['application_guide']['actual_lang']) || $_SESSION['scriptcase']['application_guide']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['application_guide']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("application_guide_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['application_guide']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['application_guide']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["application_guide"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["application_guide"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['application_guide']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['application_guide']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['application_guide']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['application_guide']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "application_guide_erro.class.php"); 
      $this->Erro = new application_guide_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('application_guide'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['application_guide']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['application_guide']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['application_guide']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['application_guide']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['application_guide']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['application_guide']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['application_guide']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['application_guide']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['application_guide']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']) && $_SESSION['scriptcase']['application_guide']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['application_guide']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['application_guide']['glo_nm_perfil']) && $_SESSION['scriptcase']['application_guide']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['application_guide']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['application_guide']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['application_guide']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['application_guide']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['application_guide']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['application_guide']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['application_guide']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['application_guide']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['application_guide']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['application_guide']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['application_guide']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['application_guide']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'application_guide', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'application_guide', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'application_guide', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['application_guide']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new application_guide_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_guide']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['application_guide']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['application_guide']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['application_guide'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_guide']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_guide']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('application_guide') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_guide']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_guide']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_guide']['Gera_log_access'] = false;
      }
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_guide']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['application_guide']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['application_guide']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "application_guide_erro.class.php"); 
      $this->Erro      = new application_guide_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['application_guide']['contr_erro'] = 'on';
 echo "<ul>
<li>Register for an online account using your full name (as it appears on your passport), a personal email address and a password of your choice - this should not be a parent/guardian or agent's email address unless you will be under 18 years of age on the 1st September of the year of entry. Please do not create multiple logins, if you encounter any difficulty logging in please email <span id='cloak05797037580adacf8cf3755a0f4bf6a5'><a href='mailto:admissions@londonstudiocentre.ac.uk'>admissions@londonstudiocentre.ac.uk</a></span><script type='text/javascript'>
				document.getElementById('cloak05797037580adacf8cf3755a0f4bf6a5').innerHTML = '';
				var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
				var path = 'hr' + 'ef' + '=';
				var addy05797037580adacf8cf3755a0f4bf6a5 = '&#97;dm&#105;ss&#105;&#111;ns' + '&#64;';
				addy05797037580adacf8cf3755a0f4bf6a5 = addy05797037580adacf8cf3755a0f4bf6a5 + 'l&#111;nd&#111;nst&#117;d&#105;&#111;c&#101;ntr&#101;' + '&#46;' + '&#97;c' + '&#46;' + '&#117;k';
				var addy_text05797037580adacf8cf3755a0f4bf6a5 = '&#97;dm&#105;ss&#105;&#111;ns' + '&#64;' + 'l&#111;nd&#111;nst&#117;d&#105;&#111;c&#101;ntr&#101;' + '&#46;' + '&#97;c' + '&#46;' + '&#117;k';document.getElementById('cloak05797037580adacf8cf3755a0f4bf6a5').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy05797037580adacf8cf3755a0f4bf6a5 + '\'>'+addy_text05797037580adacf8cf3755a0f4bf6a5+'<\/a>';
		</script></li>
<li>Complete each section of the form in full. The academic section must include details of all qualifications, including those to be taken during the current academic year, the Performing Arts Training section should include all details of your dance training regardless of whether you have taken syllabus-based dance exams. Please do not leave any section blank.</li>
<li>Upload two digital photographs: one head and shoulders photograph and one full length photograph in close fitting dancewear. Full length photographs should be taken in portrait orientation with a plain background.</li>
<li>Upload two written references, one academic reference from your current school or college, and one dance reference from your current dance teacher. References can also be emailed to&nbsp;<span id='cloak3c38cc36759c026bb85c2f14d2a91173'><a href='mailto:admissions@londonstudiocentre.ac.uk'>admissions@londonstudiocentre.ac.uk</a></span><script type='text/javascript'>
				document.getElementById('cloak3c38cc36759c026bb85c2f14d2a91173').innerHTML = '';
				var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
				var path = 'hr' + 'ef' + '=';
				var addy3c38cc36759c026bb85c2f14d2a91173 = '&#97;dm&#105;ss&#105;&#111;ns' + '&#64;';
				addy3c38cc36759c026bb85c2f14d2a91173 = addy3c38cc36759c026bb85c2f14d2a91173 + 'l&#111;nd&#111;nst&#117;d&#105;&#111;c&#101;ntr&#101;' + '&#46;' + '&#97;c' + '&#46;' + '&#117;k';
				var addy_text3c38cc36759c026bb85c2f14d2a91173 = '&#97;dm&#105;ss&#105;&#111;ns' + '&#64;' + 'l&#111;nd&#111;nst&#117;d&#105;&#111;c&#101;ntr&#101;' + '&#46;' + '&#97;c' + '&#46;' + '&#117;k';document.getElementById('cloak3c38cc36759c026bb85c2f14d2a91173').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy3c38cc36759c026bb85c2f14d2a91173 + '\'>'+addy_text3c38cc36759c026bb85c2f14d2a91173+'<\/a>';
		</script>.</li>
<li>Submit your form where you will be directed to the PayPal payment page. If you do not have a PayPal account, you can check out as a guest and pay by debit or credit card. The £45 fee is non-refundable.</li>
<li>Following successful payment you will receive confirmation that your form has been successfully submitted.</li>
</ul>";
$_SESSION['scriptcase']['application_guide']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_application_guide($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['application_guide']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "application_guide") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['application_guide']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['application_guide']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['application_guide']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
               $_SESSION['scriptcase']['application_guide']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "application_guide";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'application_guide' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['application_guide']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['application_guide']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['application_guide']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('application_guide' == $sReferer || 'application_guide_' == substr($sReferer, 0, 18))
       {
           $_SESSION['sc_session'][$script_case_init]['application_guide']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['application_guide']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['application_guide']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'application_guide')
   {
       $_SESSION['sc_session'][$script_case_init]['application_guide']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['application_guide']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/application_guide_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_application_guide($cadapar[1]);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['application_guide'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['application_guide']['opc_psq'] && !isset($_SESSION['scriptcase']['application_guide']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['application_guide']) || $_SESSION['scriptcase']['sc_apl_seg']['application_guide'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['application_guide']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("application_guide", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_application_guide = new application_guide_apl();
   $contr_application_guide->controle();
//
   function nm_limpa_str_application_guide(&$str)
   {
