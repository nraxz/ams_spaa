<?php
@session_start() ;
$_SESSION['scriptcase']['admin_grid_applicants_audition']['sc_process_barr'] = true;
require_once('../admin_grid_applicants_audition/index.php');
unset($_SESSION['scriptcase']['admin_grid_applicants_audition']['sc_process_barr']);
$ExportCtrl = new admin_grid_applicants_audition_export_control;
$ExportCtrl->Export_barr();

class admin_grid_applicants_audition_export_control
{
