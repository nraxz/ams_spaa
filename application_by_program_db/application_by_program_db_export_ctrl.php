<?php
@session_start() ;
$_SESSION['scriptcase']['application_by_program_db']['sc_process_barr'] = true;
require_once('../application_by_program_db/index.php');
unset($_SESSION['scriptcase']['application_by_program_db']['sc_process_barr']);
$ExportCtrl = new application_by_program_db_export_control;
$ExportCtrl->Export_barr();

class application_by_program_db_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> application_detail :: Excel</TITLE>
