...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_application_data"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_application_data"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_application_data']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_application_data']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_application_data']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_application_data']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_application_data']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_application_data</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_application_data']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_application_data']['embutida_filho'] as $ind => $sc_init)
          {
