...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_grid_ethnicity"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_grid_ethnicity"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['admin_form_ethnicity'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_grid_ethnicity</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_grid_ethnicity']['embutida_filho'] as $ind => $sc_init)
          {
