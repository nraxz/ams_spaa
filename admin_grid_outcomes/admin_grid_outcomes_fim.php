...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_grid_outcomes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_grid_outcomes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['admin_form_outcomes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_grid_outcomes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_grid_outcomes']['embutida_filho'] as $ind => $sc_init)
          {
