...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_all_applicants"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_all_applicants"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_admin_all_applicants</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_admin_all_applicants']['embutida_filho'] as $ind => $sc_init)
          {
