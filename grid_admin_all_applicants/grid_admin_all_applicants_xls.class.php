...
class grid_admin_all_applicants_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_admin_all_applicants_res_xls.class.php");
              $this->Res_xls = new grid_admin_all_applicants_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_admin_all_applicants.zip";
          $this->Arquivo   .= "_grid_admin_all_applicants" . $this->Xls_tp;
          $this->Tit_doc    = "grid_admin_all_applicants" . $this->Xls_tp;
          $this->Tit_zip    = "grid_admin_all_applicants.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_application_detail_audition_id = ($this->application_detail_audition_id == "") ? " is null " : " = " . $this->application_detail_audition_id;
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_image_upload_image_headshot()
   {
         ...
         { 
             ...
             $objDrawing->setName($this->image_upload_image_headshot);
             $objDrawing->setPath($in_image_upload_image_headshot);
   ...
   function NM_export_basic_information_firstname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_firstname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_firstname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_basic_information_lastname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_lastname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_lastname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_basic_information_dateofbirth()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->basic_information_dateofbirth = substr($this->basic_information_dateofbirth, 0, 10);
         if (empty($this->basic_information_dateofbirth) || $this->basic_information_dateofbirth == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_dateofbirth, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->basic_information_dateofbirth, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->basic_information_dateofbirth);
   ...
   function NM_export_basic_information_gender()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_basic_information_gender, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_basic_information_gender, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sec_users_email
   function NM_export_sec_users_email()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             ...
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sec_users_email, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_application_detail_payment_status()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->application_detail_payment_status, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->application_detail_payment_status, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- view
   function NM_export_view()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             ...
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_application_detail_id()
   {
         ...
         if (is_numeric($this->application_detail_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->application_detail_id);
         $this->Xls_col++;
   }
   ...
   function NM_export_application_detail_number()
   {
         ...
         if (is_numeric($this->application_detail_number))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->application_detail_number);
         $this->Xls_col++;
   }
   ...
   function NM_export_application_detail_venue_id()
   {
         ...
         if (is_numeric($this->application_detail_venue_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->application_detail_venue_id);
         $this->Xls_col++;
   }
   ...
   function NM_export_application_detail_audition_id()
   {
         ...
         if (is_numeric($this->application_detail_audition_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
   ...
   function NM_sub_cons_image_upload_image_headshot()
   {
         ...
         if (is_file($in_image_upload_image_headshot))
         { 
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $in_image_upload_image_headshot;
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "img";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['name'] = $this->image_upload_image_headshot;
         } 
         else 
         { 
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
   ...
   //----- basic_information_firstname
   function NM_sub_cons_basic_information_firstname()
   {
         $this->basic_information_firstname = html_entity_decode($this->basic_information_firstname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->basic_information_firstname = strip_tags($this->basic_information_firstname);
         if (!NM_is_utf8($this->basic_information_firstname))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->basic_information_firstname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- basic_information_lastname
   function NM_sub_cons_basic_information_lastname()
   {
         $this->basic_information_lastname = html_entity_decode($this->basic_information_lastname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->basic_information_lastname = strip_tags($this->basic_information_lastname);
         if (!NM_is_utf8($this->basic_information_lastname))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->basic_information_lastname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- basic_information_dateofbirth
   function NM_sub_cons_basic_information_dateofbirth()
   {
         $this->basic_information_dateofbirth = substr($this->basic_information_dateofbirth, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->basic_information_dateofbirth;
   ...
   //----- basic_information_gender
   function NM_sub_cons_basic_information_gender()
   {
         $this->look_basic_information_gender = html_entity_decode($this->look_basic_information_gender, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_basic_information_gender = strip_tags($this->look_basic_information_gender);
         if (!NM_is_utf8($this->look_basic_information_gender))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_basic_information_gender;
   ...
   //----- sec_users_email
   function NM_sub_cons_sec_users_email()
   {
         $this->sec_users_email = html_entity_decode($this->sec_users_email, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sec_users_email = strip_tags($this->sec_users_email);
         if (!NM_is_utf8($this->sec_users_email))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sec_users_email;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- application_detail_payment_status
   function NM_sub_cons_application_detail_payment_status()
   {
         $this->application_detail_payment_status = html_entity_decode($this->application_detail_payment_status, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->application_detail_payment_status = strip_tags($this->application_detail_payment_status);
         if (!NM_is_utf8($this->application_detail_payment_status))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->application_detail_payment_status;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- application_detail_id
   function NM_sub_cons_application_detail_id()
   {
         if (!NM_is_utf8($this->application_detail_id))
         {
             $this->application_detail_id = sc_convert_encoding($this->application_detail_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->application_detail_id;
   ...
   //----- application_detail_number
   function NM_sub_cons_application_detail_number()
   {
         if (!NM_is_utf8($this->application_detail_number))
         {
             $this->application_detail_number = sc_convert_encoding($this->application_detail_number, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->application_detail_number;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- application_detail_venue_id
   function NM_sub_cons_application_detail_venue_id()
   {
         if (!NM_is_utf8($this->application_detail_venue_id))
         {
             $this->application_detail_venue_id = sc_convert_encoding($this->application_detail_venue_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->application_detail_venue_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- application_detail_audition_id
   function NM_sub_cons_application_detail_audition_id()
   {
         if (!NM_is_utf8($this->application_detail_audition_id))
         {
             $this->application_detail_audition_id = sc_convert_encoding($this->application_detail_audition_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->application_detail_audition_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
 ...
 function quebra_application_detail_audition_id_venue($application_detail_venue_id, $application_detail_audition_id) 
 {
   ...
   function quebra_application_detail_venue_id_venue_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_application_detail_audition_id_venue_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>All Application :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_admin_all_applicants']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
