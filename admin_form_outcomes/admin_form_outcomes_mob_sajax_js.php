  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_admin_form_outcomes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_admin_form_outcomes_mob_form();
	}

  // ---------- Validate title
  function do_ajax_admin_form_outcomes_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_outcomes_mob_validate_title(var_title, var_script_case_init, do_ajax_admin_form_outcomes_mob_validate_title_cb);
  } // do_ajax_admin_form_outcomes_mob_validate_title

  function do_ajax_admin_form_outcomes_mob_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_outcomes_mob_validate_title_cb

  // ---------- Validate email_message
  function do_ajax_admin_form_outcomes_mob_validate_email_message()
  {
    var nomeCampo_email_message = "email_message";
    var var_email_message = scAjaxGetFieldText(nomeCampo_email_message);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_outcomes_mob_validate_email_message(var_email_message, var_script_case_init, do_ajax_admin_form_outcomes_mob_validate_email_message_cb);
  } // do_ajax_admin_form_outcomes_mob_validate_email_message

  function do_ajax_admin_form_outcomes_mob_validate_email_message_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_outcomes_mob_validate_email_message_cb

  // ---------- Validate is_offer
  function do_ajax_admin_form_outcomes_mob_validate_is_offer()
  {
    var nomeCampo_is_offer = "is_offer";
    var var_is_offer = scAjaxGetFieldSelect(nomeCampo_is_offer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_outcomes_mob_validate_is_offer(var_is_offer, var_script_case_init, do_ajax_admin_form_outcomes_mob_validate_is_offer_cb);
  } // do_ajax_admin_form_outcomes_mob_validate_is_offer

  function do_ajax_admin_form_outcomes_mob_validate_is_offer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_outcomes_mob_validate_is_offer_cb

  // ---------- Validate deposit_amount
  function do_ajax_admin_form_outcomes_mob_validate_deposit_amount()
  {
    var nomeCampo_deposit_amount = "deposit_amount";
    var var_deposit_amount = scAjaxGetFieldText(nomeCampo_deposit_amount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_outcomes_mob_validate_deposit_amount(var_deposit_amount, var_script_case_init, do_ajax_admin_form_outcomes_mob_validate_deposit_amount_cb);
  } // do_ajax_admin_form_outcomes_mob_validate_deposit_amount

  function do_ajax_admin_form_outcomes_mob_validate_deposit_amount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_outcomes_mob_validate_deposit_amount_cb

  // ---------- Validate active
  function do_ajax_admin_form_outcomes_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_outcomes_mob_validate_active(var_active, var_script_case_init, do_ajax_admin_form_outcomes_mob_validate_active_cb);
  } // do_ajax_admin_form_outcomes_mob_validate_active

  function do_ajax_admin_form_outcomes_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_outcomes_mob_validate_active_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_admin_form_outcomes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_admin_form_outcomes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_admin_form_outcomes_mob_submit_form(var_title, var_email_message, var_is_offer, var_deposit_amount, var_active, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_admin_form_outcomes_mob_submit_form_cb);
  } // do_ajax_admin_form_outcomes_mob_submit_form

  function do_ajax_admin_form_outcomes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_admin_form_outcomes_mob_submit_form_cb_after_alert);
  } // do_ajax_admin_form_outcomes_mob_submit_form_cb
  function do_ajax_admin_form_outcomes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_admin_form_outcomes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_admin_form_outcomes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_admin_form_outcomes_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_admin_form_outcomes_mob_navigate_form_cb);
  } // do_ajax_admin_form_outcomes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_admin_form_outcomes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_admin_form_outcomes_mob_navigate_form_cb_after_alert);
  } // do_ajax_admin_form_outcomes_mob_navigate_form_cb
  function do_ajax_admin_form_outcomes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_admin_form_outcomes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_admin_form_outcomes_mob_navigate_form_cb_after_alert
  function sc_hide_admin_form_outcomes_mob_form()
  {
