...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("admin_form_outcomes_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('admin_form_outcomes_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("admin_form_outcomes_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['admin_form_outcomes'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['admin_form_outcomes'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_message_label" id="hidden_field_label_email_message" style="<?php echo $sStyleHidden_email_message; ?>"><span id="id_label_email_message"><?php echo $this->nm_new_label['email_message']; ?></span></TD>
    <TD class="scFormDataOdd css_email_message_line" id="hidden_field_data_email_message" style="<?php echo $sStyleHidden_email_message; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_message_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_is_offer_label" id="hidden_field_label_is_offer" style="<?php echo $sStyleHidden_is_offer; ?>"><span id="id_label_is_offer"><?php echo $this->nm_new_label['is_offer']; ?></span></TD>
    <TD class="scFormDataOdd css_is_offer_line" id="hidden_field_data_is_offer" style="<?php echo $sStyleHidden_is_offer; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_is_offer_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['Lookup_is_offer'][] = ''; ?>
 <option value=""></option>
 <option  value="Yes" <?php  if ($this->is_offer == "Yes") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['Lookup_is_offer'][] = 'Yes'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_deposit_amount_label" id="hidden_field_label_deposit_amount" style="<?php echo $sStyleHidden_deposit_amount; ?>"><span id="id_label_deposit_amount"><?php echo $this->nm_new_label['deposit_amount']; ?></span></TD>
    <TD class="scFormDataOdd css_deposit_amount_line" id="hidden_field_data_deposit_amount" style="<?php echo $sStyleHidden_deposit_amount; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_deposit_amount_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("admin_form_outcomes");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("admin_form_outcomes");
 parent.scAjaxDetailHeight("admin_form_outcomes", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_outcomes']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
