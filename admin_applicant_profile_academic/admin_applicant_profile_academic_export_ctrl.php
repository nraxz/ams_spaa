<?php
@session_start() ;
$_SESSION['scriptcase']['admin_applicant_profile_academic']['sc_process_barr'] = true;
require_once('../admin_applicant_profile_academic/index.php');
unset($_SESSION['scriptcase']['admin_applicant_profile_academic']['sc_process_barr']);
$ExportCtrl = new admin_applicant_profile_academic_export_control;
$ExportCtrl->Export_barr();

class admin_applicant_profile_academic_export_control
{
...
<HEAD>
 <TITLE>Academic Qualification :: Excel</TITLE>
