...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("dashboard_super") . "/dashboard_super_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_super']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['dashboard_super'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_venue") . "/grid_smtt_interview_venue_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_venue") . "/grid_smtt_interview_venue_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_venue_pending") . "/grid_smtt_interview_venue_pending_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_venue_pending") . "/grid_smtt_interview_venue_pending_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_outreach_audition") . "/form_outreach_audition_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_outreach_audition") . "/form_outreach_audition_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_smtt_interview") . "/form_smtt_interview_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_smtt_interview") . "/form_smtt_interview_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_super") . "/grid_smtt_interview_super_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_super") . "/grid_smtt_interview_super_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_marking_active") . "/grid_smtt_interview_marking_active_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_marking_active") . "/grid_smtt_interview_marking_active_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_marking_complete") . "/grid_smtt_interview_marking_complete_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_marking_complete") . "/grid_smtt_interview_marking_complete_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_ListToSetOutcomes") . "/grid_smtt_interview_ListToSetOutcomes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_ListToSetOutcomes") . "/grid_smtt_interview_ListToSetOutcomes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_ListToPublishOutcomes") . "/grid_smtt_interview_ListToPublishOutcomes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_ListToPublishOutcomes") . "/grid_smtt_interview_ListToPublishOutcomes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_allPublishedOutcomes") . "/grid_smtt_interview_allPublishedOutcomes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_allPublishedOutcomes") . "/grid_smtt_interview_allPublishedOutcomes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_smtt_outcomes") . "/form_smtt_outcomes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_smtt_outcomes") . "/form_smtt_outcomes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_outcomes") . "/grid_smtt_outcomes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_outcomes") . "/grid_smtt_outcomes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_change_date") . "/grid_smtt_interview_change_date_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_smtt_interview_change_date") . "/grid_smtt_interview_change_date_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$firstname = get_tname($get_login);
$surname = $this->get_surname($get_login);
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "SMTT interviews summary";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Foundation applicants";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "New ALRA HQ audition";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "New ALRA Outreach";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[11]))
{
 ...
 $nm_var_lab[12] = "Approved auditions";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[12]))
{
 ...
 $nm_var_lab[13] = "Completed audition";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[13]))
{
 ...
 $nm_var_lab[14] = "Pending & Rejected auditions";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[14]))
{
 ...
 $nm_var_lab[15] = "Create interview date";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[15]))
{
 ...
 $nm_var_lab[16] = "View update SMTT interviews";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[17]))
{
 ...
 $nm_var_lab[18] = "Active auditions";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[18]))
{
 ...
 $nm_var_lab[19] = "Complete auditions";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[19]))
{
 ...
 $nm_var_lab[20] = "Set audition outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[20]))
{
 ...
 $nm_var_lab[21] = "Audition outcomes status";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[21]))
{
 ...
 $nm_var_lab[22] = "SMTT interview report";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[22]))
{
 ...
 $nm_var_lab[23] = "Active SMTT interviews";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[23]))
{
 ...
 $nm_var_lab[24] = "Complete SMTT interviews";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[24]))
{
 ...
 $nm_var_lab[25] = "Set SMTT outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[25]))
{
 ...
 $nm_var_lab[26] = "Publish SMTT outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[26]))
{
 ...
 $nm_var_lab[27] = "View all SMTT outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[27]))
{
 ...
 $nm_var_lab[28] = "Official settings";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[28]))
{
 ...
 $nm_var_lab[29] = "New audition outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[29]))
{
 ...
 $nm_var_lab[30] = "All audition outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[30]))
{
 ...
 $nm_var_lab[31] = "New SMTT outcomes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[31]))
{
 ...
 $nm_var_lab[32] = "All SMTT outcomes";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[33]))
{
 ...
 $nm_var_lab[34] = "Audition Date change";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[34]))
{
 ...
 $nm_var_lab[35] = "Interview Date change";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[36]))
{
 ...
 $nm_var_hint[37] = "ALRA official website";
...
$app_menu1_menuData['data'] .= "item_16|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_all_members']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_all_members']) == "on")
{
    $app_menu1_menuData['data'] .= "item_15|..|" . $nm_var_lab[1] . "|app_menu1_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_all_members&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_18|..|" . $nm_var_lab[2] . "|app_menu1_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_applicants_glance&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_19|..|" . $nm_var_lab[3] . "|app_menu1_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_applicants_finished&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue']) == "on")
{
    $app_menu1_menuData['data'] .= "item_17|..|" . $nm_var_lab[4] . "|app_menu1_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_smtt_interview_venue&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_21|.|" . $nm_var_lab[5] . "||" . $nm_var_hint[5] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_22|..|" . $nm_var_lab[6] . "|app_menu1_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_foundation_applicants_pending&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending']) == "on")
{
    $app_menu1_menuData['data'] .= "item_23|..|" . $nm_var_lab[7] . "|app_menu1_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_smtt_interview_venue_pending&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_13|.|" . $nm_var_lab[8] . "||" . $nm_var_hint[8] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_29|..|" . $nm_var_lab[9] . "|app_menu1_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_audition_location_summary&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_9|..|" . $nm_var_lab[10] . "|app_menu1_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_audition_location&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition']) == "on")
{
    $app_menu1_menuData['data'] .= "item_11|..|" . $nm_var_lab[11] . "|app_menu1_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_outreach_audition&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_12|..|" . $nm_var_lab[12] . "|app_menu1_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_audition_location_edit&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_24|..|" . $nm_var_lab[13] . "|app_menu1_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_audition_location_finished&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_25|..|" . $nm_var_lab[14] . "|app_menu1_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_audition_location_pending_rejected&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview']) == "on")
{
    $app_menu1_menuData['data'] .= "item_30|..|" . $nm_var_lab[15] . "|app_menu1_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_smtt_interview&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super']) == "on")
{
    $app_menu1_menuData['data'] .= "item_31|..|" . $nm_var_lab[16] . "|app_menu1_form_php.php?sc_item_menu=item_31&sc_apl_menu=grid_smtt_interview_super&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_26|.|" . $nm_var_lab[17] . "||" . $nm_var_hint[17] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_14|..|" . $nm_var_lab[18] . "|app_menu1_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_audition_location_super&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_27|..|" . $nm_var_lab[19] . "|app_menu1_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_audition_location_super_complete&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_32|..|" . $nm_var_lab[20] . "|app_menu1_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_audition_location_super_outcome_setting&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[20] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_33|..|" . $nm_var_lab[21] . "|app_menu1_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_applicant_admission_outcome&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[21] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_38|.|" . $nm_var_lab[22] . "||" . $nm_var_hint[22] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active']) == "on")
{
    $app_menu1_menuData['data'] .= "item_34|..|" . $nm_var_lab[23] . "|app_menu1_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_smtt_interview_marking_active&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[23] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete']) == "on")
{
    $app_menu1_menuData['data'] .= "item_35|..|" . $nm_var_lab[24] . "|app_menu1_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_smtt_interview_marking_complete&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[24] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes']) == "on")
{
    $app_menu1_menuData['data'] .= "item_36|..|" . $nm_var_lab[25] . "|app_menu1_form_php.php?sc_item_menu=item_36&sc_apl_menu=grid_smtt_interview_ListToSetOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[25] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes']) == "on")
{
    $app_menu1_menuData['data'] .= "item_37|..|" . $nm_var_lab[26] . "|app_menu1_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_smtt_interview_ListToPublishOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[26] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes']) == "on")
{
    $app_menu1_menuData['data'] .= "item_40|..|" . $nm_var_lab[27] . "|app_menu1_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_smtt_interview_allPublishedOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[27] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_41|.|" . $nm_var_lab[28] . "||" . $nm_var_hint[28] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_42|..|" . $nm_var_lab[29] . "|app_menu1_form_php.php?sc_item_menu=item_42&sc_apl_menu=form_audition_outcomes_new&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[29] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
{
    $app_menu1_menuData['data'] .= "item_47|..|" . $nm_var_lab[30] . "|app_menu1_form_php.php?sc_item_menu=item_47&sc_apl_menu=admin_grid_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[30] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes']) == "on")
{
    $app_menu1_menuData['data'] .= "item_43|..|" . $nm_var_lab[31] . "|app_menu1_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_smtt_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[31] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes']) == "on")
{
    $app_menu1_menuData['data'] .= "item_48|..|" . $nm_var_lab[32] . "|app_menu1_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_smtt_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[32] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_44|.|" . $nm_var_lab[33] . "||" . $nm_var_hint[33] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_45|..|" . $nm_var_lab[34] . "|app_menu1_form_php.php?sc_item_menu=item_45&sc_apl_menu=grid_applicants_change_audition&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[34] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date']) == "on")
{
    $app_menu1_menuData['data'] .= "item_46|..|" . $nm_var_lab[35] . "|app_menu1_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_smtt_interview_change_date&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[35] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}

$app_menu1_menuData['data'] .= "item_1|.|" . $nm_var_lab[36] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $app_menu1_menuData['data'] .= "item_39|..|" . $nm_var_lab[37] . "|app_menu1_form_php.php?sc_item_menu=item_39&sc_apl_menu=control_change_email&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[36] . "||" . $this->app_menu1_target('_self') . "|" . "\n";
}
...
$app_menu1_menuData['data'] .= "item_10|.|" . $nm_var_lab[38] . "|app_menu1_form_php.php?sc_item_menu=item_10&sc_apl_menu=http://www.londonstudiocentre.org&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[37] . "||" . $this->app_menu1_target('_blank') . "|" . "\n";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_all_members&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_all_members']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_all_members']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_applicants_glance&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_glance']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_glance']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_applicants_finished&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_finished']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_finished']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_smtt_interview_venue&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_foundation_applicants_pending&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_foundation_applicants_pending']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_foundation_applicants_pending']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_smtt_interview_venue_pending&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_venue_pending']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_audition_location_summary&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_summary']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_summary']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_9&sc_apl_menu=form_audition_location&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_audition_location']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_audition_location']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_outreach_audition&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_outreach_audition']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_audition_location_edit&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_edit']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_edit']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_audition_location_finished&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_finished']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_finished']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_audition_location_pending_rejected&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_pending_rejected']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_pending_rejected']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_smtt_interview&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_interview']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_31&sc_apl_menu=grid_smtt_interview_super&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_super']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_audition_location_super&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_audition_location_super_complete&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super_complete']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super_complete']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_audition_location_super_outcome_setting&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super_outcome_setting']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_audition_location_super_outcome_setting']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_applicant_admission_outcome&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_applicant_admission_outcome']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_applicant_admission_outcome']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_smtt_interview_marking_active&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_active']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_smtt_interview_marking_complete&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_marking_complete']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_36&sc_apl_menu=grid_smtt_interview_ListToSetOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToSetOutcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_smtt_interview_ListToPublishOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_ListToPublishOutcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_smtt_interview_allPublishedOutcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_allPublishedOutcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_42&sc_apl_menu=form_audition_outcomes_new&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_audition_outcomes_new']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_audition_outcomes_new']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_47&sc_apl_menu=admin_grid_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['admin_grid_outcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['admin_grid_outcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_smtt_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_smtt_outcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_48&sc_apl_menu=grid_smtt_outcomes&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_outcomes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_45&sc_apl_menu=grid_applicants_change_audition&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_change_audition']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_applicants_change_audition']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_smtt_interview_change_date&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_smtt_interview_change_date']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_39&sc_apl_menu=control_change_email&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_change_email']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_change_email']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu1_form_php.php?sc_item_menu=item_10&sc_apl_menu=http://www.londonstudiocentre.org&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
$app_menu1_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->app_menu1_target('_blank') . "\"",
    'sc_id'    => "item_10",
    'disabled' => $str_disabled,
    'display'     => "text_img",
    'display_position'=> "text_right",
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['app_menu1']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/grp_Fair_alrablue_hor_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "grp_Fair_alrablue" . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "grp_Fair_alrablue" . '_' . hor . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
echo "Tab_icons['app_menu1'] = \"\";\r\n";
echo "Tab_icons_inactive['app_menu1'] = \"\";\r\n";
...
function openMenuItem(str_id)
{
    ...
    if (str_target == "app_menu1_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "app_menu1" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
...
<table width="100%" height="67px" class="scMenuHHeader">
        ...
        <td width="67px" class="scMenuHHeaderFont"></td>
               <td class="scMenuHHeaderFont"><span id="lin1_col1"><?php echo "Audition Management System" ?></span><br /><span id="lin2_col1"></span></td>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_super']) && $_SESSION['scriptcase']['sc_apl_seg']['dashboard_super'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_app_menu1');\" item-href=\"app_menu1_form_php.php?sc_item_menu=app_menu1&sc_apl_menu=dashboard_super&sc_apl_link=" . urlencode($app_menu1_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu1']['glo_nm_usa_grupo'] . "\"  item-target=\"app_menu1_iframe\"";
} 
else
{ 
...
<?php
 foreach ($app_menu1_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"app_menu1_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
<table style="width: 100%; height:20px;" cellpadding="0px" cellspacing="0px" class="scMenuHFooter">
    <tr>
        <td>
            <span class="scMenuHFooterFont" id="rod_col1"><?php echo "Developed by: Considerthisuk.com" ?></span>
        </td>
        <td>
            <span class="scMenuHFooterFont" id="rod_col2"><?php echo "London Studio Centre" ?></span>
        </td>
    </tr>
</table>    </td>
  </tr>
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('app_menu1_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
