<?php
@session_start() ;
$_SESSION['scriptcase']['grid_admin_audition']['sc_process_barr'] = true;
require_once('../grid_admin_audition/index.php');
unset($_SESSION['scriptcase']['grid_admin_audition']['sc_process_barr']);
$ExportCtrl = new grid_admin_audition_export_control;
$ExportCtrl->Export_barr();

class grid_admin_audition_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> audition :: Excel</TITLE>
