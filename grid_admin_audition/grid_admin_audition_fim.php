...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_audition"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_audition"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_admin_audition</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_admin_audition']['embutida_filho'] as $ind => $sc_init)
          {
