...
<?php
   ...
   $Ord_Cmp = new grid_admin_audition_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_audition_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select_orig'] = array();
   }
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["id"] : "Audition ID";
   $tab_ger_campos['venue_id'] = "on";
   $tab_def_campos['venue_id'] = "venue_id";
   $tab_converte["venue_id"]   = "venue_id";
   $tab_labels["venue_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["venue_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["venue_id"] : "Venue";
   $tab_ger_campos['audition_date'] = "on";
   $tab_def_campos['audition_date'] = "audition_date";
   $tab_converte["audition_date"]   = "audition_date";
   $tab_labels["audition_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["audition_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["audition_date"] : "Audition Date";
   $tab_ger_campos['audition_title'] = "on";
   $tab_def_campos['audition_title'] = "audition_title";
   $tab_converte["audition_title"]   = "audition_title";
   $tab_labels["audition_title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["audition_title"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["audition_title"] : "Audition Title";
   $tab_ger_campos['pending'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pending'] = "pending";
       $tab_converte["pending"]   = "pending";
   }
   else
   {
       $tab_def_campos['pending'] = "SELECT Count(id)
FROM application_detail 
WHERE audition_id = {id} and 
payment_status = 'Pending'";
       $tab_converte["SELECT Count(id)
FROM application_detail 
WHERE audition_id = {id} and 
payment_status = 'Pending'"]   = "pending";
   }
   $tab_labels["pending"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["pending"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["pending"] : "Pending Application";
   $tab_ger_campos['complete'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['complete'] = "complete";
       $tab_converte["complete"]   = "complete";
   }
   else
   {
       $tab_def_campos['complete'] = "SELECT Count(id)
FROM application_detail 
WHERE audition_id = {id} and 
...
payment_status = 'Complete'"]   = "complete";
   ...
   $tab_labels["complete"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["complete"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["complete"] : "Complete Application";
   ...
   $tab_labels["prepare"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["prepare"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['labels']["prepare"] : "Prepare";
   $tab_ger_campos['pending'] = "none";
   $tab_ger_campos['complete'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_audition_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_audition']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
