<?php
@session_start() ;
$_SESSION['scriptcase']['applicants_auditioning_examiner']['sc_process_barr'] = true;
require_once('../applicants_auditioning_examiner/index.php');
unset($_SESSION['scriptcase']['applicants_auditioning_examiner']['sc_process_barr']);
$ExportCtrl = new applicants_auditioning_examiner_export_control;
$ExportCtrl->Export_barr();

class applicants_auditioning_examiner_export_control
{
