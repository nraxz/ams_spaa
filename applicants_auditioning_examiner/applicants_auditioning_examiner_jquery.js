...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_applicants_auditioning_examiner').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_applicants_auditioning_examiner').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_applicants_auditioning_examiner').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_applicants_auditioning_examiner').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_applicants_auditioning_examiner').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicants_auditioning_examiner').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicants_auditioning_examiner').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicants_auditioning_examiner').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_applicants_auditioning_examiner').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicants_auditioning_examiner').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicants_auditioning_examiner').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicants_auditioning_examiner').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
