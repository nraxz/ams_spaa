<?php
@session_start() ;
$_SESSION['scriptcase']['admin_personal_statement']['sc_process_barr'] = true;
require_once('../admin_personal_statement/index.php');
unset($_SESSION['scriptcase']['admin_personal_statement']['sc_process_barr']);
$ExportCtrl = new admin_personal_statement_export_control;
$ExportCtrl->Export_barr();

class admin_personal_statement_export_control
{
