...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_personal_statement"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_personal_statement"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_personal_statement</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_personal_statement']['embutida_filho'] as $ind => $sc_init)
          {
