  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_member_applicant_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_member_applicant_mob_form();
	}

  // ---------- Validate firstname
  function do_ajax_form_member_applicant_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_member_applicant_mob_validate_firstname_cb);
  } // do_ajax_form_member_applicant_mob_validate_firstname

  function do_ajax_form_member_applicant_mob_validate_firstname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_form_member_applicant_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_form_member_applicant_mob_validate_lastname_cb);
  } // do_ajax_form_member_applicant_mob_validate_lastname

  function do_ajax_form_member_applicant_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_lastname_cb

  // ---------- Validate middlename
  function do_ajax_form_member_applicant_mob_validate_middlename()
  {
    var nomeCampo_middlename = "middlename";
    var var_middlename = scAjaxGetFieldText(nomeCampo_middlename);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_middlename(var_middlename, var_script_case_init, do_ajax_form_member_applicant_mob_validate_middlename_cb);
  } // do_ajax_form_member_applicant_mob_validate_middlename

  function do_ajax_form_member_applicant_mob_validate_middlename_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "middlename";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_middlename_cb

  // ---------- Validate dateofbirth
  function do_ajax_form_member_applicant_mob_validate_dateofbirth()
  {
    var nomeCampo_dateofbirth = "dateofbirth";
    var nomeCampo_dateofbirth_dia = "dateofbirth_dia";
    var nomeCampo_dateofbirth_mes = "dateofbirth_mes";
    var nomeCampo_dateofbirth_ano = "dateofbirth_ano";
    var var_dateofbirth = scAjaxGetFieldText(nomeCampo_dateofbirth);
    var var_dateofbirth_dia = scAjaxGetFieldText(nomeCampo_dateofbirth_dia);
    var var_dateofbirth_mes = scAjaxGetFieldText(nomeCampo_dateofbirth_mes);
    var var_dateofbirth_ano = scAjaxGetFieldText(nomeCampo_dateofbirth_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_dateofbirth = scAjaxGetFieldText(nomeCampo_dateofbirth);
      var var_dateofbirth_dia = scAjaxGetFieldText(nomeCampo_dateofbirth_dia);
      var var_dateofbirth_mes = scAjaxGetFieldText(nomeCampo_dateofbirth_mes);
      var var_dateofbirth_ano = scAjaxGetFieldText(nomeCampo_dateofbirth_ano);
      x_ajax_form_member_applicant_mob_validate_dateofbirth(var_dateofbirth, var_dateofbirth_dia, var_dateofbirth_mes, var_dateofbirth_ano, var_script_case_init, do_ajax_form_member_applicant_mob_validate_dateofbirth_cb);
    }, 200);
  } // do_ajax_form_member_applicant_mob_validate_dateofbirth

  function do_ajax_form_member_applicant_mob_validate_dateofbirth_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dateofbirth";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_dateofbirth_cb

  // ---------- Validate address
  function do_ajax_form_member_applicant_mob_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_address(var_address, var_script_case_init, do_ajax_form_member_applicant_mob_validate_address_cb);
  } // do_ajax_form_member_applicant_mob_validate_address

  function do_ajax_form_member_applicant_mob_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_address_cb

  // ---------- Validate address1
  function do_ajax_form_member_applicant_mob_validate_address1()
  {
    var nomeCampo_address1 = "address1";
    var var_address1 = scAjaxGetFieldText(nomeCampo_address1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_address1(var_address1, var_script_case_init, do_ajax_form_member_applicant_mob_validate_address1_cb);
  } // do_ajax_form_member_applicant_mob_validate_address1

  function do_ajax_form_member_applicant_mob_validate_address1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_address1_cb

  // ---------- Validate town
  function do_ajax_form_member_applicant_mob_validate_town()
  {
    var nomeCampo_town = "town";
    var var_town = scAjaxGetFieldText(nomeCampo_town);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_town(var_town, var_script_case_init, do_ajax_form_member_applicant_mob_validate_town_cb);
  } // do_ajax_form_member_applicant_mob_validate_town

  function do_ajax_form_member_applicant_mob_validate_town_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "town";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_town_cb

  // ---------- Validate county
  function do_ajax_form_member_applicant_mob_validate_county()
  {
    var nomeCampo_county = "county";
    var var_county = scAjaxGetFieldText(nomeCampo_county);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_county(var_county, var_script_case_init, do_ajax_form_member_applicant_mob_validate_county_cb);
  } // do_ajax_form_member_applicant_mob_validate_county

  function do_ajax_form_member_applicant_mob_validate_county_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "county";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_county_cb

  // ---------- Validate postcode
  function do_ajax_form_member_applicant_mob_validate_postcode()
  {
    var nomeCampo_postcode = "postcode";
    var var_postcode = scAjaxGetFieldText(nomeCampo_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_postcode(var_postcode, var_script_case_init, do_ajax_form_member_applicant_mob_validate_postcode_cb);
  } // do_ajax_form_member_applicant_mob_validate_postcode

  function do_ajax_form_member_applicant_mob_validate_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_postcode_cb

  // ---------- Validate country
  function do_ajax_form_member_applicant_mob_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldSelect(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_country(var_country, var_script_case_init, do_ajax_form_member_applicant_mob_validate_country_cb);
  } // do_ajax_form_member_applicant_mob_validate_country

  function do_ajax_form_member_applicant_mob_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_country_cb

  // ---------- Validate telephone
  function do_ajax_form_member_applicant_mob_validate_telephone()
  {
    var nomeCampo_telephone = "telephone";
    var var_telephone = scAjaxGetFieldText(nomeCampo_telephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_telephone(var_telephone, var_script_case_init, do_ajax_form_member_applicant_mob_validate_telephone_cb);
  } // do_ajax_form_member_applicant_mob_validate_telephone

  function do_ajax_form_member_applicant_mob_validate_telephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_telephone_cb

  // ---------- Validate mobile
  function do_ajax_form_member_applicant_mob_validate_mobile()
  {
    var nomeCampo_mobile = "mobile";
    var var_mobile = scAjaxGetFieldText(nomeCampo_mobile);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_mobile(var_mobile, var_script_case_init, do_ajax_form_member_applicant_mob_validate_mobile_cb);
  } // do_ajax_form_member_applicant_mob_validate_mobile

  function do_ajax_form_member_applicant_mob_validate_mobile_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mobile";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_mobile_cb

  // ---------- Validate email
  function do_ajax_form_member_applicant_mob_validate_email()
  {
  } // do_ajax_form_member_applicant_mob_validate_email

  function do_ajax_form_member_applicant_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_email_cb

  // ---------- Validate copy_text
  function do_ajax_form_member_applicant_mob_validate_copy_text()
  {
  } // do_ajax_form_member_applicant_mob_validate_copy_text

  function do_ajax_form_member_applicant_mob_validate_copy_text_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "copy_text";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_copy_text_cb

  // ---------- Validate sex
  function do_ajax_form_member_applicant_mob_validate_sex()
  {
    var nomeCampo_sex = "sex";
    var var_sex = scAjaxGetFieldSelect(nomeCampo_sex);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_sex(var_sex, var_script_case_init, do_ajax_form_member_applicant_mob_validate_sex_cb);
  } // do_ajax_form_member_applicant_mob_validate_sex

  function do_ajax_form_member_applicant_mob_validate_sex_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sex";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_sex_cb

  // ---------- Validate ethnicity
  function do_ajax_form_member_applicant_mob_validate_ethnicity()
  {
    var nomeCampo_ethnicity = "ethnicity";
    var var_ethnicity = scAjaxGetFieldSelect(nomeCampo_ethnicity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_ethnicity(var_ethnicity, var_script_case_init, do_ajax_form_member_applicant_mob_validate_ethnicity_cb);
  } // do_ajax_form_member_applicant_mob_validate_ethnicity

  function do_ajax_form_member_applicant_mob_validate_ethnicity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ethnicity";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_ethnicity_cb

  // ---------- Validate nationality
  function do_ajax_form_member_applicant_mob_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldSelect(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_nationality(var_nationality, var_script_case_init, do_ajax_form_member_applicant_mob_validate_nationality_cb);
  } // do_ajax_form_member_applicant_mob_validate_nationality

  function do_ajax_form_member_applicant_mob_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_nationality_cb

  // ---------- Validate disability
  function do_ajax_form_member_applicant_mob_validate_disability()
  {
    var nomeCampo_disability = "disability";
    var var_disability = scAjaxGetFieldCheckbox(nomeCampo_disability, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_disability(var_disability, var_script_case_init, do_ajax_form_member_applicant_mob_validate_disability_cb);
  } // do_ajax_form_member_applicant_mob_validate_disability

  function do_ajax_form_member_applicant_mob_validate_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disability";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_disability_cb

  // ---------- Validate disbility_specify
  function do_ajax_form_member_applicant_mob_validate_disbility_specify()
  {
    var nomeCampo_disbility_specify = "disbility_specify";
    var var_disbility_specify = scAjaxGetFieldText(nomeCampo_disbility_specify);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_disbility_specify(var_disbility_specify, var_script_case_init, do_ajax_form_member_applicant_mob_validate_disbility_specify_cb);
  } // do_ajax_form_member_applicant_mob_validate_disbility_specify

  function do_ajax_form_member_applicant_mob_validate_disbility_specify_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disbility_specify";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_disbility_specify_cb

  // ---------- Validate offeron_disability
  function do_ajax_form_member_applicant_mob_validate_offeron_disability()
  {
    var nomeCampo_offeron_disability = "offeron_disability";
    var var_offeron_disability = scAjaxGetFieldText(nomeCampo_offeron_disability);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_mob_validate_offeron_disability(var_offeron_disability, var_script_case_init, do_ajax_form_member_applicant_mob_validate_offeron_disability_cb);
  } // do_ajax_form_member_applicant_mob_validate_offeron_disability

  function do_ajax_form_member_applicant_mob_validate_offeron_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "offeron_disability";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_mob_validate_offeron_disability_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_member_applicant_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_member_applicant_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_firstname = scAjaxGetFieldText("firstname");
    var var_lastname = scAjaxGetFieldText("lastname");
    var var_middlename = scAjaxGetFieldText("middlename");
    var var_dateofbirth_mes = scAjaxGetFieldSelect("dateofbirth_mes");
    var var_dateofbirth_dia = scAjaxGetFieldSelect("dateofbirth_dia");
    var var_dateofbirth_ano = scAjaxGetFieldSelect("dateofbirth_ano");
    var var_address = scAjaxGetFieldText("address");
    var var_address1 = scAjaxGetFieldText("address1");
    var var_town = scAjaxGetFieldText("town");
    var var_county = scAjaxGetFieldText("county");
    ...
    var var_mobile = scAjaxGetFieldText("mobile");
    var var_email = scAjaxGetFieldHidden("email");
    var var_copy_text = scAjaxGetFieldHidden("copy_text");
    var var_sex = scAjaxGetFieldSelect("sex");
    var var_ethnicity = scAjaxGetFieldSelect("ethnicity");
    var var_nationality = scAjaxGetFieldSelect("nationality");
    var var_disability = scAjaxGetFieldCheckbox("disability", ";");
    var var_disbility_specify = scAjaxGetFieldText("disbility_specify");
    var var_offeron_disability = scAjaxGetFieldText("offeron_disability");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_member_applicant_mob_submit_form(var_firstname, var_lastname, var_middlename, var_dateofbirth_mes, var_dateofbirth_dia, var_dateofbirth_ano, var_address, var_address1, var_town, var_county, var_postcode, var_country, var_telephone, var_mobile, var_email, var_copy_text, var_sex, var_ethnicity, var_nationality, var_disability, var_disbility_specify, var_offeron_disability, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_member_applicant_mob_submit_form_cb);
  } // do_ajax_form_member_applicant_mob_submit_form

  function do_ajax_form_member_applicant_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("middlename");
      scAjaxHideErrorDisplay("dateofbirth");
      scAjaxHideErrorDisplay("address");
      scAjaxHideErrorDisplay("address1");
      scAjaxHideErrorDisplay("town");
      scAjaxHideErrorDisplay("county");
      scAjaxHideErrorDisplay("postcode");
      scAjaxHideErrorDisplay("country");
      scAjaxHideErrorDisplay("telephone");
      scAjaxHideErrorDisplay("mobile");
      scAjaxHideErrorDisplay("email");
      scAjaxHideErrorDisplay("copy_text");
      scAjaxHideErrorDisplay("sex");
      scAjaxHideErrorDisplay("ethnicity");
      scAjaxHideErrorDisplay("nationality");
      scAjaxHideErrorDisplay("disability");
      scAjaxHideErrorDisplay("disbility_specify");
      scAjaxHideErrorDisplay("offeron_disability");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_member_applicant_mob_submit_form_cb_after_alert);
  } // do_ajax_form_member_applicant_mob_submit_form_cb
  function do_ajax_form_member_applicant_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_member_applicant_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_member_applicant_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_member_applicant_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_member_applicant_mob_navigate_form_cb);
  } // do_ajax_form_member_applicant_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_member_applicant_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_member_applicant_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_member_applicant_mob_navigate_form_cb
  function do_ajax_form_member_applicant_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_member_applicant_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_member_applicant_mob_navigate_form_cb_after_alert
  function sc_hide_form_member_applicant_mob_form()
  {
  ...
  ajax_field_list[0] = "firstname";
  ajax_field_list[1] = "lastname";
  ajax_field_list[2] = "middlename";
  ajax_field_list[3] = "dateofbirth";
  ajax_field_list[4] = "address";
  ajax_field_list[5] = "address1";
  ajax_field_list[6] = "town";
  ajax_field_list[7] = "county";
  ajax_field_list[8] = "postcode";
  ajax_field_list[9] = "country";
  ajax_field_list[10] = "telephone";
  ajax_field_list[11] = "mobile";
  ajax_field_list[12] = "email";
  ajax_field_list[13] = "copy_text";
  ajax_field_list[14] = "sex";
  ajax_field_list[15] = "ethnicity";
  ajax_field_list[16] = "nationality";
  ajax_field_list[17] = "disability";
  ajax_field_list[18] = "disbility_specify";
  ajax_field_list[19] = "offeron_disability";
  ...
  var ajax_error_list = {
    ...
    "middlename": {"label": "Middle name(s)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dateofbirth": {"label": "Date of birth", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "address": {"label": "Address (line 1)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "address1": {"label": "Address (line 2)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "town": {"label": "Town", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "county": {"label": "County", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "postcode": {"label": "Postcode", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "country": {"label": "Country", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telephone": {"label": "Telephone", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mobile": {"label": "Mobile", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "copy_text": {"label": "Encouragement to Disclose", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sex": {"label": "Gender", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ethnicity": {"label": "Ethnicity", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nationality": {"label": "Nationality (listed by country)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disability": {"label": "Disability", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disbility_specify": {"label": "Can we offer you any additional support at your audition?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "offeron_disability": {"label": "<p>Please provide details of injury or illness<br/>that you may feel are important to your application.</p>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "disability": new Array(),
    "disbility_specify": new Array(),
    "offeron_disability": new Array()
  };
  ajax_field_mult["firstname"][1] = "firstname";
  ajax_field_mult["lastname"][1] = "lastname";
  ajax_field_mult["middlename"][1] = "middlename";
  ajax_field_mult["dateofbirth"][1] = "dateofbirth";
  ajax_field_mult["address"][1] = "address";
  ajax_field_mult["address1"][1] = "address1";
  ajax_field_mult["town"][1] = "town";
  ajax_field_mult["county"][1] = "county";
  ajax_field_mult["postcode"][1] = "postcode";
  ajax_field_mult["country"][1] = "country";
  ajax_field_mult["telephone"][1] = "telephone";
  ajax_field_mult["mobile"][1] = "mobile";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["copy_text"][1] = "copy_text";
  ajax_field_mult["sex"][1] = "sex";
  ajax_field_mult["ethnicity"][1] = "ethnicity";
  ajax_field_mult["nationality"][1] = "nationality";
  ajax_field_mult["disability"][1] = "disability";
  ajax_field_mult["disbility_specify"][1] = "disbility_specify";
  ajax_field_mult["offeron_disability"][1] = "offeron_disability";
  ...
  var ajax_field_id = {
    ...
    "middlename": new Array("hidden_field_label_middlename", "hidden_field_data_middlename"),
    "dateofbirth": new Array("hidden_field_label_dateofbirth", "hidden_field_data_dateofbirth"),
    ...
    "town": new Array("hidden_field_label_town", "hidden_field_data_town"),
    "county": new Array("hidden_field_label_county", "hidden_field_data_county"),
    ...
    "mobile": new Array("hidden_field_label_mobile", "hidden_field_data_mobile"),
    "email": new Array("hidden_field_label_email", "hidden_field_data_email"),
    "copy_text": new Array("hidden_field_label_copy_text", "hidden_field_data_copy_text"),
    "sex": new Array("hidden_field_label_sex", "hidden_field_data_sex"),
    "ethnicity": new Array("hidden_field_label_ethnicity", "hidden_field_data_ethnicity"),
    "nationality": new Array("hidden_field_label_nationality", "hidden_field_data_nationality"),
    "disability": new Array("hidden_field_label_disability", "hidden_field_data_disability"),
    "disbility_specify": new Array("hidden_field_label_disbility_specify", "hidden_field_data_disbility_specify"),
    "offeron_disability": new Array("hidden_field_label_offeron_disability", "hidden_field_data_offeron_disability")
  };
  ...
  var ajax_read_only = {
    ...
    "nationality": "off",
    "disability": "off",
    "disbility_specify": "off",
    "offeron_disability": "off"
  };
