...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_member_applicant_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_member_applicant_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_member_applicant_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_member_applicant'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_member_applicant'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_firstname_label" id="hidden_field_label_firstname" style="<?php echo $sStyleHidden_firstname; ?>"><span id="id_label_firstname"><?php echo $this->nm_new_label['firstname']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['firstname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['firstname'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lastname_label" id="hidden_field_label_lastname" style="<?php echo $sStyleHidden_lastname; ?>"><span id="id_label_lastname"><?php echo $this->nm_new_label['lastname']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['lastname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['lastname'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_middlename_label" id="hidden_field_label_middlename" style="<?php echo $sStyleHidden_middlename; ?>"><span id="id_label_middlename"><?php echo $this->nm_new_label['middlename']; ?></span></TD>
    <TD class="scFormDataOdd css_middlename_line" id="hidden_field_data_middlename" style="<?php echo $sStyleHidden_middlename; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_middlename_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dateofbirth_label" id="hidden_field_label_dateofbirth" style="<?php echo $sStyleHidden_dateofbirth; ?>"><span id="id_label_dateofbirth"><?php echo $this->nm_new_label['dateofbirth']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['dateofbirth']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['dateofbirth'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?><span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
?>
    ...
    <TD class="scFormDataOdd css_dateofbirth_line" id="hidden_field_data_dateofbirth" style="<?php echo $sStyleHidden_dateofbirth; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dateofbirth_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_address_label" id="hidden_field_label_address" style="<?php echo $sStyleHidden_address; ?>"><span id="id_label_address"><?php echo $this->nm_new_label['address']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['address']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['address'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_address1_label" id="hidden_field_label_address1" style="<?php echo $sStyleHidden_address1; ?>"><span id="id_label_address1"><?php echo $this->nm_new_label['address1']; ?></span></TD>
    <TD class="scFormDataOdd css_address1_line" id="hidden_field_data_address1" style="<?php echo $sStyleHidden_address1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_address1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_town_label" id="hidden_field_label_town" style="<?php echo $sStyleHidden_town; ?>"><span id="id_label_town"><?php echo $this->nm_new_label['town']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['town']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['town'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_town_line" id="hidden_field_data_town" style="<?php echo $sStyleHidden_town; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_town_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_county_label" id="hidden_field_label_county" style="<?php echo $sStyleHidden_county; ?>"><span id="id_label_county"><?php echo $this->nm_new_label['county']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['county']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['county'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_postcode_label" id="hidden_field_label_postcode" style="<?php echo $sStyleHidden_postcode; ?>"><span id="id_label_postcode"><?php echo $this->nm_new_label['postcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['postcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['postcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_country_label" id="hidden_field_label_country" style="<?php echo $sStyleHidden_country; ?>"><span id="id_label_country"><?php echo $this->nm_new_label['country']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['country']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['country'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mobile_label" id="hidden_field_label_mobile" style="<?php echo $sStyleHidden_mobile; ?>"><span id="id_label_mobile"><?php echo $this->nm_new_label['mobile']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['mobile']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['mobile'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_mobile_line" id="hidden_field_data_mobile" style="<?php echo $sStyleHidden_mobile; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mobile_line" style="vertical-align: top;padding: 0px">
...
?>
    ...
    <TD class="scFormDataOdd css_email_line" id="hidden_field_data_email" style="<?php echo $sStyleHidden_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_line" style="vertical-align: top;padding: 0px"><span id="id_ajax_label_email"><?php echo $email?></span>
<input type="hidden" name="email" value="<?php echo $this->form_encode_input($email); ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sex_label" id="hidden_field_label_sex" style="<?php echo $sStyleHidden_sex; ?>"><span id="id_label_sex"><?php echo $this->nm_new_label['sex']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['sex']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['sex'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['Lookup_sex'][] = ''; ?>
 <option value=""></option>
 <option  value="Male" <?php  if ($this->sex == "Male") { echo " selected" ;} ?>>Male</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['Lookup_sex'][] = 'Male'; ?>
 <option  value="Female" <?php  if ($this->sex == "Female") { echo " selected" ;} ?>>Female</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['Lookup_sex'][] = 'Female'; ?>
 <option  value="Other" <?php  if ($this->sex == "Other") { echo " selected" ;} ?>>Other</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['Lookup_sex'][] = 'Other'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ethnicity_label" id="hidden_field_label_ethnicity" style="<?php echo $sStyleHidden_ethnicity; ?>"><span id="id_label_ethnicity"><?php echo $this->nm_new_label['ethnicity']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['ethnicity']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['ethnicity'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ethnicity_line" id="hidden_field_data_ethnicity" style="<?php echo $sStyleHidden_ethnicity; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ethnicity_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nationality_label" id="hidden_field_label_nationality" style="<?php echo $sStyleHidden_nationality; ?>"><span id="id_label_nationality"><?php echo $this->nm_new_label['nationality']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['nationality']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['nationality'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<TABLE align="center" id="hidden_bloco_4" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="2" height="" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_disability_label" id="hidden_field_label_disability" style="<?php echo $sStyleHidden_disability; ?>"><span id="id_label_disability"><?php echo $this->nm_new_label['disability']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['disability']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['php_cmp_required']['disability'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?><span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
?>
    ...
    <TD class="scFormDataOdd css_disability_line" id="hidden_field_data_disability" style="<?php echo $sStyleHidden_disability; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_disability_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_disbility_specify_label" id="hidden_field_label_disbility_specify" style="<?php echo $sStyleHidden_disbility_specify; ?>"><span id="id_label_disbility_specify"><?php echo $this->nm_new_label['disbility_specify']; ?></span><span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
?>
    ...
    <TD class="scFormDataOdd css_disbility_specify_line" id="hidden_field_data_disbility_specify" style="<?php echo $sStyleHidden_disbility_specify; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_disbility_specify_line" style="vertical-align: top;padding: 0px">
<?php
...
?>
    ...
    <TD class="scFormDataOdd css_offeron_disability_line" id="hidden_field_data_offeron_disability" style="<?php echo $sStyleHidden_offeron_disability; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_offeron_disability_line" style="vertical-align: top;padding: 0px">
<?php
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_b", "", "Submit", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_b", "", "Save Changes", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-9", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_member_applicant");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_member_applicant");
 parent.scAjaxDetailHeight("form_member_applicant", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
