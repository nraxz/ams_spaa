  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_member_applicant" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_member_applicant_form();
	}

  // ---------- Validate firstname
  function do_ajax_form_member_applicant_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_member_applicant_validate_firstname_cb);
  } // do_ajax_form_member_applicant_validate_firstname

  function do_ajax_form_member_applicant_validate_firstname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_form_member_applicant_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_lastname(var_lastname, var_script_case_init, do_ajax_form_member_applicant_validate_lastname_cb);
  } // do_ajax_form_member_applicant_validate_lastname

  function do_ajax_form_member_applicant_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_lastname_cb

  // ---------- Validate middlename
  function do_ajax_form_member_applicant_validate_middlename()
  {
    var nomeCampo_middlename = "middlename";
    var var_middlename = scAjaxGetFieldText(nomeCampo_middlename);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_middlename(var_middlename, var_script_case_init, do_ajax_form_member_applicant_validate_middlename_cb);
  } // do_ajax_form_member_applicant_validate_middlename

  function do_ajax_form_member_applicant_validate_middlename_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_middlename_cb

  // ---------- Validate dateofbirth
  function do_ajax_form_member_applicant_validate_dateofbirth()
  {
    ...
    setTimeout(function() {
      ...
      var var_dateofbirth_mes = scAjaxGetFieldText(nomeCampo_dateofbirth_mes);
      var var_dateofbirth_ano = scAjaxGetFieldText(nomeCampo_dateofbirth_ano);
      x_ajax_form_member_applicant_validate_dateofbirth(var_dateofbirth, var_dateofbirth_dia, var_dateofbirth_mes, var_dateofbirth_ano, var_script_case_init, do_ajax_form_member_applicant_validate_dateofbirth_cb);
    }, 200);
  } // do_ajax_form_member_applicant_validate_dateofbirth

  function do_ajax_form_member_applicant_validate_dateofbirth_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_dateofbirth_cb

  // ---------- Validate address
  function do_ajax_form_member_applicant_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_address(var_address, var_script_case_init, do_ajax_form_member_applicant_validate_address_cb);
  } // do_ajax_form_member_applicant_validate_address

  function do_ajax_form_member_applicant_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_address_cb

  // ---------- Validate address1
  function do_ajax_form_member_applicant_validate_address1()
  {
    var nomeCampo_address1 = "address1";
    var var_address1 = scAjaxGetFieldText(nomeCampo_address1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_address1(var_address1, var_script_case_init, do_ajax_form_member_applicant_validate_address1_cb);
  } // do_ajax_form_member_applicant_validate_address1

  function do_ajax_form_member_applicant_validate_address1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_address1_cb

  // ---------- Validate town
  function do_ajax_form_member_applicant_validate_town()
  {
    var nomeCampo_town = "town";
    var var_town = scAjaxGetFieldText(nomeCampo_town);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_town(var_town, var_script_case_init, do_ajax_form_member_applicant_validate_town_cb);
  } // do_ajax_form_member_applicant_validate_town

  function do_ajax_form_member_applicant_validate_town_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "town";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_town_cb

  // ---------- Validate county
  function do_ajax_form_member_applicant_validate_county()
  {
    var nomeCampo_county = "county";
    var var_county = scAjaxGetFieldText(nomeCampo_county);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_county(var_county, var_script_case_init, do_ajax_form_member_applicant_validate_county_cb);
  } // do_ajax_form_member_applicant_validate_county

  function do_ajax_form_member_applicant_validate_county_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "county";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_county_cb

  // ---------- Validate postcode
  function do_ajax_form_member_applicant_validate_postcode()
  {
    var nomeCampo_postcode = "postcode";
    var var_postcode = scAjaxGetFieldText(nomeCampo_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_postcode(var_postcode, var_script_case_init, do_ajax_form_member_applicant_validate_postcode_cb);
  } // do_ajax_form_member_applicant_validate_postcode

  function do_ajax_form_member_applicant_validate_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_postcode_cb

  // ---------- Validate country
  function do_ajax_form_member_applicant_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldSelect(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_country(var_country, var_script_case_init, do_ajax_form_member_applicant_validate_country_cb);
  } // do_ajax_form_member_applicant_validate_country

  function do_ajax_form_member_applicant_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_country_cb

  // ---------- Validate telephone
  function do_ajax_form_member_applicant_validate_telephone()
  {
    var nomeCampo_telephone = "telephone";
    var var_telephone = scAjaxGetFieldText(nomeCampo_telephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_telephone(var_telephone, var_script_case_init, do_ajax_form_member_applicant_validate_telephone_cb);
  } // do_ajax_form_member_applicant_validate_telephone

  function do_ajax_form_member_applicant_validate_telephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_telephone_cb

  // ---------- Validate mobile
  function do_ajax_form_member_applicant_validate_mobile()
  {
    var nomeCampo_mobile = "mobile";
    var var_mobile = scAjaxGetFieldText(nomeCampo_mobile);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_mobile(var_mobile, var_script_case_init, do_ajax_form_member_applicant_validate_mobile_cb);
  } // do_ajax_form_member_applicant_validate_mobile

  function do_ajax_form_member_applicant_validate_mobile_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mobile";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_mobile_cb

  // ---------- Validate email
  function do_ajax_form_member_applicant_validate_email()
  {
  } // do_ajax_form_member_applicant_validate_email

  function do_ajax_form_member_applicant_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_email_cb

  // ---------- Validate copy_text
  function do_ajax_form_member_applicant_validate_copy_text()
  {
  } // do_ajax_form_member_applicant_validate_copy_text

  function do_ajax_form_member_applicant_validate_copy_text_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_copy_text_cb

  // ---------- Validate sex
  function do_ajax_form_member_applicant_validate_sex()
  {
    var nomeCampo_sex = "sex";
    var var_sex = scAjaxGetFieldSelect(nomeCampo_sex);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_sex(var_sex, var_script_case_init, do_ajax_form_member_applicant_validate_sex_cb);
  } // do_ajax_form_member_applicant_validate_sex

  function do_ajax_form_member_applicant_validate_sex_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sex";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_sex_cb

  // ---------- Validate ethnicity
  function do_ajax_form_member_applicant_validate_ethnicity()
  {
    var nomeCampo_ethnicity = "ethnicity";
    var var_ethnicity = scAjaxGetFieldSelect(nomeCampo_ethnicity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_ethnicity(var_ethnicity, var_script_case_init, do_ajax_form_member_applicant_validate_ethnicity_cb);
  } // do_ajax_form_member_applicant_validate_ethnicity

  function do_ajax_form_member_applicant_validate_ethnicity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_ethnicity_cb

  // ---------- Validate nationality
  function do_ajax_form_member_applicant_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldSelect(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_nationality(var_nationality, var_script_case_init, do_ajax_form_member_applicant_validate_nationality_cb);
  } // do_ajax_form_member_applicant_validate_nationality

  function do_ajax_form_member_applicant_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_nationality_cb

  // ---------- Validate disability
  function do_ajax_form_member_applicant_validate_disability()
  {
    var nomeCampo_disability = "disability";
    var var_disability = scAjaxGetFieldCheckbox(nomeCampo_disability, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_disability(var_disability, var_script_case_init, do_ajax_form_member_applicant_validate_disability_cb);
  } // do_ajax_form_member_applicant_validate_disability

  function do_ajax_form_member_applicant_validate_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_disability_cb

  // ---------- Validate disbility_specify
  function do_ajax_form_member_applicant_validate_disbility_specify()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_disbility_specify(var_disbility_specify, var_script_case_init, do_ajax_form_member_applicant_validate_disbility_specify_cb);
  } // do_ajax_form_member_applicant_validate_disbility_specify

  function do_ajax_form_member_applicant_validate_disbility_specify_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_disbility_specify_cb

  // ---------- Validate offeron_disability
  function do_ajax_form_member_applicant_validate_offeron_disability()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_member_applicant_validate_offeron_disability(var_offeron_disability, var_script_case_init, do_ajax_form_member_applicant_validate_offeron_disability_cb);
  } // do_ajax_form_member_applicant_validate_offeron_disability

  function do_ajax_form_member_applicant_validate_offeron_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_member_applicant_validate_offeron_disability_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_member_applicant_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_member_applicant_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_member_applicant_submit_form(var_firstname, var_lastname, var_middlename, var_dateofbirth_mes, var_dateofbirth_dia, var_dateofbirth_ano, var_address, var_address1, var_town, var_county, var_postcode, var_country, var_telephone, var_mobile, var_email, var_copy_text, var_sex, var_ethnicity, var_nationality, var_disability, var_disbility_specify, var_offeron_disability, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_member_applicant_submit_form_cb);
  } // do_ajax_form_member_applicant_submit_form

  function do_ajax_form_member_applicant_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_member_applicant_submit_form_cb_after_alert);
  } // do_ajax_form_member_applicant_submit_form_cb
  function do_ajax_form_member_applicant_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_member_applicant_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_member_applicant_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_member_applicant_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_member_applicant_navigate_form_cb);
  } // do_ajax_form_member_applicant_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_member_applicant']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_member_applicant_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_member_applicant_navigate_form_cb_after_alert);
  } // do_ajax_form_member_applicant_navigate_form_cb
  function do_ajax_form_member_applicant_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_member_applicant_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_member_applicant_navigate_form_cb_after_alert
  function sc_hide_form_member_applicant_form()
  {
