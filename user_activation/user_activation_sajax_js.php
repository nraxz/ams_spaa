  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_user_activation" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_user_activation_form();
	}

  // ---------- Validate activation_code
  function do_ajax_user_activation_validate_activation_code()
  {
    var nomeCampo_activation_code = "activation_code";
    var var_activation_code = scAjaxGetFieldText(nomeCampo_activation_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_user_activation_validate_activation_code(var_activation_code, var_script_case_init, do_ajax_user_activation_validate_activation_code_cb);
  } // do_ajax_user_activation_validate_activation_code

  function do_ajax_user_activation_validate_activation_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activation_code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_user_activation_validate_activation_code_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_user_activation_submit_form()
  {
    scAjaxHideMessage();
    var var_activation_code = scAjaxGetFieldText("activation_code");
    ...
    x_ajax_user_activation_submit_form(var_activation_code, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_user_activation_submit_form_cb);
  } // do_ajax_user_activation_submit_form

  function do_ajax_user_activation_submit_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("activation_code");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_user_activation_submit_form_cb_after_alert);
  } // do_ajax_user_activation_submit_form_cb
  function do_ajax_user_activation_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_user_activation_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_user_activation_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_user_activation_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['user_activation']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_user_activation_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_user_activation_navigate_form_cb_after_alert);
  } // do_ajax_user_activation_navigate_form_cb
  function do_ajax_user_activation_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_user_activation_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_user_activation_navigate_form_cb_after_alert
  function sc_hide_user_activation_form()
  {
  ...
  ajax_field_list[0] = "activation_code";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "activation_code": {"label": "Activation Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "activation_code": new Array()
  };
  ajax_field_mult["activation_code"][1] = "activation_code";

  var ajax_field_id = {
    "activation_code": new Array("hidden_field_label_activation_code", "hidden_field_data_activation_code")
  };
