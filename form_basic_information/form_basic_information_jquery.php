...
function scHidePage(pageNo) {
	$("#id_form_basic_information_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_dummy_dateofbirth" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      setTimeout(function() { do_ajax_form_basic_information_validate_dateofbirth(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_submitted" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_basic_information_validate_submitted(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
