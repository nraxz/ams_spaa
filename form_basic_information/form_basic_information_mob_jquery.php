...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_firstname' + iSeqRow).bind('blur', function() { sc_form_basic_information_firstname_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_basic_information_firstname_onfocus(this, iSeqRow) });
  $('#id_sc_field_lastname' + iSeqRow).bind('blur', function() { sc_form_basic_information_lastname_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_basic_information_lastname_onfocus(this, iSeqRow) });
  $('#id_sc_field_nationality' + iSeqRow).bind('blur', function() { sc_form_basic_information_nationality_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_basic_information_nationality_onfocus(this, iSeqRow) });
  $('#id_sc_field_dateofbirth' + iSeqRow).bind('blur', function() { sc_form_basic_information_dateofbirth_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_basic_information_dateofbirth_onfocus(this, iSeqRow) });
  $('#id_sc_field_gender' + iSeqRow).bind('blur', function() { sc_form_basic_information_gender_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_basic_information_gender_onfocus(this, iSeqRow) });
  $('#id_sc_field_resident' + iSeqRow).bind('blur', function() { sc_form_basic_information_resident_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_basic_information_resident_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_basic_information_firstname_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_firstname();
  scCssBlur(oThis);
}

function sc_form_basic_information_firstname_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_basic_information_lastname_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_lastname();
  scCssBlur(oThis);
}

function sc_form_basic_information_lastname_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_basic_information_nationality_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_nationality();
  scCssBlur(oThis);
}

function sc_form_basic_information_nationality_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_basic_information_dateofbirth_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_dateofbirth();
  scCssBlur(oThis);
}

function sc_form_basic_information_dateofbirth_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_basic_information_gender_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_gender();
  scCssBlur(oThis);
}

function sc_form_basic_information_gender_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_basic_information_resident_onblur(oThis, iSeqRow) {
  do_ajax_form_basic_information_mob_validate_resident();
  scCssBlur(oThis);
}

function sc_form_basic_information_resident_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_resident(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_resident__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_resident" + row).select2("destroy");
		}
		scJQSelect2Add(row, "resident");
	}
}
...
function scRecreateSelect2() {
	...
	displayChange_field_resident("all", "on");
}
...
function scHidePage(pageNo) {
	$("#id_form_basic_information_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_dummy_dateofbirth" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      setTimeout(function() { do_ajax_form_basic_information_mob_validate_dateofbirth(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_submitted" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_basic_information_mob_validate_submitted(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQSelect2Add(seqRow, specificField) {
  ...
  if (null == specificField || "resident" == specificField) {
    scJQSelect2Add_resident(seqRow);
  }
} // scJQSelect2Add
...
function scJQSelect2Add_resident(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_resident_obj" : "#id_sc_field_resident" + seqRow;
  $(elemSelector).select2(
    {
      containerCssClass: 'css_resident_obj',
      dropdownCssClass: 'css_resident_obj',
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
        },
...
function scJQElementsAdd(iLine) {
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_resident) { displayChange_field_resident(iLine, "on"); } }, 150);
} // scJQElementsAdd
