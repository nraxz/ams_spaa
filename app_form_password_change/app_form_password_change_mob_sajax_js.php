  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_form_password_change_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_app_form_password_change_mob_form();
	}

  // ---------- Validate email
  function do_ajax_app_form_password_change_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_email(var_email, var_script_case_init, do_ajax_app_form_password_change_mob_validate_email_cb);
  } // do_ajax_app_form_password_change_mob_validate_email

  function do_ajax_app_form_password_change_mob_validate_email_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_email_cb

  // ---------- Validate new_pswd
  function do_ajax_app_form_password_change_mob_validate_new_pswd()
  {
    var nomeCampo_new_pswd = "new_pswd";
    var var_new_pswd = scAjaxGetFieldText(nomeCampo_new_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_new_pswd(var_new_pswd, var_script_case_init, do_ajax_app_form_password_change_mob_validate_new_pswd_cb);
  } // do_ajax_app_form_password_change_mob_validate_new_pswd

  function do_ajax_app_form_password_change_mob_validate_new_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "new_pswd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_new_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_app_form_password_change_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_app_form_password_change_mob_validate_confirm_pswd_cb);
  } // do_ajax_app_form_password_change_mob_validate_confirm_pswd

  function do_ajax_app_form_password_change_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_confirm_pswd_cb

  // ---------- Validate active
  function do_ajax_app_form_password_change_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldRadio(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_active(var_active, var_script_case_init, do_ajax_app_form_password_change_mob_validate_active_cb);
  } // do_ajax_app_form_password_change_mob_validate_active

  function do_ajax_app_form_password_change_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_active_cb

  // ---------- Validate firstname
  function do_ajax_app_form_password_change_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_app_form_password_change_mob_validate_firstname_cb);
  } // do_ajax_app_form_password_change_mob_validate_firstname

  function do_ajax_app_form_password_change_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_app_form_password_change_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_app_form_password_change_mob_validate_lastname_cb);
  } // do_ajax_app_form_password_change_mob_validate_lastname

  function do_ajax_app_form_password_change_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_lastname_cb

  // ---------- Validate created_at
  function do_ajax_app_form_password_change_mob_validate_created_at()
  {
    var nomeCampo_created_at = "created_at";
    var var_created_at = scAjaxGetFieldText(nomeCampo_created_at);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_password_change_mob_validate_created_at(var_created_at, var_script_case_init, do_ajax_app_form_password_change_mob_validate_created_at_cb);
  } // do_ajax_app_form_password_change_mob_validate_created_at

  function do_ajax_app_form_password_change_mob_validate_created_at_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_password_change_mob_validate_created_at_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_app_form_password_change_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_form_password_change_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_email = scAjaxGetFieldText("email");
    var var_new_pswd = scAjaxGetFieldText("new_pswd");
    ...
    scAjaxProcOn();
    x_ajax_app_form_password_change_mob_submit_form(var_email, var_new_pswd, var_confirm_pswd, var_active, var_firstname, var_lastname, var_created_at, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_password_change_mob_submit_form_cb);
  } // do_ajax_app_form_password_change_mob_submit_form

  function do_ajax_app_form_password_change_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("new_pswd");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app_form_password_change_mob_submit_form_cb_after_alert);
  } // do_ajax_app_form_password_change_mob_submit_form_cb
  function do_ajax_app_form_password_change_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_form_password_change_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_form_password_change_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app_form_password_change_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_password_change_mob_navigate_form_cb);
  } // do_ajax_app_form_password_change_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_password_change_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_form_password_change_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_form_password_change_mob_navigate_form_cb_after_alert);
  } // do_ajax_app_form_password_change_mob_navigate_form_cb
  function do_ajax_app_form_password_change_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app_form_password_change_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_form_password_change_mob_navigate_form_cb_after_alert
  function sc_hide_app_form_password_change_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "new_pswd": {"label": "Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "firstname": {"label": "Firstname", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lastname": {"label": "Lastname", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "created_at": {"label": "Created At", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["new_pswd"][1] = "new_pswd";
  ...
  var ajax_field_id = {
    ...
    "new_pswd": new Array("hidden_field_label_new_pswd", "hidden_field_data_new_pswd"),
