<?php
@session_start() ;
$_SESSION['scriptcase']['grid_performing_arts']['sc_process_barr'] = true;
require_once('../grid_performing_arts/index.php');
unset($_SESSION['scriptcase']['grid_performing_arts']['sc_process_barr']);
$ExportCtrl = new grid_performing_arts_export_control;
$ExportCtrl->Export_barr();

class grid_performing_arts_export_control
{
