<?php
@session_start() ;
$_SESSION['scriptcase']['admin_next_of_kin']['sc_process_barr'] = true;
require_once('../admin_next_of_kin/index.php');
unset($_SESSION['scriptcase']['admin_next_of_kin']['sc_process_barr']);
$ExportCtrl = new admin_next_of_kin_export_control;
$ExportCtrl->Export_barr();

class admin_next_of_kin_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> next_of_kin :: Excel</TITLE>
