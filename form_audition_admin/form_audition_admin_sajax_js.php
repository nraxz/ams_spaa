  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_audition_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_audition_admin_form();
	}

  // ---------- Validate audition_title
  function do_ajax_form_audition_admin_validate_audition_title()
  {
    var nomeCampo_audition_title = "audition_title";
    var var_audition_title = scAjaxGetFieldText(nomeCampo_audition_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_audition_title(var_audition_title, var_script_case_init, do_ajax_form_audition_admin_validate_audition_title_cb);
  } // do_ajax_form_audition_admin_validate_audition_title

  function do_ajax_form_audition_admin_validate_audition_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "audition_title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_audition_title_cb

  // ---------- Validate venue_id
  function do_ajax_form_audition_admin_validate_venue_id()
  {
    var nomeCampo_venue_id = "venue_id";
    var var_venue_id = scAjaxGetFieldSelect(nomeCampo_venue_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_venue_id(var_venue_id, var_script_case_init, do_ajax_form_audition_admin_validate_venue_id_cb);
  } // do_ajax_form_audition_admin_validate_venue_id

  function do_ajax_form_audition_admin_validate_venue_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "venue_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_venue_id_cb

  // ---------- Validate audition_date
  function do_ajax_form_audition_admin_validate_audition_date()
  {
    var nomeCampo_audition_date = "audition_date";
    var var_audition_date = scAjaxGetFieldText(nomeCampo_audition_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_audition_date(var_audition_date, var_script_case_init, do_ajax_form_audition_admin_validate_audition_date_cb);
  } // do_ajax_form_audition_admin_validate_audition_date

  function do_ajax_form_audition_admin_validate_audition_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "audition_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_audition_date_cb

  // ---------- Validate audition_fee
  function do_ajax_form_audition_admin_validate_audition_fee()
  {
    var nomeCampo_audition_fee = "audition_fee";
    var var_audition_fee = scAjaxGetFieldText(nomeCampo_audition_fee);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_audition_fee(var_audition_fee, var_script_case_init, do_ajax_form_audition_admin_validate_audition_fee_cb);
  } // do_ajax_form_audition_admin_validate_audition_fee

  function do_ajax_form_audition_admin_validate_audition_fee_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "audition_fee";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_audition_fee_cb

  // ---------- Validate audition_details
  function do_ajax_form_audition_admin_validate_audition_details()
  {
    var nomeCampo_audition_details = "audition_details";
    var var_audition_details = scAjaxGetFieldText(nomeCampo_audition_details);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_audition_details(var_audition_details, var_script_case_init, do_ajax_form_audition_admin_validate_audition_details_cb);
  } // do_ajax_form_audition_admin_validate_audition_details

  function do_ajax_form_audition_admin_validate_audition_details_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "audition_details";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_audition_details_cb

  // ---------- Validate type
  function do_ajax_form_audition_admin_validate_type()
  {
    var nomeCampo_type = "type";
    var var_type = scAjaxGetFieldRadio(nomeCampo_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_type(var_type, var_script_case_init, do_ajax_form_audition_admin_validate_type_cb);
  } // do_ajax_form_audition_admin_validate_type

  function do_ajax_form_audition_admin_validate_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_type_cb

  // ---------- Validate location_type
  function do_ajax_form_audition_admin_validate_location_type()
  {
    var nomeCampo_location_type = "location_type";
    var var_location_type = scAjaxGetFieldRadio(nomeCampo_location_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_location_type(var_location_type, var_script_case_init, do_ajax_form_audition_admin_validate_location_type_cb);
  } // do_ajax_form_audition_admin_validate_location_type

  function do_ajax_form_audition_admin_validate_location_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "location_type";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_location_type_cb

  // ---------- Validate contact_person
  function do_ajax_form_audition_admin_validate_contact_person()
  {
    var nomeCampo_contact_person = "contact_person";
    var var_contact_person = scAjaxGetFieldSelect(nomeCampo_contact_person);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_contact_person(var_contact_person, var_script_case_init, do_ajax_form_audition_admin_validate_contact_person_cb);
  } // do_ajax_form_audition_admin_validate_contact_person

  function do_ajax_form_audition_admin_validate_contact_person_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contact_person";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_contact_person_cb

  // ---------- Validate student_no
  function do_ajax_form_audition_admin_validate_student_no()
  {
    var nomeCampo_student_no = "student_no";
    var var_student_no = scAjaxGetFieldText(nomeCampo_student_no);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_student_no(var_student_no, var_script_case_init, do_ajax_form_audition_admin_validate_student_no_cb);
  } // do_ajax_form_audition_admin_validate_student_no

  function do_ajax_form_audition_admin_validate_student_no_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "student_no";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_student_no_cb

  // ---------- Validate status
  function do_ajax_form_audition_admin_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_validate_status(var_status, var_script_case_init, do_ajax_form_audition_admin_validate_status_cb);
  } // do_ajax_form_audition_admin_validate_status

  function do_ajax_form_audition_admin_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_audition_admin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_audition_admin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_audition_title = scAjaxGetFieldText("audition_title");
    var var_venue_id = scAjaxGetFieldSelect("venue_id");
    var var_audition_date = scAjaxGetFieldText("audition_date");
    var var_audition_fee = scAjaxGetFieldText("audition_fee");
    var var_audition_details = scAjaxGetFieldText("audition_details");
    var var_type = scAjaxGetFieldRadio("type");
    var var_location_type = scAjaxGetFieldRadio("location_type");
    var var_contact_person = scAjaxGetFieldSelect("contact_person");
    var var_student_no = scAjaxGetFieldText("student_no");
    ...
    scAjaxProcOn();
    x_ajax_form_audition_admin_submit_form(var_audition_title, var_venue_id, var_audition_date, var_audition_fee, var_audition_details, var_type, var_location_type, var_contact_person, var_student_no, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_audition_admin_submit_form_cb);
  } // do_ajax_form_audition_admin_submit_form

  function do_ajax_form_audition_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("audition_title");
      scAjaxHideErrorDisplay("venue_id");
      scAjaxHideErrorDisplay("audition_date");
      scAjaxHideErrorDisplay("audition_fee");
      scAjaxHideErrorDisplay("audition_details");
      scAjaxHideErrorDisplay("type");
      scAjaxHideErrorDisplay("location_type");
      scAjaxHideErrorDisplay("contact_person");
      scAjaxHideErrorDisplay("student_no");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_audition_admin_submit_form_cb_after_alert);
  } // do_ajax_form_audition_admin_submit_form_cb
  function do_ajax_form_audition_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_audition_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_audition_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_audition_admin_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_audition_admin_navigate_form_cb);
  } // do_ajax_form_audition_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_audition_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_audition_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_audition_admin_navigate_form_cb
  function do_ajax_form_audition_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_audition_admin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_audition_admin_navigate_form_cb_after_alert
  function sc_hide_form_audition_admin_form()
  {
  ...
  function do_ajax_form_audition_admin_lkpedt_refresh_venue_id()
  {
    var var_venue_id = scAjaxGetFieldSelect("venue_id");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "venue_id";
    x_ajax_form_audition_admin_lkpedt_refresh_venue_id(var_venue_id, nmgp_refresh_fields, var_script_case_init, do_ajax_form_audition_admin_lkpedt_refresh_venue_id_cb);
  } // do_ajax_form_audition_admin_lkpedt_refresh_venue_id

  function do_ajax_form_audition_admin_lkpedt_refresh_venue_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_audition_admin_lkpedt_refresh_venue_id_cb

  function do_ajax_form_audition_admin_lkpedt_refresh_contact_person()
  {
    var var_contact_person = scAjaxGetFieldSelect("contact_person");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "contact_person";
    x_ajax_form_audition_admin_lkpedt_refresh_contact_person(var_contact_person, nmgp_refresh_fields, var_script_case_init, do_ajax_form_audition_admin_lkpedt_refresh_contact_person_cb);
  } // do_ajax_form_audition_admin_lkpedt_refresh_contact_person

  function do_ajax_form_audition_admin_lkpedt_refresh_contact_person_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_audition_admin_lkpedt_refresh_contact_person_cb
  ...
  ajax_field_list[0] = "audition_title";
  ajax_field_list[1] = "venue_id";
  ajax_field_list[2] = "audition_date";
  ajax_field_list[3] = "audition_fee";
  ajax_field_list[4] = "audition_details";
  ajax_field_list[5] = "type";
  ajax_field_list[6] = "location_type";
  ajax_field_list[7] = "contact_person";
  ajax_field_list[8] = "student_no";
  ...
  var ajax_error_list = {
    "audition_title": {"label": "Audition Title", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "venue_id": {"label": "Venue", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "audition_date": {"label": "Audition Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "audition_fee": {"label": "Audition Fee", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "audition_details": {"label": "Audition Details", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "type": {"label": "Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "location_type": {"label": "Location Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contact_person": {"label": "Contact Person", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "student_no": {"label": "Max Auditionees", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "audition_title": new Array(),
    "venue_id": new Array(),
    "audition_date": new Array(),
    "audition_fee": new Array(),
    "audition_details": new Array(),
    "type": new Array(),
    "location_type": new Array(),
    "contact_person": new Array(),
    "student_no": new Array(),
    "status": new Array()
  };
  ajax_field_mult["audition_title"][1] = "audition_title";
  ajax_field_mult["venue_id"][1] = "venue_id";
  ajax_field_mult["audition_date"][1] = "audition_date";
  ajax_field_mult["audition_fee"][1] = "audition_fee";
  ajax_field_mult["audition_details"][1] = "audition_details";
  ajax_field_mult["type"][1] = "type";
  ajax_field_mult["location_type"][1] = "location_type";
  ajax_field_mult["contact_person"][1] = "contact_person";
  ajax_field_mult["student_no"][1] = "student_no";
  ajax_field_mult["status"][1] = "status";

  var ajax_field_id = {
    "audition_title": new Array("hidden_field_label_audition_title", "hidden_field_data_audition_title"),
    "venue_id": new Array("hidden_field_label_venue_id", "hidden_field_data_venue_id"),
    "audition_date": new Array("hidden_field_label_audition_date", "hidden_field_data_audition_date"),
    "audition_fee": new Array("hidden_field_label_audition_fee", "hidden_field_data_audition_fee"),
    "audition_details": new Array("hidden_field_label_audition_details", "hidden_field_data_audition_details"),
    "type": new Array("hidden_field_label_type", "hidden_field_data_type"),
    "location_type": new Array("hidden_field_label_location_type", "hidden_field_data_location_type"),
    "contact_person": new Array("hidden_field_label_contact_person", "hidden_field_data_contact_person"),
    "student_no": new Array("hidden_field_label_student_no", "hidden_field_data_student_no"),
