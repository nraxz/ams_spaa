...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_audition_date_hora' + iSeqRow).bind('blur', function() { sc_form_audition_admin_audition_date_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_audition_admin_audition_date_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_audition_fee' + iSeqRow).bind('blur', function() { sc_form_audition_admin_audition_fee_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_audition_admin_audition_fee_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_student_no' + iSeqRow).bind('blur', function() { sc_form_audition_admin_student_no_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_audition_admin_student_no_onchange(this, iSeqRow) })
...
function sc_form_audition_admin_audition_date_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_audition_admin_validate_audition_date();
  scCssBlur(oThis);
}
...
function sc_form_audition_admin_audition_date_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_audition_admin_audition_fee_onchange(oThis, iSeqRow) {
  scJQSlideValue("audition_fee" + iSeqRow, iSeqRow);
}
...
function sc_form_audition_admin_student_no_onchange(oThis, iSeqRow) {
  scJQSlideValue("student_no" + iSeqRow, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_audition_admin_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_audition_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_audition_admin_validate_audition_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_submitted_on" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_audition_admin_validate_submitted_on(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
