...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_audition_admin_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_audition_admin_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_audition_admin']['error_buffer']) && '' != $_SESSION['scriptcase']['form_audition_admin']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_audition_admin']['error_buffer'];
}
...
<?php
 include_once("form_audition_admin_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_audition_admin_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_audition_admin_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_audition_admin_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_audition_title_line" id="hidden_field_data_audition_title" style="<?php echo $sStyleHidden_audition_title; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_audition_title_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_audition_title_label"><span id="id_label_audition_title"><?php echo $this->nm_new_label['audition_title']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_venue_id_line" id="hidden_field_data_venue_id" style="<?php echo $sStyleHidden_venue_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_venue_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_venue_id_label"><span id="id_label_venue_id"><?php echo $this->nm_new_label['venue_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_audition_date_line" id="hidden_field_data_audition_date" style="<?php echo $sStyleHidden_audition_date; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_audition_date_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_audition_date_label"><span id="id_label_audition_date"><?php echo $this->nm_new_label['audition_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['php_cmp_required']['audition_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['php_cmp_required']['audition_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_audition_fee_line" id="hidden_field_data_audition_fee" style="<?php echo $sStyleHidden_audition_fee; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_audition_fee_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_audition_fee_label"><span id="id_label_audition_fee"><?php echo $this->nm_new_label['audition_fee']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_audition_details_line" id="hidden_field_data_audition_details" style="<?php echo $sStyleHidden_audition_details; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_audition_details_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_audition_details_label"><span id="id_label_audition_details"><?php echo $this->nm_new_label['audition_details']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_type_line" id="hidden_field_data_type" style="<?php echo $sStyleHidden_type; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_type_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_type_label"><span id="id_label_type"><?php echo $this->nm_new_label['type']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['Lookup_type'][] = 'Primary'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['Lookup_type'][] = 'Recall'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_location_type_line" id="hidden_field_data_location_type" style="<?php echo $sStyleHidden_location_type; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_location_type_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_location_type_label"><span id="id_label_location_type"><?php echo $this->nm_new_label['location_type']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['Lookup_location_type'][] = 'Internal'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['Lookup_location_type'][] = 'Outreach'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['Lookup_location_type'][] = 'Video'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_contact_person_line" id="hidden_field_data_contact_person" style="<?php echo $sStyleHidden_contact_person; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contact_person_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_contact_person_label"><span id="id_label_contact_person"><?php echo $this->nm_new_label['contact_person']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_student_no_line" id="hidden_field_data_student_no" style="<?php echo $sStyleHidden_student_no; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_student_no_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_student_no_label"><span id="id_label_student_no"><?php echo $this->nm_new_label['student_no']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_audition_admin_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_audition_admin_mob");
 parent.scAjaxDetailHeight("form_audition_admin_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
