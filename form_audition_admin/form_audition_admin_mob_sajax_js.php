  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_audition_admin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_audition_admin_mob_validate_audition_title()
  {
    var nomeCampo_audition_title = "audition_title";
    var var_audition_title = scAjaxGetFieldText(nomeCampo_audition_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_audition_title(var_audition_title, var_script_case_init, do_ajax_form_audition_admin_mob_validate_audition_title_cb);
  } // do_ajax_form_audition_admin_mob_validate_audition_title

  function do_ajax_form_audition_admin_mob_validate_audition_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_audition_title_cb

  // ---------- Validate venue_id
  function do_ajax_form_audition_admin_mob_validate_venue_id()
  {
    var nomeCampo_venue_id = "venue_id";
    var var_venue_id = scAjaxGetFieldSelect(nomeCampo_venue_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_venue_id(var_venue_id, var_script_case_init, do_ajax_form_audition_admin_mob_validate_venue_id_cb);
  } // do_ajax_form_audition_admin_mob_validate_venue_id

  function do_ajax_form_audition_admin_mob_validate_venue_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_venue_id_cb

  // ---------- Validate audition_date
  function do_ajax_form_audition_admin_mob_validate_audition_date()
  {
    var nomeCampo_audition_date = "audition_date";
    var var_audition_date = scAjaxGetFieldText(nomeCampo_audition_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_audition_date(var_audition_date, var_script_case_init, do_ajax_form_audition_admin_mob_validate_audition_date_cb);
  } // do_ajax_form_audition_admin_mob_validate_audition_date

  function do_ajax_form_audition_admin_mob_validate_audition_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_audition_date_cb

  // ---------- Validate audition_fee
  function do_ajax_form_audition_admin_mob_validate_audition_fee()
  {
    var nomeCampo_audition_fee = "audition_fee";
    var var_audition_fee = scAjaxGetFieldText(nomeCampo_audition_fee);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_audition_fee(var_audition_fee, var_script_case_init, do_ajax_form_audition_admin_mob_validate_audition_fee_cb);
  } // do_ajax_form_audition_admin_mob_validate_audition_fee

  function do_ajax_form_audition_admin_mob_validate_audition_fee_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_audition_fee_cb

  // ---------- Validate audition_details
  function do_ajax_form_audition_admin_mob_validate_audition_details()
  {
    var nomeCampo_audition_details = "audition_details";
    var var_audition_details = scAjaxGetFieldText(nomeCampo_audition_details);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_audition_details(var_audition_details, var_script_case_init, do_ajax_form_audition_admin_mob_validate_audition_details_cb);
  } // do_ajax_form_audition_admin_mob_validate_audition_details

  function do_ajax_form_audition_admin_mob_validate_audition_details_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_audition_details_cb

  // ---------- Validate type
  function do_ajax_form_audition_admin_mob_validate_type()
  {
    var nomeCampo_type = "type";
    var var_type = scAjaxGetFieldRadio(nomeCampo_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_type(var_type, var_script_case_init, do_ajax_form_audition_admin_mob_validate_type_cb);
  } // do_ajax_form_audition_admin_mob_validate_type

  function do_ajax_form_audition_admin_mob_validate_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_type_cb

  // ---------- Validate location_type
  function do_ajax_form_audition_admin_mob_validate_location_type()
  {
    var nomeCampo_location_type = "location_type";
    var var_location_type = scAjaxGetFieldRadio(nomeCampo_location_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_location_type(var_location_type, var_script_case_init, do_ajax_form_audition_admin_mob_validate_location_type_cb);
  } // do_ajax_form_audition_admin_mob_validate_location_type

  function do_ajax_form_audition_admin_mob_validate_location_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_location_type_cb

  // ---------- Validate contact_person
  function do_ajax_form_audition_admin_mob_validate_contact_person()
  {
    var nomeCampo_contact_person = "contact_person";
    var var_contact_person = scAjaxGetFieldSelect(nomeCampo_contact_person);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_contact_person(var_contact_person, var_script_case_init, do_ajax_form_audition_admin_mob_validate_contact_person_cb);
  } // do_ajax_form_audition_admin_mob_validate_contact_person

  function do_ajax_form_audition_admin_mob_validate_contact_person_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_contact_person_cb

  // ---------- Validate student_no
  function do_ajax_form_audition_admin_mob_validate_student_no()
  {
    var nomeCampo_student_no = "student_no";
    var var_student_no = scAjaxGetFieldText(nomeCampo_student_no);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_student_no(var_student_no, var_script_case_init, do_ajax_form_audition_admin_mob_validate_student_no_cb);
  } // do_ajax_form_audition_admin_mob_validate_student_no

  function do_ajax_form_audition_admin_mob_validate_student_no_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_student_no_cb

  // ---------- Validate status
  function do_ajax_form_audition_admin_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_admin_mob_validate_status(var_status, var_script_case_init, do_ajax_form_audition_admin_mob_validate_status_cb);
  } // do_ajax_form_audition_admin_mob_validate_status

  function do_ajax_form_audition_admin_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_admin_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_audition_admin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_audition_admin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_audition_admin_mob_submit_form(var_audition_title, var_venue_id, var_audition_date, var_audition_fee, var_audition_details, var_type, var_location_type, var_contact_person, var_student_no, var_status, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_audition_admin_mob_submit_form_cb);
  } // do_ajax_form_audition_admin_mob_submit_form

  function do_ajax_form_audition_admin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_audition_admin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_audition_admin_mob_submit_form_cb
  function do_ajax_form_audition_admin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_audition_admin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_audition_admin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_audition_admin_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_audition_admin_mob_navigate_form_cb);
  } // do_ajax_form_audition_admin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_admin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_audition_admin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_audition_admin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_audition_admin_mob_navigate_form_cb
  function do_ajax_form_audition_admin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_audition_admin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_audition_admin_mob_navigate_form_cb_after_alert
  function sc_hide_form_audition_admin_mob_form()
  {
