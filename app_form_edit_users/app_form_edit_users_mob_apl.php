   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']['label'] = "Edit User";
...
<HEAD>
 <TITLE><?php echo strip_tags("Edit User") ?></TITLE>
...
$salt = 'Iamsalt';
$this->pswd  = md5(md5($salt).md5($this->pswd ));

$string_login = $this->randStrGen(6);
$salt_val = time();
$this->login  = $salt_val.$string_login;
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "firstname = '$this->firstname', lastname = '$this->lastname', email = '$this->email', active = '$this->active'"; 
              } 
          ...
          $this->priv_admin = $this->priv_admin_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('firstname', 'lastname', 'email', 'pswd', 'confirm_pswd', 'active', 'groups'), $aDoNotUpdate);
              $this->ajax_return_values();
