...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate firstname
  function do_ajax_app_form_edit_users_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_firstname_cb);
  } // do_ajax_app_form_edit_users_mob_validate_firstname

  function do_ajax_app_form_edit_users_mob_validate_firstname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_app_form_edit_users_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_app_form_edit_users_mob_validate_lastname_cb);
  } // do_ajax_app_form_edit_users_mob_validate_lastname

  function do_ajax_app_form_edit_users_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_mob_validate_lastname_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_mob_submit_form(var_firstname, var_lastname, var_email, var_pswd, var_confirm_pswd, var_active, var_groups, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_mob_submit_form_cb);
