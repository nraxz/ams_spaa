<?php
@session_start() ;
$_SESSION['scriptcase']['grid_upload_files']['sc_process_barr'] = true;
require_once('../grid_upload_files/index.php');
unset($_SESSION['scriptcase']['grid_upload_files']['sc_process_barr']);
$ExportCtrl = new grid_upload_files_export_control;
$ExportCtrl->Export_barr();

class grid_upload_files_export_control
{
