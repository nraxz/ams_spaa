<?php
@session_start() ;
$_SESSION['scriptcase']['admin_grid_disability']['sc_process_barr'] = true;
require_once('../admin_grid_disability/index.php');
unset($_SESSION['scriptcase']['admin_grid_disability']['sc_process_barr']);
$ExportCtrl = new admin_grid_disability_export_control;
$ExportCtrl->Export_barr();

class admin_grid_disability_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> disability :: Excel</TITLE>
