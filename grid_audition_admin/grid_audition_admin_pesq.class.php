...
class grid_audition_admin_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_audition_admin/grid_audition_admin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_audition_admin_ajax_search.js"></script>
 <script type="text/javascript" src="grid_audition_admin_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_audition_admin_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_audition_admin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_audition_admin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $venue_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['venue_id']; 
          $venue_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['venue_id_cond']; 
          $audition_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_dia']; 
          $audition_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_mes']; 
          $audition_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_ano']; 
          $audition_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_dia']; 
          $audition_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_mes']; 
          $audition_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_ano']; 
          $audition_date_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_hor']; 
          $audition_date_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_min']; 
          $audition_date_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_seg']; 
          $audition_date_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_hor']; 
          $audition_date_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_min']; 
          $audition_date_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_seg']; 
          $audition_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_cond']; 
          $audition_title = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_title']; 
          $audition_title_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_title_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['status_cond']; 
          $type = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['type']; 
          $type_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['type_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_audition_admin_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_audition_admin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_audition_admin']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
    $('#SC_audition_date_input_2_mes').bind('change', function() {sc_grid_audition_admin_valida_mes(this)});
    $('#SC_audition_date_mes').bind('change', function() {sc_grid_audition_admin_valida_mes(this)});
 }
 function sc_grid_audition_admin_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq'] = array();
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['psq_check_ret']['venue_id'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['psq_check_ret']['status'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['venue_id'] = $venue_id; 
      if (is_array($venue_id) && !empty($venue_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0] = $venue_id;
      }
      elseif ($venue_id_cond_salva == "nu" || $venue_id_cond_salva == "nn" || $venue_id_cond_salva == "ep" || $venue_id_cond_salva == "ne" ||  !empty($venue_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][0] = $venue_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['venue_id_cond'] = $venue_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['cmp'] = "venue_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['opc'] = $venue_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['venue_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_dia'] = $audition_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_mes'] = $audition_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_ano'] = $audition_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_dia'] = $audition_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_mes'] = $audition_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_ano'] = $audition_date_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $audition_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $audition_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $audition_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $audition_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $audition_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $audition_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_hor'] = $audition_date_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_min'] = $audition_date_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_seg'] = $audition_date_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_hor'] = $audition_date_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_min'] = $audition_date_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2_seg'] = $audition_date_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $audition_date_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $audition_date_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $audition_date_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $audition_date_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $audition_date_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $audition_date_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_cond'] = $audition_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['cmp'] = "audition_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['opc'] = $audition_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['audition_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_title'] = $audition_title; 
      if (is_array($audition_title) && !empty($audition_title))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0] = $audition_title;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][0] = $audition_title;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_title_cond'] = $audition_title_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['cmp'] = "audition_title"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['opc'] = $audition_title_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['audition_title'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['status'] = $status; 
      if (is_array($status) && !empty($status))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0] = $status;
      }
      elseif ($status_cond_salva == "nu" || $status_cond_salva == "nn" || $status_cond_salva == "ep" || $status_cond_salva == "ne" ||  !empty($status))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][0] = $status;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['status_cond'] = $status_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['cmp'] = "status"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['opc'] = $status_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['status'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['type'] = $type; 
      if (is_array($type) && !empty($type))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0] = $type;
      }
      elseif ($type_cond_salva == "nu" || $type_cond_salva == "nn" || $type_cond_salva == "ep" || $type_cond_salva == "ne" ||  !empty($type))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['val'][0][0] = $type;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['type_cond'] = $type_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['cmp'] = "type"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid]['opc'] = $type_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['type'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($audition_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date'] = $val[0];
          ...
          if ($audition_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']['audition_date_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['audition_date']['label'] = $nmgp_tab_label['audition_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['audition_date']['descr'] = $nmgp_tab_label['audition_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['grid_pesq']['audition_date']['hint']  = $nmgp_tab_label['audition_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_audition_admin']['cond_pesq'] .= $this->NM_operador;
