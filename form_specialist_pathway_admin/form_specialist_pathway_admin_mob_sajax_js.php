  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_specialist_pathway_admin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_specialist_pathway_admin_mob_form();
	}

  // ---------- Validate name
  function do_ajax_form_specialist_pathway_admin_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_specialist_pathway_admin_mob_validate_name(var_name, var_script_case_init, do_ajax_form_specialist_pathway_admin_mob_validate_name_cb);
  } // do_ajax_form_specialist_pathway_admin_mob_validate_name

  function do_ajax_form_specialist_pathway_admin_mob_validate_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_specialist_pathway_admin_mob_validate_name_cb

  // ---------- Validate seq
  function do_ajax_form_specialist_pathway_admin_mob_validate_seq()
  {
    var nomeCampo_seq = "seq";
    var var_seq = scAjaxGetFieldText(nomeCampo_seq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_specialist_pathway_admin_mob_validate_seq(var_seq, var_script_case_init, do_ajax_form_specialist_pathway_admin_mob_validate_seq_cb);
  } // do_ajax_form_specialist_pathway_admin_mob_validate_seq

  function do_ajax_form_specialist_pathway_admin_mob_validate_seq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "seq";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_specialist_pathway_admin_mob_validate_seq_cb

  // ---------- Validate status
  function do_ajax_form_specialist_pathway_admin_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_specialist_pathway_admin_mob_validate_status(var_status, var_script_case_init, do_ajax_form_specialist_pathway_admin_mob_validate_status_cb);
  } // do_ajax_form_specialist_pathway_admin_mob_validate_status

  function do_ajax_form_specialist_pathway_admin_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_specialist_pathway_admin_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_specialist_pathway_admin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_specialist_pathway_admin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_name = scAjaxGetFieldText("name");
    var var_seq = scAjaxGetFieldText("seq");
    ...
    scAjaxProcOn();
    x_ajax_form_specialist_pathway_admin_mob_submit_form(var_name, var_seq, var_status, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_specialist_pathway_admin_mob_submit_form_cb);
  } // do_ajax_form_specialist_pathway_admin_mob_submit_form

  function do_ajax_form_specialist_pathway_admin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_specialist_pathway_admin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_specialist_pathway_admin_mob_submit_form_cb
  function do_ajax_form_specialist_pathway_admin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_specialist_pathway_admin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_specialist_pathway_admin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_specialist_pathway_admin_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb);
  } // do_ajax_form_specialist_pathway_admin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_specialist_pathway_admin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb
  function do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_specialist_pathway_admin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_specialist_pathway_admin_mob_navigate_form_cb_after_alert
  function sc_hide_form_specialist_pathway_admin_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "seq": {"label": "Seq", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
