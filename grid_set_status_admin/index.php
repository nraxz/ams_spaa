<?php
   include_once('grid_set_status_admin_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_set_status_admin_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_set_status_admin"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_set_status_admin';
      ...
      if (isset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_set_status_admin']['actual_lang']) || $_SESSION['scriptcase']['grid_set_status_admin']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_set_status_admin']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_set_status_admin_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_add_grid_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['opcao'] = $_GET['origem'];
          $nmgp_opcao = $_GET['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_audition_admin"] = '_self';
      ...
      $this->sc_lig_target["C_@scinf_venue"] = '_self';
      $this->sc_lig_target["C_@scinf_venue_@scinf_grid_venue_audition_nested"] = '_self';
      ...
      $this->sc_lig_target["C_@scinf_contact"] = '_self';
      $this->sc_lig_target["C_@scinf_contact_@scinf_grid_audition_contact_nested"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_set_status_admin"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_set_status_admin"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_set_status_admin_erro.class.php"); 
      $this->Erro = new grid_set_status_admin_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_set_status_admin'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_set_status_admin']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_set_status_admin', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'grid_set_status_admin', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_set_status_admin', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_set_status_admin']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class grid_set_status_admin_sub_css
{
   function __construct()
   {
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_set_status_admin_ini(); 
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_set_status_admin']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_set_status_admin'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_set_status_admin_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_set_status_admin']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_set_status_admin'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_set_status_admin($cadapar[1]);
                       nm_protect_num_grid_set_status_admin($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          if (isset($audition_title)) 
          {
              ...
              nm_limpa_str_grid_set_status_admin($_SESSION["audition_title"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_set_status_admin_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_set_status_admin']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_set_status_admin'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_set_status_admin']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_set_status_admin']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_set_status_admin') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_set_status_admin']['label'] = "Auditions";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("en_us");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_set_status_admin/grid_set_status_admin_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_set_status_admin_erro.class.php"); 
      } 
      $this->Erro      = new grid_set_status_admin_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_set_status_admin/grid_set_status_admin_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_set_status_admin_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_set_status_admin_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_set_status_admin_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['save_grid'] = true;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_set_status_admin_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_set_status_admin_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['xls_return'] = ($nmgp_opcao == "xls") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['csv_return'] = ($nmgp_opcao == "csv") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['xml_return'] = ($nmgp_opcao == "xml") ? "volta_grid" : "resumo"; 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_set_status_admin_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_set_status_admin_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "xml_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['proc_pdf_vert'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['proc_pdf']      = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "audition_card";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "contact";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "venue";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "type";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "location_type";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "student_no";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'][] = "status";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_set_status_admin']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_set_status_admin']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['grid_set_status_admin']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_set_status_admin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_set_status_admin']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['contr_array_resumo'] = "NAO";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = 'pesq';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_set_status_admin_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_set_status_admin_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_set_status_admin_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['prim_cons'] = true;  
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_set_status_admin_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_set_status_admin.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_set_status_admin_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_set_status_admin_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_set_status_admin_res_" . session_id() . ".doc";
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_set_status_admin . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_set_status_admin_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_set_status_admin_pesq.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_set_status_admin/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_set_status_admin_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_set_status_admin_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_set_status_admin/grid_set_status_admin_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_set_status_admin_grid.class.php"); 
          } 
          $this->grid  = new grid_set_status_admin_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if (!is_file($nm_arquivo_pdf_serv))
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['grid_pesq']);
               continue;
           }
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
           ...
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "audition_date")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                   }
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_set_status_admin_pesq.class.php"); 
   ...
   function proc_del_grid_search($cmp_del, $del_all)
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (in_array($cmp_del, array('audition_date')))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_hor"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_min"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_seg"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_hor"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_min"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2_seg"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<form name="Fdown" method="get" action="grid_set_status_admin_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_set_status_admin"> 
...
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_set_status_admin'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_set_status_admin']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_set_status_admin($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_set_status_admin($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_set_status_admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_set_status_admin") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
               $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_set_status_admin']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_set_status_admin']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_set_status_admin']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']);
               $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_set_status_admin']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_set_status_admin']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_set_status_admin']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_set_status_admin']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_set_status_admin']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_set_status_admin']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_set_status_admin";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_set_status_admin' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_set_status_admin/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "en_us";
   if (isset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetAmour/Sc9_SweetAmour";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_set_status_admin')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_set_status_admin_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_set_status_admin_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_set_status_admin_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_set_status_admin'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_set_status_admin'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_set_status_admin']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_set_status_admin']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_set_status_admin'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
...
<?php
       ...
       $contr_grid_set_status_admin = new grid_set_status_admin_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['opcao'] = "busca";
          $contr_grid_set_status_admin->NM_ajax_flag = true;
          $contr_grid_set_status_admin->NM_ajax_opcao = $NM_ajax_opcao;
      }
       $contr_grid_set_status_admin->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_set_status_admin']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_set_status_admin(&$str)
   {
   ...
   function nm_protect_num_grid_set_status_admin($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_set_status_admin_pack_protect_string($sString)
   {
