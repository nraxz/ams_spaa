<?php
@session_start() ;
$_SESSION['scriptcase']['grid_set_status_admin']['sc_process_barr'] = true;
require_once('../grid_set_status_admin/index.php');
unset($_SESSION['scriptcase']['grid_set_status_admin']['sc_process_barr']);
$ExportCtrl = new grid_set_status_admin_export_control;
$ExportCtrl->Export_barr();

class grid_set_status_admin_export_control
{
