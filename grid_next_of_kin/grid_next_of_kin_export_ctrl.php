<?php
@session_start() ;
$_SESSION['scriptcase']['grid_next_of_kin']['sc_process_barr'] = true;
require_once('../grid_next_of_kin/index.php');
unset($_SESSION['scriptcase']['grid_next_of_kin']['sc_process_barr']);
$ExportCtrl = new grid_next_of_kin_export_control;
$ExportCtrl->Export_barr();

class grid_next_of_kin_export_control
{
