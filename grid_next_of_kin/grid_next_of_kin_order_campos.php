...
<?php
   ...
   $Ord_Cmp = new grid_next_of_kin_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_next_of_kin_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fullname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["fullname"])) ? $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["fullname"] : "Fullname";
   $tab_ger_campos['mobile'] = "on";
   $tab_def_campos['mobile'] = "mobile";
   $tab_converte["mobile"]   = "mobile";
   $tab_labels["mobile"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["mobile"])) ? $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["mobile"] : "Mobile";
   $tab_ger_campos['relationships'] = "on";
   $tab_def_campos['relationships'] = "relationships";
   $tab_converte["relationships"]   = "relationships";
   $tab_labels["relationships"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["relationships"])) ? $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['labels']["relationships"] : "Relationships";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_next_of_kin_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_next_of_kin']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
