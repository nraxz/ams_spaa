...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_next_of_kin"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_next_of_kin"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_next_of_kin'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_next_of_kin']['embutida_filho'] as $ind => $sc_init)
          {
