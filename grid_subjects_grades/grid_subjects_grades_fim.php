...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_subjects_grades"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_subjects_grades"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_subjects_grades</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_subjects_grades']['embutida_filho'] as $ind => $sc_init)
          {
