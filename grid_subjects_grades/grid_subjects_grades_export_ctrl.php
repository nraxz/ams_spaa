<?php
@session_start() ;
$_SESSION['scriptcase']['grid_subjects_grades']['sc_process_barr'] = true;
require_once('../grid_subjects_grades/index.php');
unset($_SESSION['scriptcase']['grid_subjects_grades']['sc_process_barr']);
$ExportCtrl = new grid_subjects_grades_export_control;
$ExportCtrl->Export_barr();

class grid_subjects_grades_export_control
{
