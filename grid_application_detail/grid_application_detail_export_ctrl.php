<?php
@session_start() ;
$_SESSION['scriptcase']['grid_application_detail']['sc_process_barr'] = true;
require_once('../grid_application_detail/index.php');
unset($_SESSION['scriptcase']['grid_application_detail']['sc_process_barr']);
$ExportCtrl = new grid_application_detail_export_control;
$ExportCtrl->Export_barr();

class grid_application_detail_export_control
{
...
<HEAD>
 <TITLE>Audition Booking details :: Excel</TITLE>
