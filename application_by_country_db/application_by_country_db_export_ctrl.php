<?php
@session_start() ;
$_SESSION['scriptcase']['application_by_country_db']['sc_process_barr'] = true;
require_once('../application_by_country_db/index.php');
unset($_SESSION['scriptcase']['application_by_country_db']['sc_process_barr']);
$ExportCtrl = new application_by_country_db_export_control;
$ExportCtrl->Export_barr();

class application_by_country_db_export_control
{
