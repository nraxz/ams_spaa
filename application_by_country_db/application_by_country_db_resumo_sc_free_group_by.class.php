...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "application_by_country_db/application_by_country_db_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
