...
class application_by_country_db_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "application_by_country_db" . $this->Xls_tp;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['pivot_group_by'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_res_sheet'] = $this->Xls_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['application_by_country_db']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
