...
// 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['changepassword'])) ? $this->New_label['changepassword'] : "Password"; 
...
$_SESSION['scriptcase']['app_grid_sec_users']['contr_erro'] = 'off';
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "login*scin" . $this->login . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              ...
              {
                  $Md5_Edt  = "login*scin" . $this->login . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
              }
 ...
 function NM_grid_changepassword()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['changepassword']) || $this->NM_cmp_hidden['changepassword'] != "off") { 
          $conteudo = sc_strip_script($this->changepassword); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_changepassword_grid_line . "\"  style=\"" . $this->Css_Cmp['css_changepassword_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['Ind_lig_mult']++;
       $linkTarget = isset($this->Ini->sc_lig_target['C_@scinf_changepassword_@scinf_app_form_password_change']) ? $this->Ini->sc_lig_target['C_@scinf_changepassword_@scinf_app_form_password_change'] : (isset($this->Ini->sc_lig_target['C_@scinf_changepassword']) ? $this->Ini->sc_lig_target['C_@scinf_changepassword'] : null);
       if (isset($this->Ini->sc_lig_md5["app_form_password_change"]) && $this->Ini->sc_lig_md5["app_form_password_change"] == "S") {
