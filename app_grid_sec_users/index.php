...
class app_grid_sec_users_ini
{
   ...
   var $link_app_form_password_change_edit;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
<?php
      ...
      $Tmp_apl_lig = "app_form_password_change";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/app_form_password_change_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/app_form_password_change_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/app_form_password_change_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/app_form_password_change_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["app_form_password_change"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_changepassword"] = '_self';
      $this->sc_lig_target["C_@scinf_changepassword_@scinf_app_form_password_change"] = '_self';
      ...
      $this->link_app_form_password_change_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('app_form_password_change') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['field_order'][] = "firstname";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['field_order'][] = "lastname";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['field_order'][] = "changepassword";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
               $_SESSION['scriptcase']['app_grid_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
           }
       }
   }
