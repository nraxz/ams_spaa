...
$_SESSION['scriptcase']['app_grid_sec_users']['contr_erro'] = 'off'; 
   ...
   function NM_export_lastname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lastname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lastname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- email
   ...
   function NM_export_changepassword()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->changepassword = html_entity_decode($this->changepassword, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->changepassword = strip_tags($this->changepassword);
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->changepassword, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->changepassword, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- firstname
   ...
   function NM_sub_cons_lastname()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lastname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- changepassword
   function NM_sub_cons_changepassword()
   {
         $this->changepassword = html_entity_decode($this->changepassword, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->changepassword = strip_tags($this->changepassword);
         if (!NM_is_utf8($this->changepassword))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->changepassword;
