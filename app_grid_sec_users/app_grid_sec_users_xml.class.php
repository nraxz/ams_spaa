...
$_SESSION['scriptcase']['app_grid_sec_users']['contr_erro'] = 'off'; 
   ...
   function NM_export_changepassword()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->changepassword))
         {
          ...
          {
              $SC_Label = "changepassword"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->changepassword) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->changepassword) . "\"";
         }
   }
