  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_admin_form_disability" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_admin_form_disability_form();
	}

  // ---------- Validate hesa_code
  function do_ajax_admin_form_disability_validate_hesa_code()
  {
    var nomeCampo_hesa_code = "hesa_code";
    var var_hesa_code = scAjaxGetFieldText(nomeCampo_hesa_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_validate_hesa_code(var_hesa_code, var_script_case_init, do_ajax_admin_form_disability_validate_hesa_code_cb);
  } // do_ajax_admin_form_disability_validate_hesa_code

  function do_ajax_admin_form_disability_validate_hesa_code_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_validate_hesa_code_cb

  // ---------- Validate label
  function do_ajax_admin_form_disability_validate_label()
  {
    var nomeCampo_label = "label";
    var var_label = scAjaxGetFieldText(nomeCampo_label);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_validate_label(var_label, var_script_case_init, do_ajax_admin_form_disability_validate_label_cb);
  } // do_ajax_admin_form_disability_validate_label

  function do_ajax_admin_form_disability_validate_label_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "label";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_validate_label_cb

  // ---------- Validate status
  function do_ajax_admin_form_disability_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_validate_status(var_status, var_script_case_init, do_ajax_admin_form_disability_validate_status_cb);
  } // do_ajax_admin_form_disability_validate_status

  function do_ajax_admin_form_disability_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_admin_form_disability_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_admin_form_disability_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_admin_form_disability_submit_form(var_hesa_code, var_label, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_admin_form_disability_submit_form_cb);
  } // do_ajax_admin_form_disability_submit_form

  function do_ajax_admin_form_disability_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_admin_form_disability_submit_form_cb_after_alert);
  } // do_ajax_admin_form_disability_submit_form_cb
  function do_ajax_admin_form_disability_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_admin_form_disability_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_admin_form_disability_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_admin_form_disability_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_admin_form_disability_navigate_form_cb);
  } // do_ajax_admin_form_disability_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_disability']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_admin_form_disability_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_admin_form_disability_navigate_form_cb_after_alert);
  } // do_ajax_admin_form_disability_navigate_form_cb
  function do_ajax_admin_form_disability_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_admin_form_disability_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_admin_form_disability_navigate_form_cb_after_alert
  function sc_hide_admin_form_disability_form()
  {
