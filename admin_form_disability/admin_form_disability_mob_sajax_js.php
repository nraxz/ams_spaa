  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_admin_form_disability_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_admin_form_disability_mob_form();
	}

  // ---------- Validate hesa_code
  function do_ajax_admin_form_disability_mob_validate_hesa_code()
  {
    var nomeCampo_hesa_code = "hesa_code";
    var var_hesa_code = scAjaxGetFieldText(nomeCampo_hesa_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_mob_validate_hesa_code(var_hesa_code, var_script_case_init, do_ajax_admin_form_disability_mob_validate_hesa_code_cb);
  } // do_ajax_admin_form_disability_mob_validate_hesa_code

  function do_ajax_admin_form_disability_mob_validate_hesa_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hesa_code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_mob_validate_hesa_code_cb

  // ---------- Validate label
  function do_ajax_admin_form_disability_mob_validate_label()
  {
    var nomeCampo_label = "label";
    var var_label = scAjaxGetFieldText(nomeCampo_label);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_mob_validate_label(var_label, var_script_case_init, do_ajax_admin_form_disability_mob_validate_label_cb);
  } // do_ajax_admin_form_disability_mob_validate_label

  function do_ajax_admin_form_disability_mob_validate_label_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "label";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_mob_validate_label_cb

  // ---------- Validate status
  function do_ajax_admin_form_disability_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_disability_mob_validate_status(var_status, var_script_case_init, do_ajax_admin_form_disability_mob_validate_status_cb);
  } // do_ajax_admin_form_disability_mob_validate_status

  function do_ajax_admin_form_disability_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_disability_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_admin_form_disability_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_admin_form_disability_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_hesa_code = scAjaxGetFieldText("hesa_code");
    var var_label = scAjaxGetFieldText("label");
    ...
    scAjaxProcOn();
    x_ajax_admin_form_disability_mob_submit_form(var_hesa_code, var_label, var_status, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_admin_form_disability_mob_submit_form_cb);
  } // do_ajax_admin_form_disability_mob_submit_form

  function do_ajax_admin_form_disability_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("hesa_code");
      scAjaxHideErrorDisplay("label");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_admin_form_disability_mob_submit_form_cb_after_alert);
  } // do_ajax_admin_form_disability_mob_submit_form_cb
  function do_ajax_admin_form_disability_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_admin_form_disability_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_admin_form_disability_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_admin_form_disability_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_admin_form_disability_mob_navigate_form_cb);
  } // do_ajax_admin_form_disability_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_disability_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_admin_form_disability_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_admin_form_disability_mob_navigate_form_cb_after_alert);
  } // do_ajax_admin_form_disability_mob_navigate_form_cb
  function do_ajax_admin_form_disability_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_admin_form_disability_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_admin_form_disability_mob_navigate_form_cb_after_alert
  function sc_hide_admin_form_disability_mob_form()
  {
  ...
  ajax_field_list[0] = "hesa_code";
  ajax_field_list[1] = "label";
  ...
  var ajax_error_list = {
    "hesa_code": {"label": "Hesa Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "label": {"label": "Label", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["hesa_code"][1] = "hesa_code";
  ajax_field_mult["label"][1] = "label";
  ajax_field_mult["status"][1] = "status";

  var ajax_field_id = {
    "hesa_code": new Array("hidden_field_label_hesa_code", "hidden_field_data_hesa_code"),
    "label": new Array("hidden_field_label_label", "hidden_field_data_label"),
