...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_user_email' + iSeqRow).bind('blur', function() { sc_app_Login_user_email_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_app_Login_user_email_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_app_Login_user_email_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_validate_user_email();
  scCssBlur(oThis);
}

function sc_app_Login_user_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
