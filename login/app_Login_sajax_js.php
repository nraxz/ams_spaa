...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate user_email
  function do_ajax_app_Login_validate_user_email()
  {
    var nomeCampo_user_email = "user_email";
    var var_user_email = scAjaxGetFieldText(nomeCampo_user_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_user_email(var_user_email, var_script_case_init, do_ajax_app_Login_validate_user_email_cb);
  } // do_ajax_app_Login_validate_user_email

  function do_ajax_app_Login_validate_user_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_user_email_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    x_ajax_app_Login_submit_form(var_pswd, var_user_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_app_Login_submit_form_cb);
...
?>
  ...
  ajax_field_list[0] = "pswd";
  ajax_field_list[1] = "user_email";
