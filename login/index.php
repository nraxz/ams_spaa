...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS', 1, true);
    }
    else {
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->sc_page]['app_Login'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   if (empty($opc))
   {
       $_SESSION['sc_session'][$this->sc_page]['app_Login']['opcao'] = "";
       $_SESSION['sc_session'][$this->sc_page]['app_Login']['retorno_edit'] = "";
   }
...
{
    return $maintenance = $this->rs[0][0];
...
function getGroup($login_name){
$_SESSION['scriptcase']['app_Login']['contr_erro'] = 'on';
  
	
$check_sql = "SELECT group_id"
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
                $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_Login_validate_user_email' == $_POST['rs'])
        {
        ...
        {
            $pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $user_email = NM_utf8_urldecode($_POST['rsargs'][1]);
    ...
    sajax_export("ajax_app_Login_validate_user_email");
...
//
    ...
    function ajax_app_Login_validate_user_email($user_email, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_user_email';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_app_Login_submit_form($pswd, $user_email, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
