  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_next_of_kin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_next_of_kin_mob_form();
	}

  // ---------- Validate fullname
  function do_ajax_form_next_of_kin_mob_validate_fullname()
  {
    var nomeCampo_fullname = "fullname";
    var var_fullname = scAjaxGetFieldText(nomeCampo_fullname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_next_of_kin_mob_validate_fullname(var_fullname, var_script_case_init, do_ajax_form_next_of_kin_mob_validate_fullname_cb);
  } // do_ajax_form_next_of_kin_mob_validate_fullname

  function do_ajax_form_next_of_kin_mob_validate_fullname_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_next_of_kin_mob_validate_fullname_cb

  // ---------- Validate mobile
  function do_ajax_form_next_of_kin_mob_validate_mobile()
  {
    var nomeCampo_mobile = "mobile";
    var var_mobile = scAjaxGetFieldText(nomeCampo_mobile);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_next_of_kin_mob_validate_mobile(var_mobile, var_script_case_init, do_ajax_form_next_of_kin_mob_validate_mobile_cb);
  } // do_ajax_form_next_of_kin_mob_validate_mobile

  function do_ajax_form_next_of_kin_mob_validate_mobile_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mobile";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_next_of_kin_mob_validate_mobile_cb

  // ---------- Validate relationships
  function do_ajax_form_next_of_kin_mob_validate_relationships()
  {
    var nomeCampo_relationships = "relationships";
    var var_relationships = scAjaxGetFieldText(nomeCampo_relationships);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_next_of_kin_mob_validate_relationships(var_relationships, var_script_case_init, do_ajax_form_next_of_kin_mob_validate_relationships_cb);
  } // do_ajax_form_next_of_kin_mob_validate_relationships

  function do_ajax_form_next_of_kin_mob_validate_relationships_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "relationships";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_next_of_kin_mob_validate_relationships_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_next_of_kin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_next_of_kin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fullname = scAjaxGetFieldText("fullname");
    var var_mobile = scAjaxGetFieldText("mobile");
    var var_relationships = scAjaxGetFieldText("relationships");
    ...
    scAjaxProcOn();
    x_ajax_form_next_of_kin_mob_submit_form(var_fullname, var_mobile, var_relationships, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_next_of_kin_mob_submit_form_cb);
  } // do_ajax_form_next_of_kin_mob_submit_form

  function do_ajax_form_next_of_kin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("relationships");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_next_of_kin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_next_of_kin_mob_submit_form_cb
  function do_ajax_form_next_of_kin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_next_of_kin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_next_of_kin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_next_of_kin_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_next_of_kin_mob_navigate_form_cb);
  } // do_ajax_form_next_of_kin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_next_of_kin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_next_of_kin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_next_of_kin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_next_of_kin_mob_navigate_form_cb
  function do_ajax_form_next_of_kin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_next_of_kin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_next_of_kin_mob_navigate_form_cb_after_alert
  function sc_hide_form_next_of_kin_mob_form()
  {
  ...
  ajax_field_list[1] = "mobile";
  ajax_field_list[2] = "relationships";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fullname": {"label": "Fullname", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mobile": {"label": "Mobile", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "relationships": {"label": "Relationships", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["relationships"][1] = "relationships";
  ...
  var ajax_field_id = {
    ...
    "relationships": new Array("hidden_field_label_relationships", "hidden_field_data_relationships")
  };
