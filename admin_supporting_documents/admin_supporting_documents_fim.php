...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_supporting_documents"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_supporting_documents"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_supporting_documents</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_supporting_documents']['embutida_filho'] as $ind => $sc_init)
          {
