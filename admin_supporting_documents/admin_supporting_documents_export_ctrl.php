<?php
@session_start() ;
$_SESSION['scriptcase']['admin_supporting_documents']['sc_process_barr'] = true;
require_once('../admin_supporting_documents/index.php');
unset($_SESSION['scriptcase']['admin_supporting_documents']['sc_process_barr']);
$ExportCtrl = new admin_supporting_documents_export_control;
$ExportCtrl->Export_barr();

class admin_supporting_documents_export_control
{
...
<HEAD>
 <TITLE>Performing arts training :: Excel</TITLE>
