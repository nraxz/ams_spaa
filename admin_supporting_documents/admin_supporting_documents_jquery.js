...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_admin_supporting_documents').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_admin_supporting_documents').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_admin_supporting_documents').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_admin_supporting_documents').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_admin_supporting_documents').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_admin_supporting_documents').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_admin_supporting_documents').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_admin_supporting_documents').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_admin_supporting_documents').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_admin_supporting_documents').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_admin_supporting_documents').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_admin_supporting_documents').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
