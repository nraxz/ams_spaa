...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_upload_files"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____admin_upload_files"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_upload_files']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admin_upload_files']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admin_upload_files']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admin_upload_files']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admin_upload_files']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>admin_upload_files</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admin_upload_files']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admin_upload_files']['embutida_filho'] as $ind => $sc_init)
          {
