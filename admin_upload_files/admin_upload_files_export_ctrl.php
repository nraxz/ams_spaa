<?php
@session_start() ;
$_SESSION['scriptcase']['admin_upload_files']['sc_process_barr'] = true;
require_once('../admin_upload_files/index.php');
unset($_SESSION['scriptcase']['admin_upload_files']['sc_process_barr']);
$ExportCtrl = new admin_upload_files_export_control;
$ExportCtrl->Export_barr();

class admin_upload_files_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> upload_files :: Excel</TITLE>
