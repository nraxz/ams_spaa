...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_marks_examiners"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_marks_examiners"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_marks_examiners</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_marks_examiners']['embutida_filho'] as $ind => $sc_init)
          {
