<?php
@session_start() ;
$_SESSION['scriptcase']['grid_marks_examiners']['sc_process_barr'] = true;
require_once('../grid_marks_examiners/index.php');
unset($_SESSION['scriptcase']['grid_marks_examiners']['sc_process_barr']);
$ExportCtrl = new grid_marks_examiners_export_control;
$ExportCtrl->Export_barr();

class grid_marks_examiners_export_control
{
