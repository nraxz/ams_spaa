  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_paypal_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_paypal_mob_form();
	}

  // ---------- Validate description
  function do_ajax_control_paypal_mob_validate_description()
  {
  } // do_ajax_control_paypal_mob_validate_description

  function do_ajax_control_paypal_mob_validate_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_description_cb

  // ---------- Validate login
  function do_ajax_control_paypal_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_paypal_mob_validate_login(var_login, var_script_case_init, do_ajax_control_paypal_mob_validate_login_cb);
  } // do_ajax_control_paypal_mob_validate_login

  function do_ajax_control_paypal_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_login_cb

  // ---------- Validate application_fee
  function do_ajax_control_paypal_mob_validate_application_fee()
  {
    var nomeCampo_application_fee = "application_fee";
    var var_application_fee = scAjaxGetFieldHidden(nomeCampo_application_fee);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_paypal_mob_validate_application_fee(var_application_fee, var_script_case_init, do_ajax_control_paypal_mob_validate_application_fee_cb);
  } // do_ajax_control_paypal_mob_validate_application_fee

  function do_ajax_control_paypal_mob_validate_application_fee_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_application_fee_cb

  // ---------- Validate booking_id
  function do_ajax_control_paypal_mob_validate_booking_id()
  {
    var nomeCampo_booking_id = "booking_id";
    var var_booking_id = scAjaxGetFieldHidden(nomeCampo_booking_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_paypal_mob_validate_booking_id(var_booking_id, var_script_case_init, do_ajax_control_paypal_mob_validate_booking_id_cb);
  } // do_ajax_control_paypal_mob_validate_booking_id

  function do_ajax_control_paypal_mob_validate_booking_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_booking_id_cb

  // ---------- Validate venue_id
  function do_ajax_control_paypal_mob_validate_venue_id()
  {
    var nomeCampo_venue_id = "venue_id";
    var var_venue_id = scAjaxGetFieldHidden(nomeCampo_venue_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_paypal_mob_validate_venue_id(var_venue_id, var_script_case_init, do_ajax_control_paypal_mob_validate_venue_id_cb);
  } // do_ajax_control_paypal_mob_validate_venue_id

  function do_ajax_control_paypal_mob_validate_venue_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_venue_id_cb

  // ---------- Validate audition_id
  function do_ajax_control_paypal_mob_validate_audition_id()
  {
    var nomeCampo_audition_id = "audition_id";
    var var_audition_id = scAjaxGetFieldHidden(nomeCampo_audition_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_paypal_mob_validate_audition_id(var_audition_id, var_script_case_init, do_ajax_control_paypal_mob_validate_audition_id_cb);
  } // do_ajax_control_paypal_mob_validate_audition_id

  function do_ajax_control_paypal_mob_validate_audition_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_audition_id_cb

  // ---------- Validate venue_booking
  function do_ajax_control_paypal_mob_validate_venue_booking()
  {
  } // do_ajax_control_paypal_mob_validate_venue_booking

  function do_ajax_control_paypal_mob_validate_venue_booking_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_paypal_mob_validate_venue_booking_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_paypal_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_paypal_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_paypal_mob_submit_form(var_description, var_login, var_application_fee, var_booking_id, var_venue_id, var_audition_id, var_venue_booking, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_paypal_mob_submit_form_cb);
  } // do_ajax_control_paypal_mob_submit_form

  function do_ajax_control_paypal_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_paypal_mob_submit_form_cb_after_alert);
  } // do_ajax_control_paypal_mob_submit_form_cb
  function do_ajax_control_paypal_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_paypal_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_paypal_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_paypal_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_paypal_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_paypal_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_paypal_mob_navigate_form_cb
  function do_ajax_control_paypal_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_paypal_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_paypal_mob_navigate_form_cb_after_alert
  function sc_hide_control_paypal_mob_form()
  {
