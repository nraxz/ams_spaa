...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['control_paypal']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['control_paypal']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_paypal']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_paypal']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_paypal']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_paypal']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_paypal']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_paypal']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_paypal']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_paypal_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['initialize'])
          {
...
$_SESSION['scriptcase']['control_paypal']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['control_paypal']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_paypal']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_paypal'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_paypal']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_paypal']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_paypal') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_paypal']['label'] = "control_paypal";
      ...
      $_SESSION['scriptcase']['error_icon']['control_paypal']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_paypal'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_paypal']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_paypal'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['control_paypal'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_paypal_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_paypal_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_paypal/control_paypal_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_paypal_erro.class.php"); 
      }
      $this->Erro      = new control_paypal_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_paypal']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['final'];
      }
      else
      {
      }
...
//
      $this->sc_evento = $this->nmgp_opcao;
        if (!isset($this->NM_ajax_flag) || ('validate_' != substr($this->NM_ajax_opcao, 0, 9) && 'add_new_line' != $this->NM_ajax_opcao))
        {
            if (isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($this->nmgp_opcao) && 'paypal' == $this->nmgp_opcao)
            {
                ...
                $p->add_field('business', 'develop@considerthisuk.com');
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->description = "";
          $this->venue_booking = "";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos']))
              { 
                  $description = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][0]; 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][1]; 
                  $application_fee = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][2]; 
                  $booking_id = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][3]; 
                  $venue_id = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][4]; 
                  $audition_id = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][5]; 
                  $venue_booking = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][6]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][0] = $this->description; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][1] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][2] = $this->application_fee; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][3] = $this->booking_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][4] = $this->venue_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][5] = $this->audition_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['campos'][6] = $this->venue_booking; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_paypal", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("control_paypal_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_paypal.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_paypal_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_paypal"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_paypal', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'control_paypal', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'control_paypal', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_paypal']) || !is_array($this->NM_ajax_info['errList']['geral_control_paypal']))
              {
                  $this->NM_ajax_info['errList']['geral_control_paypal'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_paypal'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_application_fee(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->application_fee === "" || is_null($this->application_fee))  
      { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values_venue_id($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['venue_id'] = array(
              ...
              $this->NM_ajax_info['fldList']['venue_id']['lookupCons'] = control_paypal_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_audition_id($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['audition_id'] = array(
              ...
              $this->NM_ajax_info['fldList']['audition_id']['lookupCons'] = control_paypal_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_venue_booking($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['control_paypal']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("control_paypal_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "control_paypal_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_paypal_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_paypal']['retorno_edit'] = "";
   }
