<?php
@session_start() ;
$_SESSION['scriptcase']['grid_assign_panel_admin']['sc_process_barr'] = true;
require_once('../grid_assign_panel_admin/index.php');
unset($_SESSION['scriptcase']['grid_assign_panel_admin']['sc_process_barr']);
$ExportCtrl = new grid_assign_panel_admin_export_control;
$ExportCtrl->Export_barr();

class grid_assign_panel_admin_export_control
{
