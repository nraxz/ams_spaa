...
//----------- 
   ...
   {
      global $sc_where;
      $sc_where_pos = " WHERE ((group_id < $this->group_id_) OR (group_id = $this->group_id_ AND app_name < '" . substr($this->Db->qstr($this->app_name_), 1, -1) . "'))";
      if ('' != $sc_where)
      {
      ...
      if ('' != $this->group_id_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
