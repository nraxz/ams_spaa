...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_name\" /></a>";
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_access\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_insert\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_delete\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_update\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_export\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
...
<?php
      ...
      $link_img = empty($nome_img) ? '' : $link_a . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_print\" /></a>";
      $SC_Label = $link_a . $SC_Label . "</a>";
?>
<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center">
<?php
