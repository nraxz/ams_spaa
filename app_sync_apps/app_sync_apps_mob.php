...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'SPAA_AMS', 1, true);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
                $_SESSION['scriptcase']['app_sync_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
            }
        }
    }
