  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_venue_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_venue_admin_form();
	}

  // ---------- Validate venue_name
  function do_ajax_form_venue_admin_validate_venue_name()
  {
    var nomeCampo_venue_name = "venue_name";
    var var_venue_name = scAjaxGetFieldText(nomeCampo_venue_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_venue_name(var_venue_name, var_script_case_init, do_ajax_form_venue_admin_validate_venue_name_cb);
  } // do_ajax_form_venue_admin_validate_venue_name

  function do_ajax_form_venue_admin_validate_venue_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_venue_name_cb

  // ---------- Validate address_1
  function do_ajax_form_venue_admin_validate_address_1()
  {
    var nomeCampo_address_1 = "address_1";
    var var_address_1 = scAjaxGetFieldText(nomeCampo_address_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_address_1(var_address_1, var_script_case_init, do_ajax_form_venue_admin_validate_address_1_cb);
  } // do_ajax_form_venue_admin_validate_address_1

  function do_ajax_form_venue_admin_validate_address_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_address_1_cb

  // ---------- Validate address_2
  function do_ajax_form_venue_admin_validate_address_2()
  {
    var nomeCampo_address_2 = "address_2";
    var var_address_2 = scAjaxGetFieldText(nomeCampo_address_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_address_2(var_address_2, var_script_case_init, do_ajax_form_venue_admin_validate_address_2_cb);
  } // do_ajax_form_venue_admin_validate_address_2

  function do_ajax_form_venue_admin_validate_address_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_address_2_cb

  // ---------- Validate town_city
  function do_ajax_form_venue_admin_validate_town_city()
  {
    var nomeCampo_town_city = "town_city";
    var var_town_city = scAjaxGetFieldText(nomeCampo_town_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_town_city(var_town_city, var_script_case_init, do_ajax_form_venue_admin_validate_town_city_cb);
  } // do_ajax_form_venue_admin_validate_town_city

  function do_ajax_form_venue_admin_validate_town_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_town_city_cb

  // ---------- Validate postcode
  function do_ajax_form_venue_admin_validate_postcode()
  {
    var nomeCampo_postcode = "postcode";
    var var_postcode = scAjaxGetFieldText(nomeCampo_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_postcode(var_postcode, var_script_case_init, do_ajax_form_venue_admin_validate_postcode_cb);
  } // do_ajax_form_venue_admin_validate_postcode

  function do_ajax_form_venue_admin_validate_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_postcode_cb

  // ---------- Validate county
  function do_ajax_form_venue_admin_validate_county()
  {
    var nomeCampo_county = "county";
    var var_county = scAjaxGetFieldText(nomeCampo_county);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_county(var_county, var_script_case_init, do_ajax_form_venue_admin_validate_county_cb);
  } // do_ajax_form_venue_admin_validate_county

  function do_ajax_form_venue_admin_validate_county_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "county";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_county_cb

  // ---------- Validate country
  function do_ajax_form_venue_admin_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldSelect(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_country(var_country, var_script_case_init, do_ajax_form_venue_admin_validate_country_cb);
  } // do_ajax_form_venue_admin_validate_country

  function do_ajax_form_venue_admin_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_country_cb

  // ---------- Validate status
  function do_ajax_form_venue_admin_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venue_admin_validate_status(var_status, var_script_case_init, do_ajax_form_venue_admin_validate_status_cb);
  } // do_ajax_form_venue_admin_validate_status

  function do_ajax_form_venue_admin_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venue_admin_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_venue_admin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_venue_admin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_venue_admin_submit_form(var_venue_name, var_address_1, var_address_2, var_town_city, var_postcode, var_county, var_country, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_venue_admin_submit_form_cb);
  } // do_ajax_form_venue_admin_submit_form

  function do_ajax_form_venue_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_venue_admin_submit_form_cb_after_alert);
  } // do_ajax_form_venue_admin_submit_form_cb
  function do_ajax_form_venue_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_venue_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_venue_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_venue_admin_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_venue_admin_navigate_form_cb);
  } // do_ajax_form_venue_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_venue_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_venue_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_venue_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_venue_admin_navigate_form_cb
  function do_ajax_form_venue_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_venue_admin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_venue_admin_navigate_form_cb_after_alert
  function sc_hide_form_venue_admin_form()
  {
