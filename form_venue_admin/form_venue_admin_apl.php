...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_venue_admin.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_venue_admin'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_venue_admin'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_venue_admin_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_venue_admin"> 
...
//---------------------------------------------------------
    ...
    function ValidateField_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_venue_admin']['php_cmp_required']['status']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_venue_admin']['php_cmp_required']['status'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Status" ;
