  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_additional_information_i_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_additional_information_i_mob_form();
	}

  // ---------- Validate howyouhearus
  function do_ajax_form_additional_information_i_mob_validate_howyouhearus()
  {
    var nomeCampo_howyouhearus = "howyouhearus";
    var var_howyouhearus = scAjaxGetFieldCheckbox(nomeCampo_howyouhearus, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_mob_validate_howyouhearus(var_howyouhearus, var_script_case_init, do_ajax_form_additional_information_i_mob_validate_howyouhearus_cb);
  } // do_ajax_form_additional_information_i_mob_validate_howyouhearus

  function do_ajax_form_additional_information_i_mob_validate_howyouhearus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "howyouhearus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_mob_validate_howyouhearus_cb

  // ---------- Validate specify_how
  function do_ajax_form_additional_information_i_mob_validate_specify_how()
  {
    var nomeCampo_specify_how = "specify_how";
    var var_specify_how = scAjaxGetFieldText(nomeCampo_specify_how);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_mob_validate_specify_how(var_specify_how, var_script_case_init, do_ajax_form_additional_information_i_mob_validate_specify_how_cb);
  } // do_ajax_form_additional_information_i_mob_validate_specify_how

  function do_ajax_form_additional_information_i_mob_validate_specify_how_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "specify_how";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_mob_validate_specify_how_cb

  // ---------- Validate anything_else
  function do_ajax_form_additional_information_i_mob_validate_anything_else()
  {
    var nomeCampo_anything_else = "anything_else";
    var var_anything_else = scAjaxGetFieldText(nomeCampo_anything_else);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_mob_validate_anything_else(var_anything_else, var_script_case_init, do_ajax_form_additional_information_i_mob_validate_anything_else_cb);
  } // do_ajax_form_additional_information_i_mob_validate_anything_else

  function do_ajax_form_additional_information_i_mob_validate_anything_else_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anything_else";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_mob_validate_anything_else_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_additional_information_i_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_additional_information_i_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_howyouhearus = scAjaxGetFieldCheckbox("howyouhearus", ";");
    var var_specify_how = scAjaxGetFieldText("specify_how");
    var var_anything_else = scAjaxGetFieldText("anything_else");
    ...
    scAjaxProcOn();
    x_ajax_form_additional_information_i_mob_submit_form(var_howyouhearus, var_specify_how, var_anything_else, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_additional_information_i_mob_submit_form_cb);
  } // do_ajax_form_additional_information_i_mob_submit_form

  function do_ajax_form_additional_information_i_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("howyouhearus");
      scAjaxHideErrorDisplay("specify_how");
      scAjaxHideErrorDisplay("anything_else");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_additional_information_i_mob_submit_form_cb_after_alert);
  } // do_ajax_form_additional_information_i_mob_submit_form_cb
  function do_ajax_form_additional_information_i_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_additional_information_i_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_additional_information_i_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_additional_information_i_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_additional_information_i_mob_navigate_form_cb);
  } // do_ajax_form_additional_information_i_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_additional_information_i_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_additional_information_i_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_additional_information_i_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_additional_information_i_mob_navigate_form_cb
  function do_ajax_form_additional_information_i_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_additional_information_i_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_additional_information_i_mob_navigate_form_cb_after_alert
  function sc_hide_form_additional_information_i_mob_form()
  {
  ...
  ajax_field_list[0] = "howyouhearus";
  ajax_field_list[1] = "specify_how";
  ajax_field_list[2] = "anything_else";
  ...
  var ajax_error_list = {
    "howyouhearus": {"label": "How did you hear about us?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "specify_how": {"label": "Other", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anything_else": {"label": "Comments", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "howyouhearus": new Array(),
    "specify_how": new Array(),
    "anything_else": new Array()
  };
  ajax_field_mult["howyouhearus"][1] = "howyouhearus";
  ajax_field_mult["specify_how"][1] = "specify_how";
  ajax_field_mult["anything_else"][1] = "anything_else";

  var ajax_field_id = {
    "howyouhearus": new Array("hidden_field_label_howyouhearus", "hidden_field_data_howyouhearus"),
    "specify_how": new Array("hidden_field_label_specify_how", "hidden_field_data_specify_how"),
    "anything_else": new Array("hidden_field_label_anything_else", "hidden_field_data_anything_else")
  };
