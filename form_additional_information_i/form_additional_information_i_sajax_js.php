  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_additional_information_i" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_additional_information_i_form();
	}

  // ---------- Validate howyouhearus
  function do_ajax_form_additional_information_i_validate_howyouhearus()
  {
    var nomeCampo_howyouhearus = "howyouhearus";
    var var_howyouhearus = scAjaxGetFieldCheckbox(nomeCampo_howyouhearus, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_validate_howyouhearus(var_howyouhearus, var_script_case_init, do_ajax_form_additional_information_i_validate_howyouhearus_cb);
  } // do_ajax_form_additional_information_i_validate_howyouhearus

  function do_ajax_form_additional_information_i_validate_howyouhearus_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_validate_howyouhearus_cb

  // ---------- Validate specify_how
  function do_ajax_form_additional_information_i_validate_specify_how()
  {
    var nomeCampo_specify_how = "specify_how";
    var var_specify_how = scAjaxGetFieldText(nomeCampo_specify_how);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_validate_specify_how(var_specify_how, var_script_case_init, do_ajax_form_additional_information_i_validate_specify_how_cb);
  } // do_ajax_form_additional_information_i_validate_specify_how

  function do_ajax_form_additional_information_i_validate_specify_how_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_validate_specify_how_cb

  // ---------- Validate anything_else
  function do_ajax_form_additional_information_i_validate_anything_else()
  {
    var nomeCampo_anything_else = "anything_else";
    var var_anything_else = scAjaxGetFieldText(nomeCampo_anything_else);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_additional_information_i_validate_anything_else(var_anything_else, var_script_case_init, do_ajax_form_additional_information_i_validate_anything_else_cb);
  } // do_ajax_form_additional_information_i_validate_anything_else

  function do_ajax_form_additional_information_i_validate_anything_else_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_additional_information_i_validate_anything_else_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_additional_information_i_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_additional_information_i_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_additional_information_i_submit_form(var_howyouhearus, var_specify_how, var_anything_else, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_additional_information_i_submit_form_cb);
  } // do_ajax_form_additional_information_i_submit_form

  function do_ajax_form_additional_information_i_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_additional_information_i_submit_form_cb_after_alert);
  } // do_ajax_form_additional_information_i_submit_form_cb
  function do_ajax_form_additional_information_i_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_additional_information_i_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_additional_information_i_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_additional_information_i_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_additional_information_i_navigate_form_cb);
  } // do_ajax_form_additional_information_i_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_additional_information_i']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_additional_information_i_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_additional_information_i_navigate_form_cb_after_alert);
  } // do_ajax_form_additional_information_i_navigate_form_cb
  function do_ajax_form_additional_information_i_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_additional_information_i_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_additional_information_i_navigate_form_cb_after_alert
  function sc_hide_form_additional_information_i_form()
  {
