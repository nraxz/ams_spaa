...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_email_setup_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_email_setup_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_email_setup_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_email_setup'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_email_setup'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_label" id="hidden_field_label_smtp" style="<?php echo $sStyleHidden_smtp; ?>"><span id="id_label_smtp"><?php echo $this->nm_new_label['smtp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_email_label" id="hidden_field_label_smtp_email" style="<?php echo $sStyleHidden_smtp_email; ?>"><span id="id_label_smtp_email"><?php echo $this->nm_new_label['smtp_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_user_label" id="hidden_field_label_smtp_user" style="<?php echo $sStyleHidden_smtp_user; ?>"><span id="id_label_smtp_user"><?php echo $this->nm_new_label['smtp_user']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp_user']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['smtp_user'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_type_password_label" id="hidden_field_label_type_password" style="<?php echo $sStyleHidden_type_password; ?>"><span id="id_label_type_password"><?php echo $this->nm_new_label['type_password']; ?></span></TD>
    <TD class="scFormDataOdd css_type_password_line" id="hidden_field_data_type_password" style="<?php echo $sStyleHidden_type_password; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_type_password_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_re_type_label" id="hidden_field_label_re_type" style="<?php echo $sStyleHidden_re_type; ?>"><span id="id_label_re_type"><?php echo $this->nm_new_label['re_type']; ?></span></TD>
    <TD class="scFormDataOdd css_re_type_line" id="hidden_field_data_re_type" style="<?php echo $sStyleHidden_re_type; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_re_type_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_format_label" id="hidden_field_label_format" style="<?php echo $sStyleHidden_format; ?>"><span id="id_label_format"><?php echo $this->nm_new_label['format']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['format']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['format'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_format'][] = ''; ?>
 <option value=""></option>
 <option  value="H" <?php  if ($this->format == "H") { echo " selected" ;} ?>>HTML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_format'][] = 'H'; ?>
 <option  value="T" <?php  if ($this->format == "T") { echo " selected" ;} ?>>Text</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_format'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_port_label" id="hidden_field_label_port" style="<?php echo $sStyleHidden_port; ?>"><span id="id_label_port"><?php echo $this->nm_new_label['port']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['port']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['port'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_security_label" id="hidden_field_label_security" style="<?php echo $sStyleHidden_security; ?>"><span id="id_label_security"><?php echo $this->nm_new_label['security']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['security']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['security'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_security'][] = ''; ?>
 <option value=""></option>
 <option  value="S" <?php  if ($this->security == "S") { echo " selected" ;} ?>>S</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_security'][] = 'S'; ?>
 <option  value="T" <?php  if ($this->security == "T") { echo " selected" ;} ?>>T</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_security'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_active_label" id="hidden_field_label_active" style="<?php echo $sStyleHidden_active; ?>"><span id="id_label_active"><?php echo $this->nm_new_label['active']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['active']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['php_cmp_required']['active'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_active'][] = ''; ?>
 <option value=""></option>
 <option  value="Yes" <?php  if ($this->active == "Yes") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_active'][] = 'Yes'; ?>
 <option  value="No" <?php  if ($this->active == "No") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['Lookup_active'][] = 'No'; ?>
 </select></span>
</span><?php  }?>
...
<?php 
    if (isset($this->NMSC_modal) && $this->NMSC_modal == "ok") {
        $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai_modal()", "scBtnFn_sys_format_sai_modal()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-4", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_email_setup");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_email_setup");
 parent.scAjaxDetailHeight("form_email_setup", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
