  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_email_setup" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_email_setup_form();
	}

  // ---------- Validate smtp
  function do_ajax_form_email_setup_validate_smtp()
  {
    var nomeCampo_smtp = "smtp";
    var var_smtp = scAjaxGetFieldText(nomeCampo_smtp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_smtp(var_smtp, var_script_case_init, do_ajax_form_email_setup_validate_smtp_cb);
  } // do_ajax_form_email_setup_validate_smtp

  function do_ajax_form_email_setup_validate_smtp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_smtp_cb

  // ---------- Validate smtp_email
  function do_ajax_form_email_setup_validate_smtp_email()
  {
    var nomeCampo_smtp_email = "smtp_email";
    var var_smtp_email = scAjaxGetFieldText(nomeCampo_smtp_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_smtp_email(var_smtp_email, var_script_case_init, do_ajax_form_email_setup_validate_smtp_email_cb);
  } // do_ajax_form_email_setup_validate_smtp_email

  function do_ajax_form_email_setup_validate_smtp_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_smtp_email_cb

  // ---------- Validate smtp_user
  function do_ajax_form_email_setup_validate_smtp_user()
  {
    var nomeCampo_smtp_user = "smtp_user";
    var var_smtp_user = scAjaxGetFieldText(nomeCampo_smtp_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_smtp_user(var_smtp_user, var_script_case_init, do_ajax_form_email_setup_validate_smtp_user_cb);
  } // do_ajax_form_email_setup_validate_smtp_user

  function do_ajax_form_email_setup_validate_smtp_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_smtp_user_cb

  // ---------- Validate type_password
  function do_ajax_form_email_setup_validate_type_password()
  {
    var nomeCampo_type_password = "type_password";
    var var_type_password = scAjaxGetFieldText(nomeCampo_type_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_type_password(var_type_password, var_script_case_init, do_ajax_form_email_setup_validate_type_password_cb);
  } // do_ajax_form_email_setup_validate_type_password

  function do_ajax_form_email_setup_validate_type_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_type_password_cb

  // ---------- Validate re_type
  function do_ajax_form_email_setup_validate_re_type()
  {
    var nomeCampo_re_type = "re_type";
    var var_re_type = scAjaxGetFieldText(nomeCampo_re_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_re_type(var_re_type, var_script_case_init, do_ajax_form_email_setup_validate_re_type_cb);
  } // do_ajax_form_email_setup_validate_re_type

  function do_ajax_form_email_setup_validate_re_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "re_type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_re_type_cb

  // ---------- Validate format
  function do_ajax_form_email_setup_validate_format()
  {
    var nomeCampo_format = "format";
    var var_format = scAjaxGetFieldSelect(nomeCampo_format);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_format(var_format, var_script_case_init, do_ajax_form_email_setup_validate_format_cb);
  } // do_ajax_form_email_setup_validate_format

  function do_ajax_form_email_setup_validate_format_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "format";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_format_cb

  // ---------- Validate port
  function do_ajax_form_email_setup_validate_port()
  {
    var nomeCampo_port = "port";
    var var_port = scAjaxGetFieldText(nomeCampo_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_port(var_port, var_script_case_init, do_ajax_form_email_setup_validate_port_cb);
  } // do_ajax_form_email_setup_validate_port

  function do_ajax_form_email_setup_validate_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "port";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_port_cb

  // ---------- Validate security
  function do_ajax_form_email_setup_validate_security()
  {
    var nomeCampo_security = "security";
    var var_security = scAjaxGetFieldSelect(nomeCampo_security);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_security(var_security, var_script_case_init, do_ajax_form_email_setup_validate_security_cb);
  } // do_ajax_form_email_setup_validate_security

  function do_ajax_form_email_setup_validate_security_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_security_cb

  // ---------- Validate active
  function do_ajax_form_email_setup_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_validate_active(var_active, var_script_case_init, do_ajax_form_email_setup_validate_active_cb);
  } // do_ajax_form_email_setup_validate_active

  function do_ajax_form_email_setup_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_validate_active_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_email_setup_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_email_setup_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_email_setup_submit_form(var_smtp, var_smtp_email, var_smtp_user, var_type_password, var_re_type, var_format, var_port, var_security, var_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_email_setup_submit_form_cb);
  } // do_ajax_form_email_setup_submit_form

  function do_ajax_form_email_setup_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_email_setup_submit_form_cb_after_alert);
  } // do_ajax_form_email_setup_submit_form_cb
  function do_ajax_form_email_setup_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_email_setup_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_email_setup_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_email_setup_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_email_setup_navigate_form_cb);
  } // do_ajax_form_email_setup_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_email_setup_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_email_setup_navigate_form_cb_after_alert);
  } // do_ajax_form_email_setup_navigate_form_cb
  function do_ajax_form_email_setup_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_email_setup_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_email_setup_navigate_form_cb_after_alert
  function sc_hide_form_email_setup_form()
  {
