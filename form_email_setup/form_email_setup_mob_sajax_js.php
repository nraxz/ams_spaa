  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_email_setup_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_email_setup_mob_form();
	}

  // ---------- Validate smtp
  function do_ajax_form_email_setup_mob_validate_smtp()
  {
    var nomeCampo_smtp = "smtp";
    var var_smtp = scAjaxGetFieldText(nomeCampo_smtp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_smtp(var_smtp, var_script_case_init, do_ajax_form_email_setup_mob_validate_smtp_cb);
  } // do_ajax_form_email_setup_mob_validate_smtp

  function do_ajax_form_email_setup_mob_validate_smtp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_smtp_cb

  // ---------- Validate smtp_email
  function do_ajax_form_email_setup_mob_validate_smtp_email()
  {
    var nomeCampo_smtp_email = "smtp_email";
    var var_smtp_email = scAjaxGetFieldText(nomeCampo_smtp_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_smtp_email(var_smtp_email, var_script_case_init, do_ajax_form_email_setup_mob_validate_smtp_email_cb);
  } // do_ajax_form_email_setup_mob_validate_smtp_email

  function do_ajax_form_email_setup_mob_validate_smtp_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "smtp_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_smtp_email_cb

  // ---------- Validate smtp_user
  function do_ajax_form_email_setup_mob_validate_smtp_user()
  {
    var nomeCampo_smtp_user = "smtp_user";
    var var_smtp_user = scAjaxGetFieldText(nomeCampo_smtp_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_smtp_user(var_smtp_user, var_script_case_init, do_ajax_form_email_setup_mob_validate_smtp_user_cb);
  } // do_ajax_form_email_setup_mob_validate_smtp_user

  function do_ajax_form_email_setup_mob_validate_smtp_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_smtp_user_cb

  // ---------- Validate type_password
  function do_ajax_form_email_setup_mob_validate_type_password()
  {
    var nomeCampo_type_password = "type_password";
    var var_type_password = scAjaxGetFieldText(nomeCampo_type_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_type_password(var_type_password, var_script_case_init, do_ajax_form_email_setup_mob_validate_type_password_cb);
  } // do_ajax_form_email_setup_mob_validate_type_password

  function do_ajax_form_email_setup_mob_validate_type_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_type_password_cb

  // ---------- Validate re_type
  function do_ajax_form_email_setup_mob_validate_re_type()
  {
    var nomeCampo_re_type = "re_type";
    var var_re_type = scAjaxGetFieldText(nomeCampo_re_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_re_type(var_re_type, var_script_case_init, do_ajax_form_email_setup_mob_validate_re_type_cb);
  } // do_ajax_form_email_setup_mob_validate_re_type

  function do_ajax_form_email_setup_mob_validate_re_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "re_type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_re_type_cb

  // ---------- Validate format
  function do_ajax_form_email_setup_mob_validate_format()
  {
    var nomeCampo_format = "format";
    var var_format = scAjaxGetFieldSelect(nomeCampo_format);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_format(var_format, var_script_case_init, do_ajax_form_email_setup_mob_validate_format_cb);
  } // do_ajax_form_email_setup_mob_validate_format

  function do_ajax_form_email_setup_mob_validate_format_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "format";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_format_cb

  // ---------- Validate port
  function do_ajax_form_email_setup_mob_validate_port()
  {
    var nomeCampo_port = "port";
    var var_port = scAjaxGetFieldText(nomeCampo_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_port(var_port, var_script_case_init, do_ajax_form_email_setup_mob_validate_port_cb);
  } // do_ajax_form_email_setup_mob_validate_port

  function do_ajax_form_email_setup_mob_validate_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "port";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_port_cb

  // ---------- Validate security
  function do_ajax_form_email_setup_mob_validate_security()
  {
    var nomeCampo_security = "security";
    var var_security = scAjaxGetFieldSelect(nomeCampo_security);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_security(var_security, var_script_case_init, do_ajax_form_email_setup_mob_validate_security_cb);
  } // do_ajax_form_email_setup_mob_validate_security

  function do_ajax_form_email_setup_mob_validate_security_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "security";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_security_cb

  // ---------- Validate active
  function do_ajax_form_email_setup_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_email_setup_mob_validate_active(var_active, var_script_case_init, do_ajax_form_email_setup_mob_validate_active_cb);
  } // do_ajax_form_email_setup_mob_validate_active

  function do_ajax_form_email_setup_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_email_setup_mob_validate_active_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_email_setup_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_email_setup_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_smtp = scAjaxGetFieldText("smtp");
    var var_smtp_email = scAjaxGetFieldText("smtp_email");
    var var_smtp_user = scAjaxGetFieldText("smtp_user");
    var var_type_password = scAjaxGetFieldText("type_password");
    var var_re_type = scAjaxGetFieldText("re_type");
    var var_format = scAjaxGetFieldSelect("format");
    var var_port = scAjaxGetFieldText("port");
    var var_security = scAjaxGetFieldSelect("security");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_email_setup_mob_submit_form(var_smtp, var_smtp_email, var_smtp_user, var_type_password, var_re_type, var_format, var_port, var_security, var_active, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_email_setup_mob_submit_form_cb);
  } // do_ajax_form_email_setup_mob_submit_form

  function do_ajax_form_email_setup_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("smtp");
      scAjaxHideErrorDisplay("smtp_email");
      scAjaxHideErrorDisplay("smtp_user");
      scAjaxHideErrorDisplay("type_password");
      scAjaxHideErrorDisplay("re_type");
      scAjaxHideErrorDisplay("format");
      scAjaxHideErrorDisplay("port");
      scAjaxHideErrorDisplay("security");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_email_setup_mob_submit_form_cb_after_alert);
  } // do_ajax_form_email_setup_mob_submit_form_cb
  function do_ajax_form_email_setup_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_email_setup_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_email_setup_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_email_setup_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_email_setup_mob_navigate_form_cb);
  } // do_ajax_form_email_setup_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_setup_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_email_setup_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_email_setup_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_email_setup_mob_navigate_form_cb
  function do_ajax_form_email_setup_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_email_setup_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_email_setup_mob_navigate_form_cb_after_alert
  function sc_hide_form_email_setup_mob_form()
  {
  ...
  ajax_field_list[0] = "smtp";
  ajax_field_list[1] = "smtp_email";
  ajax_field_list[2] = "smtp_user";
  ajax_field_list[3] = "type_password";
  ajax_field_list[4] = "re_type";
  ajax_field_list[5] = "format";
  ajax_field_list[6] = "port";
  ajax_field_list[7] = "security";
  ajax_field_list[8] = "active";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "smtp": {"label": "SMTP Server", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "smtp_email": {"label": "SMTP Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "smtp_user": {"label": "SMTP User", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "type_password": {"label": "SMTP Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "re_type": {"label": "Confirm Password", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "format": {"label": "Format", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "port": {"label": "Port", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "security": {"label": "Security", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "smtp": new Array(),
    "smtp_email": new Array(),
    "smtp_user": new Array(),
    "type_password": new Array(),
    "re_type": new Array(),
    "format": new Array(),
    "port": new Array(),
    "security": new Array(),
  ...
  ajax_field_mult["smtp"][1] = "smtp";
  ajax_field_mult["smtp_email"][1] = "smtp_email";
  ajax_field_mult["smtp_user"][1] = "smtp_user";
  ajax_field_mult["type_password"][1] = "type_password";
  ajax_field_mult["re_type"][1] = "re_type";
  ajax_field_mult["format"][1] = "format";
  ajax_field_mult["port"][1] = "port";
  ajax_field_mult["security"][1] = "security";
  ajax_field_mult["active"][1] = "active";

  var ajax_field_id = {
    "smtp": new Array("hidden_field_label_smtp", "hidden_field_data_smtp"),
    "smtp_email": new Array("hidden_field_label_smtp_email", "hidden_field_data_smtp_email"),
    "smtp_user": new Array("hidden_field_label_smtp_user", "hidden_field_data_smtp_user"),
    "type_password": new Array("hidden_field_label_type_password", "hidden_field_data_type_password"),
    "re_type": new Array("hidden_field_label_re_type", "hidden_field_data_re_type"),
    "format": new Array("hidden_field_label_format", "hidden_field_data_format"),
    "port": new Array("hidden_field_label_port", "hidden_field_data_port"),
    "security": new Array("hidden_field_label_security", "hidden_field_data_security"),
