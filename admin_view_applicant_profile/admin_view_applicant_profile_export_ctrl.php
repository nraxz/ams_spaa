<?php
@session_start() ;
$_SESSION['scriptcase']['admin_view_applicant_profile']['sc_process_barr'] = true;
require_once('../admin_view_applicant_profile/index.php');
unset($_SESSION['scriptcase']['admin_view_applicant_profile']['sc_process_barr']);
$ExportCtrl = new admin_view_applicant_profile_export_control;
$ExportCtrl->Export_barr();

class admin_view_applicant_profile_export_control
{
...
<HEAD>
 <TITLE>Basic Information :: Excel</TITLE>
