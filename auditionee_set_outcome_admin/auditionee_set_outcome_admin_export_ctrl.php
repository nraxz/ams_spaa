<?php
@session_start() ;
$_SESSION['scriptcase']['auditionee_set_outcome_admin']['sc_process_barr'] = true;
require_once('../auditionee_set_outcome_admin/index.php');
unset($_SESSION['scriptcase']['auditionee_set_outcome_admin']['sc_process_barr']);
$ExportCtrl = new auditionee_set_outcome_admin_export_control;
$ExportCtrl->Export_barr();

class auditionee_set_outcome_admin_export_control
{
