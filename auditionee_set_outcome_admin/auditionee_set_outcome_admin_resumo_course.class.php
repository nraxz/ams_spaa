...
class auditionee_set_outcome_admin_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_application_detail_program;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_application_detail_program = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['auditionee_set_outcome_admin']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['auditionee_set_outcome_admin']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['contr_total_geral'] == "OK")
      {
          $this->array_total_application_detail_program = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_total']['application_detail_program'];
      }
      else
      {
          $this->array_total_application_detail_program = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_total']['application_detail_program'] = $this->array_total_application_detail_program;
      $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_application_detail_program = "Program";
       $this->comp_field = array(
           $Lab_application_detail_program,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_number']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_number'] = "Number"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_firstname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_firstname'] = "Firstname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_lastname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_lastname'] = "Lastname"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_nationality']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_nationality'] = "Nationality"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_gender']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_gender'] = "Gender"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['audition_marks']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['audition_marks'] = "Audition Marks"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['avg_marks']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['avg_marks'] = "Audition Marks"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['outcome']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['outcome'] = "Outcome"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_middlename']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_middlename'] = "Middlename"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_dateofbirth']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_dateofbirth'] = "DOB"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_login']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['basic_information_login'] = "Login"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_program']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_program'] = "Program"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_register']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_register'] = "Register"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_audition_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['labels']['application_detail_audition_id'] = "Audition Id"; 
       }
       //-----
       $this->comp_field_nm = array(
           'application_detail_program' => 0,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_order']['course']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_order']['course'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_order']['course'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['summarizing_fields_display']['course'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_application_detail_program as $i_application_detail_program => $d_application_detail_program) {
           if (!in_array($i_application_detail_program, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_application_detail_program[2] ] = $d_application_detail_program[1];
               $this->comp_label[0][ $d_application_detail_program[2] ] = $d_application_detail_program[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'application_detail.program', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_application_detail_program => $l_application_detail_program) {
           if (isset($this->array_total_application_detail_program[$i_application_detail_program])) {
               $this->comp_group[$i_application_detail_program] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_application_detail_program;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@auditionee_set_outcome_admin@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new auditionee_set_outcome_admin_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_course("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_application_detail_program);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_auditionee_set_outcome_admin_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_auditionee_set_outcome_admin_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_auditionee_set_outcome_admin_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=auditionee_set_outcome_admin&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("auditionee_set_outcome_admin_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['auditionee_set_outcome_admin']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['auditionee_set_outcome_admin']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'auditionee_set_outcome_admin_config_pivot.php?nome_apl=auditionee_set_outcome_admin&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"auditionee_set_outcome_admin_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"auditionee_set_outcome_admin_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_auditionee_set_outcome_admin_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "auditionee_set_outcome_admin/auditionee_set_outcome_admin_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['auditionee_set_outcome_admin']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $application_detail_number = $Busca_temp['application_detail_number']; 
          $tmp_pos = strpos($application_detail_number, "##@@");
          if ($tmp_pos !== false && !is_array($application_detail_number))
          {
              $application_detail_number = substr($application_detail_number, 0, $tmp_pos);
          }
          $basic_information_firstname = $Busca_temp['basic_information_firstname']; 
          $tmp_pos = strpos($basic_information_firstname, "##@@");
          if ($tmp_pos !== false && !is_array($basic_information_firstname))
          {
              $basic_information_firstname = substr($basic_information_firstname, 0, $tmp_pos);
          }
          $basic_information_lastname = $Busca_temp['basic_information_lastname']; 
          $tmp_pos = strpos($basic_information_lastname, "##@@");
          if ($tmp_pos !== false && !is_array($basic_information_lastname))
          {
              $basic_information_lastname = substr($basic_information_lastname, 0, $tmp_pos);
          }
          $basic_information_middlename = $Busca_temp['basic_information_middlename']; 
          $tmp_pos = strpos($basic_information_middlename, "##@@");
          if ($tmp_pos !== false && !is_array($basic_information_middlename))
          {
              $basic_information_middlename = substr($basic_information_middlename, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_application_detail_program, $quebra_application_detail_program_orig)
   {
      //----- Program
      if (!isset($this->array_total_application_detail_program[$quebra_application_detail_program_orig]))
      {
         $this->array_total_application_detail_program[$quebra_application_detail_program_orig][0] = 1;
         $this->array_total_application_detail_program[$quebra_application_detail_program_orig][1] = $quebra_application_detail_program;
         $this->array_total_application_detail_program[$quebra_application_detail_program_orig][2] = $quebra_application_detail_program_orig;
      }
      else
      {
         $this->array_total_application_detail_program[$quebra_application_detail_program_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'application_detail_program');
     $campos_order = $this->Ini->Get_date_order_groupby("application_detail.program", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->application_detail_number = $rs_res->fields[0] ;  
            $this->basic_information_firstname = $rs_res->fields[1] ;  
            $this->basic_information_lastname = $rs_res->fields[2] ;  
            $this->basic_information_nationality = $rs_res->fields[3] ;  
            $this->basic_information_gender = $rs_res->fields[4] ;  
            $this->basic_information_middlename = $rs_res->fields[5] ;  
            $this->basic_information_dateofbirth = $rs_res->fields[6] ;  
            $this->basic_information_login = $rs_res->fields[7] ;  
            $this->application_detail_program = $rs_res->fields[8] ;  
            $this->application_detail_audition_id = $rs_res->fields[9] ;  
...
$_SESSION['scriptcase']['auditionee_set_outcome_admin']['contr_erro'] = 'off'; 
            $this->application_detail_program_orig = $this->application_detail_program;
            $this->application_detail_program = $this->look_application_detail_program ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->application_detail_program, $this->application_detail_program_orig);
            }
   }
//
