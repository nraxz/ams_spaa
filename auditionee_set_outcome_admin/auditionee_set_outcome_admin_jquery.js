...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_auditionee_set_outcome_admin').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_auditionee_set_outcome_admin').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_auditionee_set_outcome_admin').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_auditionee_set_outcome_admin').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_auditionee_set_outcome_admin').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_auditionee_set_outcome_admin').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_auditionee_set_outcome_admin').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_auditionee_set_outcome_admin').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_auditionee_set_outcome_admin').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_auditionee_set_outcome_admin').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_auditionee_set_outcome_admin').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_auditionee_set_outcome_admin').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
