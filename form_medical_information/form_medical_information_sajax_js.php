  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medical_information" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_medical_information_form();
	}

  // ---------- Validate any_disability
  function do_ajax_form_medical_information_validate_any_disability()
  {
    ...
    x_ajax_form_medical_information_validate_any_disability(var_any_disability, var_script_case_init, do_ajax_form_medical_information_validate_any_disability_cb);
  } // do_ajax_form_medical_information_validate_any_disability

  function do_ajax_form_medical_information_validate_any_disability_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_validate_any_disability_cb

  // ---------- Validate what_type_disability
  function do_ajax_form_medical_information_validate_what_type_disability()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_validate_what_type_disability(var_what_type_disability, var_script_case_init, do_ajax_form_medical_information_validate_what_type_disability_cb);
  } // do_ajax_form_medical_information_validate_what_type_disability

  function do_ajax_form_medical_information_validate_what_type_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_validate_what_type_disability_cb

  // ---------- Validate any_anxiety
  function do_ajax_form_medical_information_validate_any_anxiety()
  {
    var nomeCampo_any_anxiety = "any_anxiety";
    var var_any_anxiety = scAjaxGetFieldRadio(nomeCampo_any_anxiety);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_validate_any_anxiety(var_any_anxiety, var_script_case_init, do_ajax_form_medical_information_validate_any_anxiety_cb);
  } // do_ajax_form_medical_information_validate_any_anxiety

  function do_ajax_form_medical_information_validate_any_anxiety_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_validate_any_anxiety_cb

  // ---------- Validate what_type_anxiety
  function do_ajax_form_medical_information_validate_what_type_anxiety()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_validate_what_type_anxiety(var_what_type_anxiety, var_script_case_init, do_ajax_form_medical_information_validate_what_type_anxiety_cb);
  } // do_ajax_form_medical_information_validate_what_type_anxiety

  function do_ajax_form_medical_information_validate_what_type_anxiety_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_validate_what_type_anxiety_cb

  // ---------- Validate medical_information
  function do_ajax_form_medical_information_validate_medical_information()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_validate_medical_information(var_medical_information, var_script_case_init, do_ajax_form_medical_information_validate_medical_information_cb);
  } // do_ajax_form_medical_information_validate_medical_information

  function do_ajax_form_medical_information_validate_medical_information_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_validate_medical_information_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medical_information_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medical_information_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_medical_information_submit_form(var_any_disability, var_what_type_disability, var_any_anxiety, var_what_type_anxiety, var_medical_information, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medical_information_submit_form_cb);
  } // do_ajax_form_medical_information_submit_form

  function do_ajax_form_medical_information_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medical_information_submit_form_cb_after_alert);
  } // do_ajax_form_medical_information_submit_form_cb
  function do_ajax_form_medical_information_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medical_information_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medical_information_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_medical_information_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medical_information_navigate_form_cb);
  } // do_ajax_form_medical_information_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medical_information']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medical_information_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medical_information_navigate_form_cb_after_alert);
  } // do_ajax_form_medical_information_navigate_form_cb
  function do_ajax_form_medical_information_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_medical_information_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medical_information_navigate_form_cb_after_alert
  function sc_hide_form_medical_information_form()
  {
