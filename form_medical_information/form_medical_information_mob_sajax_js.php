  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medical_information_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_medical_information_mob_form();
	}

  // ---------- Validate any_disability
  function do_ajax_form_medical_information_mob_validate_any_disability()
  {
    var nomeCampo_any_disability = "any_disability";
    var var_any_disability = scAjaxGetFieldRadio(nomeCampo_any_disability);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_mob_validate_any_disability(var_any_disability, var_script_case_init, do_ajax_form_medical_information_mob_validate_any_disability_cb);
  } // do_ajax_form_medical_information_mob_validate_any_disability

  function do_ajax_form_medical_information_mob_validate_any_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "any_disability";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_mob_validate_any_disability_cb

  // ---------- Validate what_type_disability
  function do_ajax_form_medical_information_mob_validate_what_type_disability()
  {
    var nomeCampo_what_type_disability = "what_type_disability";
    var var_what_type_disability = scAjaxGetFieldText(nomeCampo_what_type_disability);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_mob_validate_what_type_disability(var_what_type_disability, var_script_case_init, do_ajax_form_medical_information_mob_validate_what_type_disability_cb);
  } // do_ajax_form_medical_information_mob_validate_what_type_disability

  function do_ajax_form_medical_information_mob_validate_what_type_disability_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "what_type_disability";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_mob_validate_what_type_disability_cb

  // ---------- Validate any_anxiety
  function do_ajax_form_medical_information_mob_validate_any_anxiety()
  {
    var nomeCampo_any_anxiety = "any_anxiety";
    var var_any_anxiety = scAjaxGetFieldRadio(nomeCampo_any_anxiety);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_mob_validate_any_anxiety(var_any_anxiety, var_script_case_init, do_ajax_form_medical_information_mob_validate_any_anxiety_cb);
  } // do_ajax_form_medical_information_mob_validate_any_anxiety

  function do_ajax_form_medical_information_mob_validate_any_anxiety_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "any_anxiety";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_mob_validate_any_anxiety_cb

  // ---------- Validate what_type_anxiety
  function do_ajax_form_medical_information_mob_validate_what_type_anxiety()
  {
    var nomeCampo_what_type_anxiety = "what_type_anxiety";
    var var_what_type_anxiety = scAjaxGetFieldText(nomeCampo_what_type_anxiety);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_mob_validate_what_type_anxiety(var_what_type_anxiety, var_script_case_init, do_ajax_form_medical_information_mob_validate_what_type_anxiety_cb);
  } // do_ajax_form_medical_information_mob_validate_what_type_anxiety

  function do_ajax_form_medical_information_mob_validate_what_type_anxiety_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "what_type_anxiety";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_mob_validate_what_type_anxiety_cb

  // ---------- Validate medical_information
  function do_ajax_form_medical_information_mob_validate_medical_information()
  {
    var nomeCampo_medical_information = "medical_information";
    var var_medical_information = scAjaxGetFieldText(nomeCampo_medical_information);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medical_information_mob_validate_medical_information(var_medical_information, var_script_case_init, do_ajax_form_medical_information_mob_validate_medical_information_cb);
  } // do_ajax_form_medical_information_mob_validate_medical_information

  function do_ajax_form_medical_information_mob_validate_medical_information_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medical_information";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medical_information_mob_validate_medical_information_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_medical_information_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medical_information_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_any_disability = scAjaxGetFieldRadio("any_disability");
    var var_what_type_disability = scAjaxGetFieldText("what_type_disability");
    var var_any_anxiety = scAjaxGetFieldRadio("any_anxiety");
    var var_what_type_anxiety = scAjaxGetFieldText("what_type_anxiety");
    var var_medical_information = scAjaxGetFieldText("medical_information");
    ...
    scAjaxProcOn();
    x_ajax_form_medical_information_mob_submit_form(var_any_disability, var_what_type_disability, var_any_anxiety, var_what_type_anxiety, var_medical_information, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medical_information_mob_submit_form_cb);
  } // do_ajax_form_medical_information_mob_submit_form

  function do_ajax_form_medical_information_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("any_disability");
      scAjaxHideErrorDisplay("what_type_disability");
      scAjaxHideErrorDisplay("any_anxiety");
      scAjaxHideErrorDisplay("what_type_anxiety");
      scAjaxHideErrorDisplay("medical_information");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medical_information_mob_submit_form_cb_after_alert);
  } // do_ajax_form_medical_information_mob_submit_form_cb
  function do_ajax_form_medical_information_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medical_information_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medical_information_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_medical_information_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medical_information_mob_navigate_form_cb);
  } // do_ajax_form_medical_information_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medical_information_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medical_information_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medical_information_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_medical_information_mob_navigate_form_cb
  function do_ajax_form_medical_information_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_medical_information_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medical_information_mob_navigate_form_cb_after_alert
  function sc_hide_form_medical_information_mob_form()
  {
  ...
  ajax_field_list[0] = "any_disability";
  ajax_field_list[1] = "what_type_disability";
  ajax_field_list[2] = "any_anxiety";
  ajax_field_list[3] = "what_type_anxiety";
  ajax_field_list[4] = "medical_information";
  ...
  var ajax_error_list = {
    "any_disability": {"label": "Do you have a disability?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "what_type_disability": {"label": "Please provide name or type of disability", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "any_anxiety": {"label": "Do you suffer from anxiety? ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "what_type_anxiety": {"label": "Please provide name or type of anxiety", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medical_information": {"label": "Medical Information (including any past or current injures, medications etc.)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "any_disability": new Array(),
    "what_type_disability": new Array(),
    "any_anxiety": new Array(),
    "what_type_anxiety": new Array(),
    "medical_information": new Array()
  };
  ajax_field_mult["any_disability"][1] = "any_disability";
  ajax_field_mult["what_type_disability"][1] = "what_type_disability";
  ajax_field_mult["any_anxiety"][1] = "any_anxiety";
  ajax_field_mult["what_type_anxiety"][1] = "what_type_anxiety";
  ajax_field_mult["medical_information"][1] = "medical_information";

  var ajax_field_id = {
    "any_disability": new Array("hidden_field_label_any_disability", "hidden_field_data_any_disability"),
    "what_type_disability": new Array("hidden_field_label_what_type_disability", "hidden_field_data_what_type_disability"),
    "any_anxiety": new Array("hidden_field_label_any_anxiety", "hidden_field_data_any_anxiety"),
    "what_type_anxiety": new Array("hidden_field_label_what_type_anxiety", "hidden_field_data_what_type_anxiety"),
    "medical_information": new Array("hidden_field_label_medical_information", "hidden_field_data_medical_information")
  };

  var ajax_read_only = {
    "any_disability": "off",
    "what_type_disability": "off",
    "any_anxiety": "off",
    "what_type_anxiety": "off",
    "medical_information": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("what_type_disability" == sIndex)
    {
