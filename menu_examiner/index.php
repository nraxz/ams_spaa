<?php
include_once('menu_examiner_session.php');
session_start();
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil']         = "conn_mysql";
    $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_examiner_class
{
  var $Db;
 ...
 function menu_examiner_menu()
 {
    global $menu_examiner_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_examiner']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_examiner/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_examiner');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_examiner_erro.php");
}
include_once(dirname(__FILE__) . "/menu_examiner_erro.class.php"); 
$this->Erro = new menu_examiner_erro();
$str_path = substr($_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']);
}

/* Path definitions */
$menu_examiner_menuData         = array();
$menu_examiner_menuData['path'] = array();
$menu_examiner_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_examiner_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_examiner_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_examiner_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_examiner_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_examiner_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_examiner_menuData['url']['web']   = str_replace("\\", '/', $menu_examiner_menuData['url']['web']);
$menu_examiner_menuData['path']['root'] = substr($menu_examiner_menuData['path']['sys'],  0, -1 * strlen($menu_examiner_menuData['url']['web']));
$menu_examiner_menuData['path']['app']  = substr($menu_examiner_menuData['path']['sys'],  0, strrpos($menu_examiner_menuData['path']['sys'],  '/'));
$menu_examiner_menuData['path']['link'] = substr($menu_examiner_menuData['path']['app'],  0, strrpos($menu_examiner_menuData['path']['app'],  '/'));
$menu_examiner_menuData['path']['link'] = substr($menu_examiner_menuData['path']['link'], 0, strrpos($menu_examiner_menuData['path']['link'], '/')) . '/';
$menu_examiner_menuData['path']['app'] .= '/';
$menu_examiner_menuData['url']['app']   = substr($menu_examiner_menuData['url']['web'],  0, strrpos($menu_examiner_menuData['url']['web'],  '/'));
$menu_examiner_menuData['url']['link']  = substr($menu_examiner_menuData['url']['app'],  0, strrpos($menu_examiner_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] == "S")
{
    $menu_examiner_menuData['url']['link']  = substr($menu_examiner_menuData['url']['link'], 0, strrpos($menu_examiner_menuData['url']['link'], '/'));
}
$menu_examiner_menuData['url']['link']  .= '/';
$menu_examiner_menuData['url']['app']   .= '/';
...
if (isset($_SESSION['scriptcase']['menu_examiner']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_examiner']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_examiner']['actual_lang']) || $_SESSION['scriptcase']['menu_examiner']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_examiner']['actual_lang'] = $this->str_lang;
...
include_once("menu_examiner_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_examiner";
     $_SESSION['scriptcase']['menu_apls']['menu_examiner'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_examiner']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_examiner']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_examiner']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_examiner']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_examiner']['init']))
{
    $_SESSION['sc_session'][1]['menu_examiner']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_examiner']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_examiner'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_examiner'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_examiner'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'], 'SPAA_AMS', 2); 
}
if (isset($_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_examiner']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_examiner']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_examiner']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_examiner']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_examiner']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_examiner']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_examiner']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_examiner']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'], 'SPAA_AMS'); 
} 
else 
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_examiner'))
{
    $_SESSION['sc_session'][1]['menu_examiner']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_examiner'] = "javascript:window.close()";
}
/* Menu configuration variables */
$menu_examiner_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("my_audition_examiner") . "/my_audition_examiner_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner'] = "on";
    }
}
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_examiner'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']) == "on")
{
    $menu_examiner_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_examiner_form_php.php?sc_item_menu=item_1&sc_apl_menu=my_audition_examiner&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_examiner_target('_self') . "|" . "\n";
}
else
{
    $menu_examiner_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
$menu_examiner_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "||_self|\n";
$menu_examiner_menuData['data'] .= "item_3|.|" . $_SESSION['usr_name'] . "||" . $nm_var_hint[2] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_examiner_menuData['data'] .= "item_4|..|" . $nm_var_lab[2] . "|menu_examiner_form_php.php?sc_item_menu=item_4&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_examiner_target('_self') . "|" . "\n";
}
else
{
    $menu_examiner_menuData['data'] .= "item_4|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_login']) == "on")
{
    $menu_examiner_menuData['data'] .= "item_5|..|" . $nm_var_lab[3] . "|menu_examiner_form_php.php?sc_item_menu=item_5&sc_apl_menu=app_login&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_examiner_target('_parent') . "|" . "\n";
}
else
{
    $menu_examiner_menuData['data'] .= "item_5|..|" . $nm_var_lab[3] . "||||_parent|disabled\n";
}

$menu_examiner_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_examiner_form_php.php?sc_item_menu=item_1&sc_apl_menu=my_audition_examiner&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_examiner_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_examiner_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "menu_examiner_form_php.php?sc_item_menu=item_4&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_examiner_form_php.php?sc_item_menu=item_5&sc_apl_menu=app_login&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_examiner_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_examiner_target('_parent') . "\"",
        'sc_id'    => "item_5",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_examiner']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_examiner']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_examiner');
    $menu_examiner_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_examiner_help.txt"))
{
    $Arq_WebHelp = file("menu_examiner_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_examiner_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_examiner_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_examiner']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_examiner']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_examiner_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_examiner']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_examiner_menuData['data'][$i_menu]);
       }
    ...
    $menu_examiner_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_examiner']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_examiner']))
{
    $disable_menu = false;
    foreach ($menu_examiner_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_examiner']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_examiner_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* HTML header */
if ($menu_examiner_menuData['iframe'])
{
    $menu_examiner_menuData['height'] = '100%';
?>
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $menu_examiner_menuData['height'] = '30px';
}

/* JS files */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<?php
$confirmButtonClass = '';
$cancelButtonClass  = '';
...
<script type="text/javascript" src="menu_examiner_message.js"></script>
...
Iframe_atual = "menu_examiner_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_examiner\";\r\n";
echo "Tab_labels['menu_examiner'] = \"\";\r\n";
echo "Tab_hints['menu_examiner'] = \"\";\r\n";
echo "Tab_abas['menu_examiner']   = \"none\";\r\n";
echo "Tab_refresh['menu_examiner']   = \"\";\r\n";
echo "Tab_icons['menu_examiner'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_examiner'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_examiner']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_examiner']   = \"\";\r\n";
echo "Tab_display['menu_examiner']   = \"\";\r\n";
echo "Tab_display_position['menu_examiner']   = \"\";\r\n";
         $seq++;
 foreach ($menu_examiner_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_examiner_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_examiner'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_examiner').hide();
    if (str_id == "")
    {
        $('#iframe_menu_examiner').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_examiner') 
            {
                Iframe_atual = "menu_examiner_" + Tab_iframes[i] + '_iframe';
            }
...
{
    str_target_sv = "";
    if (str_id != "iframe_menu_examiner")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("menu_examiner_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    str_id = str_id.replace('iframe_menu_examiner', 'menu_examiner');
    if (str_target == "menu_examiner_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_examiner")
        {
            $('#links_abas').css('display','');
        }
        if (str_id != "menu_examiner" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    $('#iframe_menu_examiner')[0].contentWindow.focus();
}
</script>
<?php
...
echo $this->menu_examiner_escreveMenu($menu_examiner_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Iframe control */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_examiner_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner']) && $_SESSION['scriptcase']['sc_apl_seg']['my_audition_examiner'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_examiner');\" item-href=\"menu_examiner_form_php.php?sc_item_menu=menu_examiner&sc_apl_menu=my_audition_examiner&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_examiner_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_examiner_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_examiner" name="menu_examiner_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_examiner_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_examiner_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_examiner').click()";
    echo "</script>";
}
...
/* Target control */
function menu_examiner_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('menu_examiner_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function menu_examiner_target($str_target)
{
    global $menu_examiner_menuData;
    ...
    elseif ($menu_examiner_menuData['iframe'])
    {
        return 'menu_examiner_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_examiner_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_examiner_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_examiner_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_examiner_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_examiner']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_examiner_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_examiner']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_examiner']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_examiner']['sc_init'][$apl_menu];
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['menu_examiner']['SC_sep_date']) && !empty($_SESSION['scriptcase']['menu_examiner']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['menu_examiner']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['menu_examiner']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_examiner', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'menu_examiner', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_examiner', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_examiner']['glo_nm_path_imag_temp'] . "/sc_apl_default_SPAA_AMS.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_examiner") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_examiner']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_SPAA_AMS'])) {
            $_SESSION['scriptcase']['menu_examiner']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SPAA_AMS'];
        }
    }
}
...
$contr_menu_examiner = new menu_examiner_class;
$contr_menu_examiner->menu_examiner_menu();
