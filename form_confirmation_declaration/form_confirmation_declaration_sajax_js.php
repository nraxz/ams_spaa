  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_confirmation_declaration" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_confirmation_declaration_form();
	}

  // ---------- Validate requirement
  function do_ajax_form_confirmation_declaration_validate_requirement()
  {
    var nomeCampo_requirement = "requirement";
    var var_requirement = scAjaxGetFieldCheckbox(nomeCampo_requirement, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_validate_requirement(var_requirement, var_script_case_init, do_ajax_form_confirmation_declaration_validate_requirement_cb);
  } // do_ajax_form_confirmation_declaration_validate_requirement

  function do_ajax_form_confirmation_declaration_validate_requirement_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_validate_requirement_cb

  // ---------- Validate agreement
  function do_ajax_form_confirmation_declaration_validate_agreement()
  {
    var nomeCampo_agreement = "agreement";
    var var_agreement = scAjaxGetFieldCheckbox(nomeCampo_agreement, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_validate_agreement(var_agreement, var_script_case_init, do_ajax_form_confirmation_declaration_validate_agreement_cb);
  } // do_ajax_form_confirmation_declaration_validate_agreement

  function do_ajax_form_confirmation_declaration_validate_agreement_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_validate_agreement_cb

  // ---------- Validate termandcondition
  function do_ajax_form_confirmation_declaration_validate_termandcondition()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_validate_termandcondition(var_termandcondition, var_script_case_init, do_ajax_form_confirmation_declaration_validate_termandcondition_cb);
  } // do_ajax_form_confirmation_declaration_validate_termandcondition

  function do_ajax_form_confirmation_declaration_validate_termandcondition_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_validate_termandcondition_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_confirmation_declaration_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_confirmation_declaration_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_confirmation_declaration_submit_form(var_requirement, var_agreement, var_termandcondition, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_confirmation_declaration_submit_form_cb);
  } // do_ajax_form_confirmation_declaration_submit_form

  function do_ajax_form_confirmation_declaration_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_confirmation_declaration_submit_form_cb_after_alert);
  } // do_ajax_form_confirmation_declaration_submit_form_cb
  function do_ajax_form_confirmation_declaration_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_confirmation_declaration_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_confirmation_declaration_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_confirmation_declaration_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_confirmation_declaration_navigate_form_cb);
  } // do_ajax_form_confirmation_declaration_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_confirmation_declaration']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_confirmation_declaration_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_confirmation_declaration_navigate_form_cb_after_alert);
  } // do_ajax_form_confirmation_declaration_navigate_form_cb
  function do_ajax_form_confirmation_declaration_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_confirmation_declaration_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_confirmation_declaration_navigate_form_cb_after_alert
  function sc_hide_form_confirmation_declaration_form()
  {
