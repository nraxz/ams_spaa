  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_confirmation_declaration_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_confirmation_declaration_mob_form();
	}

  // ---------- Validate requirement
  function do_ajax_form_confirmation_declaration_mob_validate_requirement()
  {
    var nomeCampo_requirement = "requirement";
    var var_requirement = scAjaxGetFieldCheckbox(nomeCampo_requirement, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_mob_validate_requirement(var_requirement, var_script_case_init, do_ajax_form_confirmation_declaration_mob_validate_requirement_cb);
  } // do_ajax_form_confirmation_declaration_mob_validate_requirement

  function do_ajax_form_confirmation_declaration_mob_validate_requirement_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "requirement";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_mob_validate_requirement_cb

  // ---------- Validate agreement
  function do_ajax_form_confirmation_declaration_mob_validate_agreement()
  {
    var nomeCampo_agreement = "agreement";
    var var_agreement = scAjaxGetFieldCheckbox(nomeCampo_agreement, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_mob_validate_agreement(var_agreement, var_script_case_init, do_ajax_form_confirmation_declaration_mob_validate_agreement_cb);
  } // do_ajax_form_confirmation_declaration_mob_validate_agreement

  function do_ajax_form_confirmation_declaration_mob_validate_agreement_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agreement";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_mob_validate_agreement_cb

  // ---------- Validate termandcondition
  function do_ajax_form_confirmation_declaration_mob_validate_termandcondition()
  {
    var nomeCampo_termandcondition = "termandcondition";
    var var_termandcondition = scAjaxGetFieldCheckbox(nomeCampo_termandcondition, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_confirmation_declaration_mob_validate_termandcondition(var_termandcondition, var_script_case_init, do_ajax_form_confirmation_declaration_mob_validate_termandcondition_cb);
  } // do_ajax_form_confirmation_declaration_mob_validate_termandcondition

  function do_ajax_form_confirmation_declaration_mob_validate_termandcondition_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "termandcondition";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_confirmation_declaration_mob_validate_termandcondition_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_confirmation_declaration_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_confirmation_declaration_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_requirement = scAjaxGetFieldCheckbox("requirement", ";");
    var var_agreement = scAjaxGetFieldCheckbox("agreement", ";");
    var var_termandcondition = scAjaxGetFieldCheckbox("termandcondition", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_confirmation_declaration_mob_submit_form(var_requirement, var_agreement, var_termandcondition, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_confirmation_declaration_mob_submit_form_cb);
  } // do_ajax_form_confirmation_declaration_mob_submit_form

  function do_ajax_form_confirmation_declaration_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("requirement");
      scAjaxHideErrorDisplay("agreement");
      scAjaxHideErrorDisplay("termandcondition");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_confirmation_declaration_mob_submit_form_cb_after_alert);
  } // do_ajax_form_confirmation_declaration_mob_submit_form_cb
  function do_ajax_form_confirmation_declaration_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_confirmation_declaration_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_confirmation_declaration_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_confirmation_declaration_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_confirmation_declaration_mob_navigate_form_cb);
  } // do_ajax_form_confirmation_declaration_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_confirmation_declaration_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_confirmation_declaration_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_confirmation_declaration_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_confirmation_declaration_mob_navigate_form_cb
  function do_ajax_form_confirmation_declaration_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_confirmation_declaration_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_confirmation_declaration_mob_navigate_form_cb_after_alert
  function sc_hide_form_confirmation_declaration_mob_form()
  {
  ...
  ajax_field_list[0] = "requirement";
  ajax_field_list[1] = "agreement";
  ajax_field_list[2] = "termandcondition";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "requirement": {"label": "I meet the academic <a href=\"http://www.londonstudiocentre.org/admissions/entry-requirements\" target=\"_blank\"><strong>entry requirements</strong></a>.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "agreement": {"label": "I confirm that I, the applicant, have completed this form to the best of my knowledge and the information given is correct.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "termandcondition": {"label": "I confirm that I, the applicant, have read the <a href=\"http://www.londonstudiocentre.org/terms-a-conditions\" target=\"_blank\"><strong>Terms & Conditions </strong></a> and agree to proceed.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "agreement": new Array(),
    "termandcondition": new Array()
  };
  ajax_field_mult["requirement"][1] = "requirement";
  ajax_field_mult["agreement"][1] = "agreement";
  ajax_field_mult["termandcondition"][1] = "termandcondition";

  var ajax_field_id = {
    "requirement": new Array("hidden_field_label_requirement", "hidden_field_data_requirement"),
    "agreement": new Array("hidden_field_label_agreement", "hidden_field_data_agreement"),
    "termandcondition": new Array("hidden_field_label_termandcondition", "hidden_field_data_termandcondition")
  };

  var ajax_read_only = {
    "requirement": "off",
    "agreement": "off",
    "termandcondition": "off"
  };
