<?php
@session_start() ;
$_SESSION['scriptcase']['admin_training_experience']['sc_process_barr'] = true;
require_once('../admin_training_experience/index.php');
unset($_SESSION['scriptcase']['admin_training_experience']['sc_process_barr']);
$ExportCtrl = new admin_training_experience_export_control;
$ExportCtrl->Export_barr();

class admin_training_experience_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> medical_information :: Excel</TITLE>
