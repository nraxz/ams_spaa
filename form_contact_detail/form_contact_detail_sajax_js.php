  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contact_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contact_detail_form();
	}

  // ---------- Validate full_address
  function do_ajax_form_contact_detail_validate_full_address()
  {
    var nomeCampo_full_address = "full_address";
    var var_full_address = scAjaxGetFieldText(nomeCampo_full_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contact_detail_validate_full_address(var_full_address, var_script_case_init, do_ajax_form_contact_detail_validate_full_address_cb);
  } // do_ajax_form_contact_detail_validate_full_address

  function do_ajax_form_contact_detail_validate_full_address_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contact_detail_validate_full_address_cb

  // ---------- Validate country
  function do_ajax_form_contact_detail_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldSelect(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contact_detail_validate_country(var_country, var_script_case_init, do_ajax_form_contact_detail_validate_country_cb);
  } // do_ajax_form_contact_detail_validate_country

  function do_ajax_form_contact_detail_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contact_detail_validate_country_cb

  // ---------- Validate contact_number
  function do_ajax_form_contact_detail_validate_contact_number()
  {
    var nomeCampo_contact_number = "contact_number";
    var var_contact_number = scAjaxGetFieldText(nomeCampo_contact_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contact_detail_validate_contact_number(var_contact_number, var_script_case_init, do_ajax_form_contact_detail_validate_contact_number_cb);
  } // do_ajax_form_contact_detail_validate_contact_number

  function do_ajax_form_contact_detail_validate_contact_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contact_detail_validate_contact_number_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contact_detail_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contact_detail_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contact_detail_submit_form(var_full_address, var_country, var_contact_number, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contact_detail_submit_form_cb);
  } // do_ajax_form_contact_detail_submit_form

  function do_ajax_form_contact_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contact_detail_submit_form_cb_after_alert);
  } // do_ajax_form_contact_detail_submit_form_cb
  function do_ajax_form_contact_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contact_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contact_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_contact_detail_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contact_detail_navigate_form_cb);
  } // do_ajax_form_contact_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contact_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contact_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contact_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_contact_detail_navigate_form_cb
  function do_ajax_form_contact_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contact_detail_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contact_detail_navigate_form_cb_after_alert
  function sc_hide_form_contact_detail_form()
  {
