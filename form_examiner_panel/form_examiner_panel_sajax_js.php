  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_examiner_panel" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_examiner_panel_form();
	}

  // ---------- Validate audition_id_
  function do_ajax_form_examiner_panel_validate_audition_id_(iNumLinha)
  {
    var nomeCampo_audition_id_ = "audition_id_" + iNumLinha;
    var var_audition_id_ = scAjaxGetFieldText(nomeCampo_audition_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examiner_panel_validate_audition_id_(var_audition_id_, iNumLinha, var_script_case_init, do_ajax_form_examiner_panel_validate_audition_id__cb);
  } // do_ajax_form_examiner_panel_validate_audition_id_

  function do_ajax_form_examiner_panel_validate_audition_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "audition_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "audition_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "audition_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "audition_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examiner_panel_validate_audition_id__cb

  // ---------- Validate panel_
  function do_ajax_form_examiner_panel_validate_panel_(iNumLinha)
  {
    var nomeCampo_panel_ = "panel_" + iNumLinha;
    var var_panel_ = scAjaxGetFieldSelect(nomeCampo_panel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examiner_panel_validate_panel_(var_panel_, iNumLinha, var_script_case_init, do_ajax_form_examiner_panel_validate_panel__cb);
  } // do_ajax_form_examiner_panel_validate_panel_

  function do_ajax_form_examiner_panel_validate_panel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "panel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "panel_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "panel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "panel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examiner_panel_validate_panel__cb

  // ---------- Validate id_
  function do_ajax_form_examiner_panel_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examiner_panel_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_examiner_panel_validate_id__cb);
  } // do_ajax_form_examiner_panel_validate_id_

  function do_ajax_form_examiner_panel_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examiner_panel_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_examiner_panel_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_examiner_panel_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_examiner_panel_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_examiner_panel_add_new_line_cb);
  } // do_ajax_form_examiner_panel_add_new_line

  function do_ajax_form_examiner_panel_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("audition_id_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_examiner_panel_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_examiner_panel_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examiner_panel_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_examiner_panel_backup_line_cb);
  } // do_ajax_form_examiner_panel_backup_line

  function do_ajax_form_examiner_panel_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_examiner_panel_backup_line_cb

  function do_ajax_form_examiner_panel_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_examiner_panel_cancel_insert

  function do_ajax_form_examiner_panel_cancel_update(iSeqVert)
  {
    do_ajax_form_examiner_panel_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_examiner_panel_cancel_update

  function do_ajax_form_examiner_panel_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_examiner_panel_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_examiner_panel_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_examiner_panel_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_examiner_panel_table_refresh_cb);
  } //  do_ajax_form_examiner_panel_table_refresh

  function do_ajax_form_examiner_panel_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scJQGeneralAdd();
    scAjaxAlert(do_ajax_form_examiner_panel_table_refresh_cb_after_alert);
  } // do_ajax_form_examiner_panel_table_refresh_cb
  function do_ajax_form_examiner_panel_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_examiner_panel_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_examiner_panel_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_examiner_panel_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_audition_id_ = scAjaxGetFieldText("audition_id_" + iNumLinha);
    var var_panel_ = scAjaxGetFieldSelect("panel_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_examiner_panel_submit_form(var_audition_id_, var_panel_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_examiner_panel_submit_form_cb);
  } // do_ajax_form_examiner_panel_submit_form

  function do_ajax_form_examiner_panel_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("audition_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("panel_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_examiner_panel_submit_form_cb_after_alert);
  } // do_ajax_form_examiner_panel_submit_form_cb
  function do_ajax_form_examiner_panel_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_examiner_panel_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_examiner_panel_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_examiner_panel_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("audition_id_" + iNavForm);
      scAjaxHideErrorDisplay("panel_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_examiner_panel_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_examiner_panel_navigate_form_cb);
  } // do_ajax_form_examiner_panel_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_examiner_panel']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_examiner_panel_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_examiner_panel_navigate_form_cb_after_alert);
  } // do_ajax_form_examiner_panel_navigate_form_cb
  function do_ajax_form_examiner_panel_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_examiner_panel_navigate_form_cb_after_alert
  function sc_hide_form_examiner_panel_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "audition_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "panel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["audition_id_" + iNumLinha] = {"label": "Audition ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["panel_" + iNumLinha] = {"label": "Panel<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["audition_id_"][iNumLinha] = "audition_id_" + iNumLinha;
    ajax_field_mult["panel_"][iNumLinha] = "panel_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["audition_id_" + iNumLinha] = new Array("hidden_field_label_audition_id_", "hidden_field_data_audition_id_" + iNumLinha);
    ajax_field_id["panel_" + iNumLinha] = new Array("hidden_field_label_panel_", "hidden_field_data_panel_" + iNumLinha);
    ajax_error_count["audition_id_" + iNumLinha] = "off";
    ajax_error_count["panel_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["audition_id_" + iNumLinha] = "off";
    ajax_read_only["panel_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["audition_id_" + iNumLinha] = "on";
    ajax_read_only["panel_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["audition_id_" + iNumLinha] = null;
    ajax_error_list["panel_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["audition_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["audition_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["audition_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["audition_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["audition_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["panel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["panel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["panel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["panel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["panel_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['audition_id_'])) ? $this->nmgp_cmp_readonly['audition_id_'] : 'off';
?>
    scAjaxFieldRead("audition_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['panel_'])) ? $this->nmgp_cmp_readonly['panel_'] : 'off';
?>
    scAjaxFieldRead("panel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("audition_id_" + iSeq, "on");
    scAjaxFieldRead("panel_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["audition_id_" + iRow] || "on" == ajax_error_count["panel_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_audition_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_panel_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["audition_id_" + iRow] && "off" == ajax_error_count["panel_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["audition_id_" + iRow] = "off";
        ajax_error_count["panel_" + iRow] = "off";
      ...
      $("#hidden_field_data_audition_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_panel_" + iRow).removeClass("scFormErrorLine");
