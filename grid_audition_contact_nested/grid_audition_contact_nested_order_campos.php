...
<?php
   ...
   $Ord_Cmp = new grid_audition_contact_nested_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_audition_contact_nested_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['contact_person'] = "contact_person";
   $tab_converte["contact_person"]   = "contact_person";
   $tab_labels["contact_person"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["contact_person"])) ? $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["contact_person"] : "Contact Person";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["email"] : "Email";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "phone";
   $tab_converte["phone"]   = "phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["phone"] : "Phone";
   $tab_ger_campos['website'] = "on";
   $tab_def_campos['website'] = "website";
   $tab_converte["website"]   = "website";
   $tab_labels["website"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["website"])) ? $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['labels']["website"] : "Website";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_audition_contact_nested_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_audition_contact_nested']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
