<?php
@session_start() ;
$_SESSION['scriptcase']['grid_audition_contact_nested']['sc_process_barr'] = true;
require_once('../grid_audition_contact_nested/index.php');
unset($_SESSION['scriptcase']['grid_audition_contact_nested']['sc_process_barr']);
$ExportCtrl = new grid_audition_contact_nested_export_control;
$ExportCtrl->Export_barr();

class grid_audition_contact_nested_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> audition_contact :: Excel</TITLE>
