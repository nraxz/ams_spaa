...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["app_menu_applicant"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["app_menu_applicant"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["app_menu_applicant"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($app_menu_applicant_menuData["data"]) && is_array($app_menu_applicant_menuData["data"]) && !empty($app_menu_applicant_menuData["data"]))
    {
        foreach($app_menu_applicant_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($app_menu_applicant_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
