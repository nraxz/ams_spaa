  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_application_detail_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_application_detail_mob_form();
	}

  // ---------- Validate venue_id
  function do_ajax_form_application_detail_mob_validate_venue_id()
  {
    var nomeCampo_venue_id = "venue_id";
    var var_venue_id = scAjaxGetFieldSelect(nomeCampo_venue_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_detail_mob_validate_venue_id(var_venue_id, var_script_case_init, do_ajax_form_application_detail_mob_validate_venue_id_cb);
  } // do_ajax_form_application_detail_mob_validate_venue_id

  function do_ajax_form_application_detail_mob_validate_venue_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_validate_venue_id_cb

  // ---------- Validate audition_id
  function do_ajax_form_application_detail_mob_validate_audition_id()
  {
    var nomeCampo_audition_id = "audition_id";
    var var_audition_id = scAjaxGetFieldSelect(nomeCampo_audition_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_detail_mob_validate_audition_id(var_audition_id, var_script_case_init, do_ajax_form_application_detail_mob_validate_audition_id_cb);
  } // do_ajax_form_application_detail_mob_validate_audition_id

  function do_ajax_form_application_detail_mob_validate_audition_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_validate_audition_id_cb

  // ---------- Validate program
  function do_ajax_form_application_detail_mob_validate_program()
  {
    var nomeCampo_program = "program";
    var var_program = scAjaxGetFieldCheckbox(nomeCampo_program, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_detail_mob_validate_program(var_program, var_script_case_init, do_ajax_form_application_detail_mob_validate_program_cb);
  } // do_ajax_form_application_detail_mob_validate_program

  function do_ajax_form_application_detail_mob_validate_program_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "program";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_validate_program_cb

  // ---------- Validate note
  function do_ajax_form_application_detail_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_detail_mob_validate_note(var_note, var_script_case_init, do_ajax_form_application_detail_mob_validate_note_cb);
  } // do_ajax_form_application_detail_mob_validate_note

  function do_ajax_form_application_detail_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_validate_note_cb

  // ---------- Validate info
  function do_ajax_form_application_detail_mob_validate_info()
  {
  } // do_ajax_form_application_detail_mob_validate_info

  function do_ajax_form_application_detail_mob_validate_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "info";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_validate_info_cb

  // ---------- Refresh venue_id
  function do_ajax_form_application_detail_mob_refresh_venue_id()
  {
    var var_venue_id = scAjaxGetFieldSelect("venue_id");
    var var_nmgp_refresh_fields = "audition_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_application_detail_mob_refresh_venue_id(var_venue_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_application_detail_mob_refresh_venue_id_cb);
  } // do_ajax_form_application_detail_mob_refresh_venue_id

  function do_ajax_form_application_detail_mob_refresh_venue_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_detail_mob_refresh_venue_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_application_detail_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_application_detail_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_venue_id = scAjaxGetFieldSelect("venue_id");
    var var_audition_id = scAjaxGetFieldSelect("audition_id");
    var var_program = scAjaxGetFieldCheckbox("program", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_application_detail_mob_submit_form(var_venue_id, var_audition_id, var_program, var_note, var_info, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_application_detail_mob_submit_form_cb);
  } // do_ajax_form_application_detail_mob_submit_form

  function do_ajax_form_application_detail_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_application_detail_mob_submit_form_cb_after_alert);
  } // do_ajax_form_application_detail_mob_submit_form_cb
  function do_ajax_form_application_detail_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_application_detail_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_application_detail_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_application_detail_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_application_detail_mob_navigate_form_cb);
  } // do_ajax_form_application_detail_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_application_detail_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_application_detail_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_application_detail_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_application_detail_mob_navigate_form_cb
  function do_ajax_form_application_detail_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_application_detail_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_application_detail_mob_navigate_form_cb_after_alert
  function sc_hide_form_application_detail_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "program": {"label": "Applying for course", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
