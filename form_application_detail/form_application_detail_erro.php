...
$old_error_handler = set_error_handler("form_application_detail_scriptcase_error_handler");

function form_application_detail_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_application_detail']['contr_erro']) && $_SESSION['scriptcase']['form_application_detail']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_application_detail->contr_form_application_detail->Apl_com_erro = true;
            if ($inicial_form_application_detail->contr_form_application_detail->NM_ajax_flag)
            {
                $inicial_form_application_detail->contr_form_application_detail->NM_ajax_info['errList']['geral_form_application_detail'][] = $msg;
                return;
            }
            form_application_detail_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_application_detail_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_application_detail'])  && '' != $_SESSION['scriptcase']['error_icon']['form_application_detail'])  ? $_SESSION['scriptcase']['error_icon']['form_application_detail']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_application_detail']) && '' != $_SESSION['scriptcase']['error_span_title']['form_application_detail']) ? $_SESSION['scriptcase']['error_span_title']['form_application_detail'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_application_detail']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_application_detail']) ? $_SESSION['scriptcase']['error_icon_title']['form_application_detail'] : '';
?>
