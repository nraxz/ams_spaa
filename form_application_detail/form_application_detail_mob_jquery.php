...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_venue_id' + iSeqRow).bind('blur', function() { sc_form_application_detail_venue_id_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_application_detail_venue_id_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_application_detail_venue_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_audition_id' + iSeqRow).bind('blur', function() { sc_form_application_detail_audition_id_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_application_detail_audition_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_program' + iSeqRow).bind('blur', function() { sc_form_application_detail_program_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_application_detail_program_onfocus(this, iSeqRow) });
  $('#id_sc_field_note' + iSeqRow).bind('blur', function() { sc_form_application_detail_note_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_application_detail_note_onfocus(this, iSeqRow) });
  $('#id_sc_field_info' + iSeqRow).bind('blur', function() { sc_form_application_detail_info_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_application_detail_info_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_application_detail_venue_id_onblur(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_validate_venue_id();
  scCssBlur(oThis);
}

function sc_form_application_detail_venue_id_onchange(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_refresh_venue_id();
}

function sc_form_application_detail_venue_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_application_detail_audition_id_onblur(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_validate_audition_id();
  scCssBlur(oThis);
}

function sc_form_application_detail_audition_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_application_detail_program_onblur(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_validate_program();
  scCssBlur(oThis);
}

function sc_form_application_detail_program_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_application_detail_note_onblur(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_validate_note();
  scCssBlur(oThis);
}

function sc_form_application_detail_note_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_application_detail_info_onblur(oThis, iSeqRow) {
  do_ajax_form_application_detail_mob_validate_info();
  scCssBlur(oThis);
}

function sc_form_application_detail_info_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_application_detail_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_submitted" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_application_detail_mob_validate_submitted(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
