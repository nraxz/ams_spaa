<?php
@session_start() ;
$_SESSION['scriptcase']['grid_manage_outcome_admin']['sc_process_barr'] = true;
require_once('../grid_manage_outcome_admin/index.php');
unset($_SESSION['scriptcase']['grid_manage_outcome_admin']['sc_process_barr']);
$ExportCtrl = new grid_manage_outcome_admin_export_control;
$ExportCtrl->Export_barr();

class grid_manage_outcome_admin_export_control
{
