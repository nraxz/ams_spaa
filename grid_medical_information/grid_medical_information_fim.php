...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_medical_information"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_medical_information"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_medical_information']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_medical_information']['opc_psq']) || $fecha_janela)
   {
       ...
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_medical_information']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_medical_information</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_medical_information']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_medical_information']['embutida_filho'] as $ind => $sc_init)
          {
