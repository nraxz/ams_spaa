...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_my_auditions"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_my_auditions"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_my_auditions']['embutida_filho'] as $ind => $sc_init)
          {
