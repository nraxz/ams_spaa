<?php
@session_start() ;
$_SESSION['scriptcase']['grid_my_auditions']['sc_process_barr'] = true;
require_once('../grid_my_auditions/index.php');
unset($_SESSION['scriptcase']['grid_my_auditions']['sc_process_barr']);
$ExportCtrl = new grid_my_auditions_export_control;
$ExportCtrl->Export_barr();

class grid_my_auditions_export_control
{
