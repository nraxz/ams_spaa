<?php
@session_start() ;
$_SESSION['scriptcase']['grid_academic']['sc_process_barr'] = true;
require_once('../grid_academic/index.php');
unset($_SESSION['scriptcase']['grid_academic']['sc_process_barr']);
$ExportCtrl = new grid_academic_export_control;
$ExportCtrl->Export_barr();

class grid_academic_export_control
{
