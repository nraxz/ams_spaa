...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_academic"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_academic"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_academic']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_academic']['opc_psq']) || $fecha_janela)
   {
       ...
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_academic']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_academic']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_academic']['embutida_filho'] as $ind => $sc_init)
          {
