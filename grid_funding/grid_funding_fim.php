...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_funding"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_funding"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_funding_i'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_funding']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_funding']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_funding']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_funding']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_funding']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_funding']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_funding']['embutida_filho'] as $ind => $sc_init)
          {
