<?php
@session_start() ;
$_SESSION['scriptcase']['grid_funding']['sc_process_barr'] = true;
require_once('../grid_funding/index.php');
unset($_SESSION['scriptcase']['grid_funding']['sc_process_barr']);
$ExportCtrl = new grid_funding_export_control;
$ExportCtrl->Export_barr();

class grid_funding_export_control
{
...
<HEAD>
 <TITLE>Funding Information :: Excel</TITLE>
