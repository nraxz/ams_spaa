  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subjects_grades_edit_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_subjects_grades_edit_mob_form();
	}

  // ---------- Validate academic_id
  function do_ajax_form_subjects_grades_edit_mob_validate_academic_id()
  {
    var nomeCampo_academic_id = "academic_id";
    var var_academic_id = scAjaxGetFieldSelect(nomeCampo_academic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_mob_validate_academic_id(var_academic_id, var_script_case_init, do_ajax_form_subjects_grades_edit_mob_validate_academic_id_cb);
  } // do_ajax_form_subjects_grades_edit_mob_validate_academic_id

  function do_ajax_form_subjects_grades_edit_mob_validate_academic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "academic_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_mob_validate_academic_id_cb

  // ---------- Validate level
  function do_ajax_form_subjects_grades_edit_mob_validate_level()
  {
    var nomeCampo_level = "level";
    var var_level = scAjaxGetFieldSelect(nomeCampo_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_mob_validate_level(var_level, var_script_case_init, do_ajax_form_subjects_grades_edit_mob_validate_level_cb);
  } // do_ajax_form_subjects_grades_edit_mob_validate_level

  function do_ajax_form_subjects_grades_edit_mob_validate_level_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "level";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_mob_validate_level_cb

  // ---------- Validate subject
  function do_ajax_form_subjects_grades_edit_mob_validate_subject()
  {
    var nomeCampo_subject = "subject";
    var var_subject = scAjaxGetFieldText(nomeCampo_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_mob_validate_subject(var_subject, var_script_case_init, do_ajax_form_subjects_grades_edit_mob_validate_subject_cb);
  } // do_ajax_form_subjects_grades_edit_mob_validate_subject

  function do_ajax_form_subjects_grades_edit_mob_validate_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "subject";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_mob_validate_subject_cb

  // ---------- Validate grades
  function do_ajax_form_subjects_grades_edit_mob_validate_grades()
  {
    var nomeCampo_grades = "grades";
    var var_grades = scAjaxGetFieldText(nomeCampo_grades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_mob_validate_grades(var_grades, var_script_case_init, do_ajax_form_subjects_grades_edit_mob_validate_grades_cb);
  } // do_ajax_form_subjects_grades_edit_mob_validate_grades

  function do_ajax_form_subjects_grades_edit_mob_validate_grades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grades";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_mob_validate_grades_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_subjects_grades_edit_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_subjects_grades_edit_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_academic_id = scAjaxGetFieldSelect("academic_id");
    var var_level = scAjaxGetFieldSelect("level");
    var var_subject = scAjaxGetFieldText("subject");
    var var_grades = scAjaxGetFieldText("grades");
    ...
    scAjaxProcOn();
    x_ajax_form_subjects_grades_edit_mob_submit_form(var_academic_id, var_level, var_subject, var_grades, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_subjects_grades_edit_mob_submit_form_cb);
  } // do_ajax_form_subjects_grades_edit_mob_submit_form

  function do_ajax_form_subjects_grades_edit_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("academic_id");
      scAjaxHideErrorDisplay("level");
      scAjaxHideErrorDisplay("subject");
      scAjaxHideErrorDisplay("grades");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_subjects_grades_edit_mob_submit_form_cb_after_alert);
  } // do_ajax_form_subjects_grades_edit_mob_submit_form_cb
  function do_ajax_form_subjects_grades_edit_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_subjects_grades_edit_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_subjects_grades_edit_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_subjects_grades_edit_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subjects_grades_edit_mob_navigate_form_cb);
  } // do_ajax_form_subjects_grades_edit_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_subjects_grades_edit_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_subjects_grades_edit_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_subjects_grades_edit_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_subjects_grades_edit_mob_navigate_form_cb
  function do_ajax_form_subjects_grades_edit_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_subjects_grades_edit_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_subjects_grades_edit_mob_navigate_form_cb_after_alert
  function sc_hide_form_subjects_grades_edit_mob_form()
  {
  ...
  ajax_field_list[0] = "academic_id";
  ajax_field_list[1] = "level";
  ajax_field_list[2] = "subject";
  ajax_field_list[3] = "grades";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "academic_id": {"label": "Institution", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "level": {"label": "Level", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "subject": {"label": "Subject<br/><span style=\"color: #333333; font-size: 7.5pt\"> Please include full course title<br/> e.g. BTEC Extended Diploma Performing Arts</span>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grades": {"label": "Grades<br/><span style=\"color: #333333; font-size: 7.5pt\">For exams yet to be taken,<br/>please list predicted grades with P<br/> before the grades, e.g. P: A</span>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "academic_id": new Array(),
    "level": new Array(),
    "subject": new Array(),
    "grades": new Array()
  };
  ajax_field_mult["academic_id"][1] = "academic_id";
  ajax_field_mult["level"][1] = "level";
  ajax_field_mult["subject"][1] = "subject";
  ajax_field_mult["grades"][1] = "grades";

  var ajax_field_id = {
    "academic_id": new Array("hidden_field_label_academic_id", "hidden_field_data_academic_id"),
    ...
    "grades": new Array("hidden_field_label_grades", "hidden_field_data_grades")
  };
