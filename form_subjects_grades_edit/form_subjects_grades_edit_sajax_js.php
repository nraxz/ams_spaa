  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subjects_grades_edit" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_subjects_grades_edit_form();
	}

  // ---------- Validate academic_id
  function do_ajax_form_subjects_grades_edit_validate_academic_id()
  {
    var nomeCampo_academic_id = "academic_id";
    var var_academic_id = scAjaxGetFieldSelect(nomeCampo_academic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_validate_academic_id(var_academic_id, var_script_case_init, do_ajax_form_subjects_grades_edit_validate_academic_id_cb);
  } // do_ajax_form_subjects_grades_edit_validate_academic_id

  function do_ajax_form_subjects_grades_edit_validate_academic_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_validate_academic_id_cb

  // ---------- Validate level
  function do_ajax_form_subjects_grades_edit_validate_level()
  {
    var nomeCampo_level = "level";
    var var_level = scAjaxGetFieldSelect(nomeCampo_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_validate_level(var_level, var_script_case_init, do_ajax_form_subjects_grades_edit_validate_level_cb);
  } // do_ajax_form_subjects_grades_edit_validate_level

  function do_ajax_form_subjects_grades_edit_validate_level_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "level";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_validate_level_cb

  // ---------- Validate subject
  function do_ajax_form_subjects_grades_edit_validate_subject()
  {
    var nomeCampo_subject = "subject";
    var var_subject = scAjaxGetFieldText(nomeCampo_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_validate_subject(var_subject, var_script_case_init, do_ajax_form_subjects_grades_edit_validate_subject_cb);
  } // do_ajax_form_subjects_grades_edit_validate_subject

  function do_ajax_form_subjects_grades_edit_validate_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "subject";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_validate_subject_cb

  // ---------- Validate grades
  function do_ajax_form_subjects_grades_edit_validate_grades()
  {
    var nomeCampo_grades = "grades";
    var var_grades = scAjaxGetFieldText(nomeCampo_grades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subjects_grades_edit_validate_grades(var_grades, var_script_case_init, do_ajax_form_subjects_grades_edit_validate_grades_cb);
  } // do_ajax_form_subjects_grades_edit_validate_grades

  function do_ajax_form_subjects_grades_edit_validate_grades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grades";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subjects_grades_edit_validate_grades_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_subjects_grades_edit_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_subjects_grades_edit_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_subjects_grades_edit_submit_form(var_academic_id, var_level, var_subject, var_grades, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_subjects_grades_edit_submit_form_cb);
  } // do_ajax_form_subjects_grades_edit_submit_form

  function do_ajax_form_subjects_grades_edit_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_subjects_grades_edit_submit_form_cb_after_alert);
  } // do_ajax_form_subjects_grades_edit_submit_form_cb
  function do_ajax_form_subjects_grades_edit_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_subjects_grades_edit_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_subjects_grades_edit_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_subjects_grades_edit_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subjects_grades_edit_navigate_form_cb);
  } // do_ajax_form_subjects_grades_edit_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_subjects_grades_edit']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_subjects_grades_edit_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_subjects_grades_edit_navigate_form_cb_after_alert);
  } // do_ajax_form_subjects_grades_edit_navigate_form_cb
  function do_ajax_form_subjects_grades_edit_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_subjects_grades_edit_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_subjects_grades_edit_navigate_form_cb_after_alert
  function sc_hide_form_subjects_grades_edit_form()
  {
