...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_subjects_grades_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_subjects_grades_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function nm_mostra_mens(bloco, iframe)
{
    if (iframe == null)
    {
        NovaJanela = window.open ("form_subjects_grades_mob_help.php?nm_bloco=" + bloco + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>", "ScriptCase", "resizable, scrollbars");
    }
    else
    {
        NovaJanela = window.open ("../form_subjects_grades_mob/form_subjects_grades_mob_help.php?nm_bloco=" + bloco + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>", "ScriptCase", "resizable, scrollbars");
    }
}
