<?php
@session_start() ;
$_SESSION['scriptcase']['grid_programs_admin']['sc_process_barr'] = true;
require_once('../grid_programs_admin/index.php');
unset($_SESSION['scriptcase']['grid_programs_admin']['sc_process_barr']);
$ExportCtrl = new grid_programs_admin_export_control;
$ExportCtrl->Export_barr();

class grid_programs_admin_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> programs :: Excel</TITLE>
