...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate user_email
  function do_ajax_app_retrieve_pswd_validate_user_email()
  {
    var nomeCampo_user_email = "user_email";
    var var_user_email = scAjaxGetFieldText(nomeCampo_user_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_retrieve_pswd_validate_user_email(var_user_email, var_script_case_init, do_ajax_app_retrieve_pswd_validate_user_email_cb);
  } // do_ajax_app_retrieve_pswd_validate_user_email

  function do_ajax_app_retrieve_pswd_validate_user_email_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_retrieve_pswd_validate_user_email_cb

  // ---------- Event onblur user_email
  function do_ajax_app_retrieve_pswd_event_user_email_onblur()
  {
    var var_user_email = scAjaxGetFieldText("user_email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_retrieve_pswd_event_user_email_onblur(var_user_email, var_script_case_init, do_ajax_app_retrieve_pswd_event_user_email_onblur_cb);
  } // do_ajax_app_retrieve_pswd_event_user_email_onblur

  function do_ajax_app_retrieve_pswd_event_user_email_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "user_email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app_retrieve_pswd_event_user_email_onblur_cb_after_alert);
  } // do_ajax_app_retrieve_pswd_event_user_email_onblur_cb
  function do_ajax_app_retrieve_pswd_event_user_email_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_retrieve_pswd_event_user_email_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_retrieve_pswd_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_retrieve_pswd_submit_form(var_user_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_retrieve_pswd_submit_form_cb);
