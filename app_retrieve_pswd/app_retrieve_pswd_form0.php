...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['run_iframe']) ? 'margin: 2px;' : '';
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_user_email_line" id="hidden_field_data_user_email" style="<?php echo $sStyleHidden_user_email; ?>"> <span class="scFormLabelOddFormat css_user_email_label"><span id="id_label_user_email"><?php echo $this->nm_new_label['user_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['php_cmp_required']['user_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_retrieve_pswd']['php_cmp_required']['user_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
