...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_all_register"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_admin_all_register"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_admin_all_register</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_admin_all_register']['embutida_filho'] as $ind => $sc_init)
          {
