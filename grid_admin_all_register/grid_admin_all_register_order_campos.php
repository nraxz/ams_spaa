...
<?php
   ...
   $Ord_Cmp = new grid_admin_all_register_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_all_register_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["sec_users_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_login"] : "SID";
   $tab_ger_campos['sec_users_firstname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sec_users_firstname'] = "sec_users_firstname";
       $tab_converte["sec_users_firstname"]   = "sec_users_firstname";
   }
   else
   {
       $tab_def_campos['sec_users_firstname'] = "sec_users.firstname";
       $tab_converte["sec_users.firstname"]   = "sec_users_firstname";
   }
   $tab_labels["sec_users_firstname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_firstname"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_firstname"] : "Firstname";
   $tab_ger_campos['sec_users_lastname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sec_users_lastname'] = "sec_users_lastname";
       $tab_converte["sec_users_lastname"]   = "sec_users_lastname";
   }
   else
   {
       $tab_def_campos['sec_users_lastname'] = "sec_users.lastname";
       $tab_converte["sec_users.lastname"]   = "sec_users_lastname";
   }
   $tab_labels["sec_users_lastname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_lastname"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_lastname"] : "Lastname";
   ...
   $tab_labels["sec_users_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_email"] : "Email";
   $tab_ger_campos['sec_users_active'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sec_users_active'] = "sec_users_active";
       $tab_converte["sec_users_active"]   = "sec_users_active";
   }
   else
   {
       $tab_def_campos['sec_users_active'] = "sec_users.active";
       $tab_converte["sec_users.active"]   = "sec_users_active";
   }
   $tab_labels["sec_users_active"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_active"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["sec_users_active"] : "Active";
   ...
   $tab_labels["view"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["view"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['labels']["view"] : "View";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_all_register_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_all_register']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
