  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_application_register_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_application_register_admin_form();
	}

  // ---------- Validate login_
  function do_ajax_form_application_register_admin_validate_login_(iNumLinha)
  {
    var nomeCampo_login_ = "login_" + iNumLinha;
    var var_login_ = scAjaxGetFieldHidden(nomeCampo_login_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_validate_login_(var_login_, iNumLinha, var_script_case_init, do_ajax_form_application_register_admin_validate_login__cb);
  } // do_ajax_form_application_register_admin_validate_login_

  function do_ajax_form_application_register_admin_validate_login__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_login__cb

  // ---------- Validate fullname_
  function do_ajax_form_application_register_admin_validate_fullname_(iNumLinha)
  {
  } // do_ajax_form_application_register_admin_validate_fullname_

  function do_ajax_form_application_register_admin_validate_fullname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fullname_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fullname_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fullname_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fullname_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_fullname__cb

  // ---------- Validate number_
  function do_ajax_form_application_register_admin_validate_number_(iNumLinha)
  {
    var nomeCampo_number_ = "number_" + iNumLinha;
    var var_number_ = scAjaxGetFieldText(nomeCampo_number_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_validate_number_(var_number_, iNumLinha, var_script_case_init, do_ajax_form_application_register_admin_validate_number__cb);
  } // do_ajax_form_application_register_admin_validate_number_

  function do_ajax_form_application_register_admin_validate_number__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_number__cb

  // ---------- Validate register_
  function do_ajax_form_application_register_admin_validate_register_(iNumLinha)
  {
    var nomeCampo_register_ = "register_" + iNumLinha;
    var var_register_ = scAjaxGetFieldSelect(nomeCampo_register_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_validate_register_(var_register_, iNumLinha, var_script_case_init, do_ajax_form_application_register_admin_validate_register__cb);
  } // do_ajax_form_application_register_admin_validate_register_

  function do_ajax_form_application_register_admin_validate_register__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "register_" + iLineNumber;
    }
    else
    {
      sFieldValid = "register_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "register_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "register_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_register__cb

  // ---------- Validate profile_
  function do_ajax_form_application_register_admin_validate_profile_(iNumLinha)
  {
    var nomeCampo_profile_ = "profile_" + iNumLinha;
    var var_profile_ = scAjaxGetFieldText(nomeCampo_profile_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_validate_profile_(var_profile_, iNumLinha, var_script_case_init, do_ajax_form_application_register_admin_validate_profile__cb);
  } // do_ajax_form_application_register_admin_validate_profile_

  function do_ajax_form_application_register_admin_validate_profile__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "profile_" + iLineNumber;
    }
    else
    {
      sFieldValid = "profile_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "profile_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "profile_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_profile__cb

  // ---------- Validate id_
  function do_ajax_form_application_register_admin_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_application_register_admin_validate_id__cb);
  } // do_ajax_form_application_register_admin_validate_id_

  function do_ajax_form_application_register_admin_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_application_register_admin_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_application_register_admin_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_application_register_admin_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_application_register_admin_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_application_register_admin_add_new_line_cb);
  } // do_ajax_form_application_register_admin_add_new_line

  function do_ajax_form_application_register_admin_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_application_register_admin_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_application_register_admin_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_application_register_admin_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_application_register_admin_backup_line_cb);
  } // do_ajax_form_application_register_admin_backup_line

  function do_ajax_form_application_register_admin_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_application_register_admin_backup_line_cb

  function do_ajax_form_application_register_admin_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_application_register_admin_cancel_insert

  function do_ajax_form_application_register_admin_cancel_update(iSeqVert)
  {
    do_ajax_form_application_register_admin_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_application_register_admin_cancel_update

  function do_ajax_form_application_register_admin_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_application_register_admin_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_application_register_admin_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_application_register_admin_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_application_register_admin_table_refresh_cb);
  } //  do_ajax_form_application_register_admin_table_refresh

  function do_ajax_form_application_register_admin_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scJQGeneralAdd();
    scAjaxAlert(do_ajax_form_application_register_admin_table_refresh_cb_after_alert);
  } // do_ajax_form_application_register_admin_table_refresh_cb
  function do_ajax_form_application_register_admin_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_application_register_admin_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_application_register_admin_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_application_register_admin_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_login_ = scAjaxGetFieldHidden("login_" + iNumLinha);
    var var_fullname_ = scAjaxGetFieldHidden("fullname_" + iNumLinha);
    var var_number_ = scAjaxGetFieldText("number_" + iNumLinha);
    var var_register_ = scAjaxGetFieldSelect("register_" + iNumLinha);
    var var_profile_ = "";
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_application_register_admin_submit_form(var_login_, var_fullname_, var_number_, var_register_, var_profile_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_application_register_admin_submit_form_cb);
  } // do_ajax_form_application_register_admin_submit_form

  function do_ajax_form_application_register_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fullname_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("number_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("register_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("profile_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_application_register_admin_submit_form_cb_after_alert);
  } // do_ajax_form_application_register_admin_submit_form_cb
  function do_ajax_form_application_register_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_application_register_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_application_register_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_application_register_admin_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fullname_" + iNavForm);
      scAjaxHideErrorDisplay("number_" + iNavForm);
      scAjaxHideErrorDisplay("register_" + iNavForm);
      scAjaxHideErrorDisplay("profile_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_application_register_admin_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_application_register_admin_navigate_form_cb);
  } // do_ajax_form_application_register_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_application_register_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_application_register_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_application_register_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_application_register_admin_navigate_form_cb
  function do_ajax_form_application_register_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_application_register_admin_navigate_form_cb_after_alert
  function sc_hide_form_application_register_admin_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fullname_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "number_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "register_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "profile_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["login_" + iNumLinha] = {"label": "Login<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fullname_" + iNumLinha] = {"label": "Applicant Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["number_" + iNumLinha] = {"label": "Number<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["register_" + iNumLinha] = {"label": "Register<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["profile_" + iNumLinha] = {"label": "Applicant Detail<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fullname_"][iNumLinha] = "fullname_" + iNumLinha;
    ajax_field_mult["number_"][iNumLinha] = "number_" + iNumLinha;
    ajax_field_mult["register_"][iNumLinha] = "register_" + iNumLinha;
    ajax_field_mult["profile_"][iNumLinha] = "profile_" + iNumLinha;
    ...
    ajax_field_id["fullname_" + iNumLinha] = new Array("hidden_field_label_fullname_", "hidden_field_data_fullname_" + iNumLinha);
    ajax_field_id["number_" + iNumLinha] = new Array("hidden_field_label_number_", "hidden_field_data_number_" + iNumLinha);
    ajax_field_id["register_" + iNumLinha] = new Array("hidden_field_label_register_", "hidden_field_data_register_" + iNumLinha);
    ajax_field_id["profile_" + iNumLinha] = new Array("hidden_field_label_profile_", "hidden_field_data_profile_" + iNumLinha);
    ajax_error_count["login_" + iNumLinha] = "off";
    ajax_error_count["fullname_" + iNumLinha] = "off";
    ajax_error_count["number_" + iNumLinha] = "off";
    ajax_error_count["register_" + iNumLinha] = "off";
    ajax_error_count["profile_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["login_" + iNumLinha] = "off";
    ajax_read_only["fullname_" + iNumLinha] = "off";
    ajax_read_only["number_" + iNumLinha] = "off";
    ajax_read_only["register_" + iNumLinha] = "off";
    ajax_read_only["profile_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fullname_" + iNumLinha] = "on";
    ajax_read_only["number_" + iNumLinha] = "on";
    ajax_read_only["register_" + iNumLinha] = "on";
    ajax_read_only["profile_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fullname_" + iNumLinha] = null;
    ajax_error_list["number_" + iNumLinha] = null;
    ajax_error_list["register_" + iNumLinha] = null;
    ajax_error_list["profile_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fullname_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fullname_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fullname_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fullname_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fullname_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["register_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["register_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["register_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["register_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["register_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["profile_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["profile_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["profile_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["profile_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["profile_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['login_'])) ? $this->nmgp_cmp_readonly['login_'] : 'off';
?>
    scAjaxFieldRead("login_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fullname_'])) ? $this->nmgp_cmp_readonly['fullname_'] : 'off';
?>
    scAjaxFieldRead("fullname_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['register_'])) ? $this->nmgp_cmp_readonly['register_'] : 'off';
?>
    scAjaxFieldRead("register_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['profile_'])) ? $this->nmgp_cmp_readonly['profile_'] : 'off';
?>
    scAjaxFieldRead("profile_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fullname_" + iSeq, "on");
    scAjaxFieldRead("number_" + iSeq, "on");
    scAjaxFieldRead("register_" + iSeq, "on");
    scAjaxFieldRead("profile_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["login_" + iRow] || "on" == ajax_error_count["fullname_" + iRow] || "on" == ajax_error_count["number_" + iRow] || "on" == ajax_error_count["register_" + iRow] || "on" == ajax_error_count["profile_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_login_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fullname_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_number_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_register_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_profile_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["login_" + iRow] && "off" == ajax_error_count["fullname_" + iRow] && "off" == ajax_error_count["number_" + iRow] && "off" == ajax_error_count["register_" + iRow] && "off" == ajax_error_count["profile_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["login_" + iRow] = "off";
        ajax_error_count["fullname_" + iRow] = "off";
        ajax_error_count["number_" + iRow] = "off";
        ajax_error_count["register_" + iRow] = "off";
        ajax_error_count["profile_" + iRow] = "off";
      ...
      $("#hidden_field_data_login_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fullname_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_number_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_register_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_profile_" + iRow).removeClass("scFormErrorLine");
