  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_applicant_outcome_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_applicant_outcome_admin_form();
	}

  // ---------- Validate outcome_id
  function do_ajax_form_applicant_outcome_admin_validate_outcome_id()
  {
    var nomeCampo_outcome_id = "outcome_id";
    var var_outcome_id = scAjaxGetFieldSelect(nomeCampo_outcome_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_applicant_outcome_admin_validate_outcome_id(var_outcome_id, var_script_case_init, do_ajax_form_applicant_outcome_admin_validate_outcome_id_cb);
  } // do_ajax_form_applicant_outcome_admin_validate_outcome_id

  function do_ajax_form_applicant_outcome_admin_validate_outcome_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_applicant_outcome_admin_validate_outcome_id_cb

  // ---------- Validate published
  function do_ajax_form_applicant_outcome_admin_validate_published()
  {
    var nomeCampo_published = "published";
    var var_published = scAjaxGetFieldSelect(nomeCampo_published);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_applicant_outcome_admin_validate_published(var_published, var_script_case_init, do_ajax_form_applicant_outcome_admin_validate_published_cb);
  } // do_ajax_form_applicant_outcome_admin_validate_published

  function do_ajax_form_applicant_outcome_admin_validate_published_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_applicant_outcome_admin_validate_published_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_applicant_outcome_admin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_applicant_outcome_admin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_applicant_outcome_admin_submit_form(var_outcome_id, var_published, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_applicant_outcome_admin_submit_form_cb);
  } // do_ajax_form_applicant_outcome_admin_submit_form

  function do_ajax_form_applicant_outcome_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_applicant_outcome_admin_submit_form_cb_after_alert);
  } // do_ajax_form_applicant_outcome_admin_submit_form_cb
  function do_ajax_form_applicant_outcome_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_applicant_outcome_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_applicant_outcome_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_applicant_outcome_admin_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_applicant_outcome_admin_navigate_form_cb);
  } // do_ajax_form_applicant_outcome_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_applicant_outcome_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_applicant_outcome_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_applicant_outcome_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_applicant_outcome_admin_navigate_form_cb
  function do_ajax_form_applicant_outcome_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_applicant_outcome_admin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_applicant_outcome_admin_navigate_form_cb_after_alert
  function sc_hide_form_applicant_outcome_admin_form()
  {
