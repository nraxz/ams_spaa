  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_applicant_outcome_admin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_applicant_outcome_admin_mob_form();
	}

  // ---------- Validate outcome_id
  function do_ajax_form_applicant_outcome_admin_mob_validate_outcome_id()
  {
    var nomeCampo_outcome_id = "outcome_id";
    var var_outcome_id = scAjaxGetFieldSelect(nomeCampo_outcome_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_applicant_outcome_admin_mob_validate_outcome_id(var_outcome_id, var_script_case_init, do_ajax_form_applicant_outcome_admin_mob_validate_outcome_id_cb);
  } // do_ajax_form_applicant_outcome_admin_mob_validate_outcome_id

  function do_ajax_form_applicant_outcome_admin_mob_validate_outcome_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "outcome_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_applicant_outcome_admin_mob_validate_outcome_id_cb

  // ---------- Validate published
  function do_ajax_form_applicant_outcome_admin_mob_validate_published()
  {
    var nomeCampo_published = "published";
    var var_published = scAjaxGetFieldSelect(nomeCampo_published);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_applicant_outcome_admin_mob_validate_published(var_published, var_script_case_init, do_ajax_form_applicant_outcome_admin_mob_validate_published_cb);
  } // do_ajax_form_applicant_outcome_admin_mob_validate_published

  function do_ajax_form_applicant_outcome_admin_mob_validate_published_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_applicant_outcome_admin_mob_validate_published_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_applicant_outcome_admin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_applicant_outcome_admin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_outcome_id = scAjaxGetFieldSelect("outcome_id");
    ...
    scAjaxProcOn();
    x_ajax_form_applicant_outcome_admin_mob_submit_form(var_outcome_id, var_published, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_applicant_outcome_admin_mob_submit_form_cb);
  } // do_ajax_form_applicant_outcome_admin_mob_submit_form

  function do_ajax_form_applicant_outcome_admin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("outcome_id");
      scAjaxHideErrorDisplay("published");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_applicant_outcome_admin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_applicant_outcome_admin_mob_submit_form_cb
  function do_ajax_form_applicant_outcome_admin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_applicant_outcome_admin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_applicant_outcome_admin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_applicant_outcome_admin_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb);
  } // do_ajax_form_applicant_outcome_admin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_applicant_outcome_admin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb
  function do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_applicant_outcome_admin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_applicant_outcome_admin_mob_navigate_form_cb_after_alert
  function sc_hide_form_applicant_outcome_admin_mob_form()
  {
  ...
  ajax_field_list[0] = "outcome_id";
  ajax_field_list[1] = "published";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "outcome_id": {"label": "Outcome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "published": {"label": "Published", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "outcome_id": new Array(),
    "published": new Array()
  };
  ajax_field_mult["outcome_id"][1] = "outcome_id";
  ajax_field_mult["published"][1] = "published";

  var ajax_field_id = {
    "outcome_id": new Array("hidden_field_label_outcome_id", "hidden_field_data_outcome_id"),
