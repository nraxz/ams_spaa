...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_email_test/form_email_test_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
include_once('form_email_test_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_email_test_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_email_test'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_email_test'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-1", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-2", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_label" id="hidden_field_label_smtp" style="<?php echo $sStyleHidden_smtp; ?>"><span id="id_label_smtp"><?php echo $this->nm_new_label['smtp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_smtp_line" id="hidden_field_data_smtp" style="<?php echo $sStyleHidden_smtp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_smtp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_email_label" id="hidden_field_label_smtp_email" style="<?php echo $sStyleHidden_smtp_email; ?>"><span id="id_label_smtp_email"><?php echo $this->nm_new_label['smtp_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_smtp_email_line" id="hidden_field_data_smtp_email" style="<?php echo $sStyleHidden_smtp_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_smtp_email_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_smtp_user_label" id="hidden_field_label_smtp_user" style="<?php echo $sStyleHidden_smtp_user; ?>"><span id="id_label_smtp_user"><?php echo $this->nm_new_label['smtp_user']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp_user']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['smtp_user'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_smtp_user_line" id="hidden_field_data_smtp_user" style="<?php echo $sStyleHidden_smtp_user; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_smtp_user_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_format_label" id="hidden_field_label_format" style="<?php echo $sStyleHidden_format; ?>"><span id="id_label_format"><?php echo $this->nm_new_label['format']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['format']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['format'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_format_line" id="hidden_field_data_format" style="<?php echo $sStyleHidden_format; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_format_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_format'][] = ''; ?>
 <option value=""></option>
 <option  value="H" <?php  if ($this->format == "H") { echo " selected" ;} ?>>HTML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_format'][] = 'H'; ?>
 <option  value="T" <?php  if ($this->format == "T") { echo " selected" ;} ?>>Text</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_format'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_port_label" id="hidden_field_label_port" style="<?php echo $sStyleHidden_port; ?>"><span id="id_label_port"><?php echo $this->nm_new_label['port']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['port']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['port'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_port_line" id="hidden_field_data_port" style="<?php echo $sStyleHidden_port; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_port_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_security_label" id="hidden_field_label_security" style="<?php echo $sStyleHidden_security; ?>"><span id="id_label_security"><?php echo $this->nm_new_label['security']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['security']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['security'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_security_line" id="hidden_field_data_security" style="<?php echo $sStyleHidden_security; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_security_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_security'][] = ''; ?>
 <option value=""></option>
 <option  value="S" <?php  if ($this->security == "S") { echo " selected" ;} ?>>S</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_security'][] = 'S'; ?>
 <option  value="T" <?php  if ($this->security == "T") { echo " selected" ;} ?>>T</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_security'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_active_label" id="hidden_field_label_active" style="<?php echo $sStyleHidden_active; ?>"><span id="id_label_active"><?php echo $this->nm_new_label['active']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['active']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['php_cmp_required']['active'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_active'][] = ''; ?>
 <option value=""></option>
 <option  value="Yes" <?php  if ($this->active == "Yes") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_active'][] = 'Yes'; ?>
 <option  value="No" <?php  if ($this->active == "No") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['Lookup_active'][] = 'No'; ?>
 </select></span>
</span><?php  }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sent_to']))
    {
        $this->nm_new_label['sent_to'] = "Send Email to";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_sent_to = '';
   if (isset($this->nmgp_cmp_hidden['sent_to']) && $this->nmgp_cmp_hidden['sent_to'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sent_to']);
       $sStyleHidden_sent_to = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sent_to = 'display: none;';
   $sStyleReadInp_sent_to = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sent_to']) && $this->nmgp_cmp_readonly['sent_to'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sent_to']);
       $sStyleReadLab_sent_to = '';
       $sStyleReadInp_sent_to = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sent_to']) && $this->nmgp_cmp_hidden['sent_to'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sent_to" value="<?php echo $this->form_encode_input($sent_to) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_sent_to_label" id="hidden_field_label_sent_to" style="<?php echo $sStyleHidden_sent_to; ?>"><span id="id_label_sent_to"><?php echo $this->nm_new_label['sent_to']; ?></span></TD>
    <TD class="scFormDataOdd css_sent_to_line" id="hidden_field_data_sent_to" style="<?php echo $sStyleHidden_sent_to; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sent_to_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sent_to"]) &&  $this->nmgp_cmp_readonly["sent_to"] == "on") { 

 ?>
<input type="hidden" name="sent_to" value="<?php echo $this->form_encode_input($sent_to) . "\">" . $sent_to . ""; ?>
<?php } else { ?>
<span id="id_read_on_sent_to" class="sc-ui-readonly-sent_to css_sent_to_line" style="<?php echo $sStyleReadLab_sent_to; ?>"><?php echo $this->form_encode_input($this->sent_to); ?></span><span id="id_read_off_sent_to" class="css_read_off_sent_to" style="white-space: nowrap;<?php echo $sStyleReadInp_sent_to; ?>">
 <input class="sc-js-input scFormObjectOdd css_sent_to_obj" style="" id="id_sc_field_sent_to" type=text name="sent_to" value="<?php echo $this->form_encode_input($sent_to) ?>"
 size=40 maxlength=40 alt="{enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >&nbsp;<span style="display: none"><?php echo nmButtonOutput($this->arr_buttons, "bemail", "if (document.F1.sent_to.value != '') {window.open('mailto:' + document.F1.sent_to.value); }", "if (document.F1.sent_to.value != '') {window.open('mailto:' + document.F1.sent_to.value); }", "sent_to_mail", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span>
</span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sent_to_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sent_to_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_email_test");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_email_test");
 parent.scAjaxDetailHeight("form_email_test", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
