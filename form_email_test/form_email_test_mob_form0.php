...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['embutida_pdf']))
 {
 ?>
...
include_once('form_email_test_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_email_test']['error_buffer']) && '' != $_SESSION['scriptcase']['form_email_test']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_email_test']['error_buffer'];
}
...
<?php
 include_once("form_email_test_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_email_test_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_email_test_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_email_test_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-6", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-7", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtp_line" id="hidden_field_data_smtp" style="<?php echo $sStyleHidden_smtp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_smtp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_smtp_label"><span id="id_label_smtp"><?php echo $this->nm_new_label['smtp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['smtp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['smtp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_smtp_user_line" id="hidden_field_data_smtp_user" style="<?php echo $sStyleHidden_smtp_user; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_smtp_user_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_smtp_user_label"><span id="id_label_smtp_user"><?php echo $this->nm_new_label['smtp_user']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['smtp_user']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['smtp_user'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_format'][] = ''; ?>
 <option value=""></option>
 <option  value="H" <?php  if ($this->format == "H") { echo " selected" ;} ?>>HTML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_format'][] = 'H'; ?>
 <option  value="T" <?php  if ($this->format == "T") { echo " selected" ;} ?>>Text</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_format'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_port_line" id="hidden_field_data_port" style="<?php echo $sStyleHidden_port; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_port_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_port_label"><span id="id_label_port"><?php echo $this->nm_new_label['port']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['port']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['port'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_security_line" id="hidden_field_data_security" style="<?php echo $sStyleHidden_security; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_security_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_security_label"><span id="id_label_security"><?php echo $this->nm_new_label['security']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['security']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['php_cmp_required']['security'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_security'][] = ''; ?>
 <option value=""></option>
 <option  value="S" <?php  if ($this->security == "S") { echo " selected" ;} ?>>S</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_security'][] = 'S'; ?>
 <option  value="T" <?php  if ($this->security == "T") { echo " selected" ;} ?>>T</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_security'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_active'][] = ''; ?>
 <option value=""></option>
 <option  value="Yes" <?php  if ($this->active == "Yes") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_active'][] = 'Yes'; ?>
 <option  value="No" <?php  if ($this->active == "No") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['Lookup_active'][] = 'No'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sent_to_line" id="hidden_field_data_sent_to" style="<?php echo $sStyleHidden_sent_to; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sent_to_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sent_to_label"><span id="id_label_sent_to"><?php echo $this->nm_new_label['sent_to']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_email_test_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_email_test_mob");
 parent.scAjaxDetailHeight("form_email_test_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_ret() {
		...
		if ($("#sc_b_ret_t.sc-unique-btn-6").length && $("#sc_b_ret_t.sc-unique-btn-6").is(":visible")) {
			nm_move ('retorna');
			 return;
		}
	}
	function scBtnFn_sys_format_ava() {
		...
		if ($("#sc_b_avc_t.sc-unique-btn-7").length && $("#sc_b_avc_t.sc-unique-btn-7").is(":visible")) {
			nm_move ('avanca');
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_email_test_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
