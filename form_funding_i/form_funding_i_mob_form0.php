...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_funding_i_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_funding_i_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_funding_i']['error_buffer']) && '' != $_SESSION['scriptcase']['form_funding_i']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_funding_i']['error_buffer'];
}
...
<?php
 include_once("form_funding_i_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_funding_i_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_funding_i_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_funding_i_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_are_you_line" id="hidden_field_data_are_you" style="<?php echo $sStyleHidden_are_you; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_are_you_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_are_you_label"><span id="id_label_are_you"><?php echo $this->nm_new_label['are_you']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['php_cmp_required']['are_you']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['php_cmp_required']['are_you'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_are_you'][] = 'a UK Student'; ?>
<?php  if ("a UK Student" == $this->are_you)  { echo " checked" ;} ?>  onClick="do_ajax_form_funding_i_mob_event_are_you_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_are_you'][] = 'an EU Student'; ?>
<?php  if ("an EU Student" == $this->are_you)  { echo " checked" ;} ?>  onClick="do_ajax_form_funding_i_mob_event_are_you_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_are_you'][] = 'an International Student'; ?>
<?php  if ("an International Student" == $this->are_you)  { echo " checked" ;} ?>  onClick="do_ajax_form_funding_i_mob_event_are_you_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_apply_for_loan'][] = 'Yes'; ?>
<?php  if ("Yes" == $this->apply_for_loan)  { echo " checked" ;} ?>  onClick="do_ajax_form_funding_i_mob_event_apply_for_loan_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_apply_for_loan'][] = 'No'; ?>
<?php  if ("No" == $this->apply_for_loan)  { echo " checked" ;} ?>  onClick="do_ajax_form_funding_i_mob_event_apply_for_loan_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_loan_eligibility'][] = 'Yes'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_loan_eligibility'][] = 'No'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_maintenance_loan_eligibility'][] = 'Yes'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['Lookup_maintenance_loan_eligibility'][] = 'No'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_funding_support_line" id="hidden_field_data_funding_support" style="<?php echo $sStyleHidden_funding_support; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_funding_support_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_funding_support_label"><span id="id_label_funding_support"><?php echo $this->nm_new_label['funding_support']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['php_cmp_required']['funding_support']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['php_cmp_required']['funding_support'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_b", "", "Save", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-11", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_funding_i_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_funding_i_mob");
 parent.scAjaxDetailHeight("form_funding_i_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
