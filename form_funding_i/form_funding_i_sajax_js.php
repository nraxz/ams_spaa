  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funding_i" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_funding_i_form();
	}

  // ---------- Validate are_you
  function do_ajax_form_funding_i_validate_are_you()
  {
    var nomeCampo_are_you = "are_you";
    var var_are_you = scAjaxGetFieldRadio(nomeCampo_are_you);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_validate_are_you(var_are_you, var_script_case_init, do_ajax_form_funding_i_validate_are_you_cb);
  } // do_ajax_form_funding_i_validate_are_you

  function do_ajax_form_funding_i_validate_are_you_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_are_you_cb

  // ---------- Validate apply_for_loan
  function do_ajax_form_funding_i_validate_apply_for_loan()
  {
    var nomeCampo_apply_for_loan = "apply_for_loan";
    var var_apply_for_loan = scAjaxGetFieldRadio(nomeCampo_apply_for_loan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_validate_apply_for_loan(var_apply_for_loan, var_script_case_init, do_ajax_form_funding_i_validate_apply_for_loan_cb);
  } // do_ajax_form_funding_i_validate_apply_for_loan

  function do_ajax_form_funding_i_validate_apply_for_loan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_apply_for_loan_cb

  // ---------- Validate t_eligibility
  function do_ajax_form_funding_i_validate_t_eligibility()
  {
  } // do_ajax_form_funding_i_validate_t_eligibility

  function do_ajax_form_funding_i_validate_t_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_t_eligibility_cb

  // ---------- Validate loan_eligibility
  function do_ajax_form_funding_i_validate_loan_eligibility()
  {
    var nomeCampo_loan_eligibility = "loan_eligibility";
    var var_loan_eligibility = scAjaxGetFieldRadio(nomeCampo_loan_eligibility);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_validate_loan_eligibility(var_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_validate_loan_eligibility_cb);
  } // do_ajax_form_funding_i_validate_loan_eligibility

  function do_ajax_form_funding_i_validate_loan_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_loan_eligibility_cb

  // ---------- Validate m_eligibility
  function do_ajax_form_funding_i_validate_m_eligibility()
  {
  } // do_ajax_form_funding_i_validate_m_eligibility

  function do_ajax_form_funding_i_validate_m_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_m_eligibility_cb

  // ---------- Validate maintenance_loan_eligibility
  function do_ajax_form_funding_i_validate_maintenance_loan_eligibility()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_validate_maintenance_loan_eligibility(var_maintenance_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_validate_maintenance_loan_eligibility_cb);
  } // do_ajax_form_funding_i_validate_maintenance_loan_eligibility

  function do_ajax_form_funding_i_validate_maintenance_loan_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_maintenance_loan_eligibility_cb

  // ---------- Validate funding_support
  function do_ajax_form_funding_i_validate_funding_support()
  {
    var nomeCampo_funding_support = "funding_support";
    var var_funding_support = scAjaxGetFieldText(nomeCampo_funding_support);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_validate_funding_support(var_funding_support, var_script_case_init, do_ajax_form_funding_i_validate_funding_support_cb);
  } // do_ajax_form_funding_i_validate_funding_support

  function do_ajax_form_funding_i_validate_funding_support_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_validate_funding_support_cb

  // ---------- Event onclick apply_for_loan
  function do_ajax_form_funding_i_event_apply_for_loan_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_funding_i_event_apply_for_loan_onclick(var_apply_for_loan, var_t_eligibility, var_m_eligibility, var_loan_eligibility, var_maintenance_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_event_apply_for_loan_onclick_cb);
  } // do_ajax_form_funding_i_event_apply_for_loan_onclick

  function do_ajax_form_funding_i_event_apply_for_loan_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apply_for_loan";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funding_i_event_apply_for_loan_onclick_cb_after_alert);
  } // do_ajax_form_funding_i_event_apply_for_loan_onclick_cb
  function do_ajax_form_funding_i_event_apply_for_loan_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funding_i_event_apply_for_loan_onclick_cb_after_alert

  // ---------- Event onclick are_you
  function do_ajax_form_funding_i_event_are_you_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funding_i_event_are_you_onclick(var_are_you, var_apply_for_loan, var_loan_eligibility, var_maintenance_loan_eligibility, var_t_eligibility, var_m_eligibility, var_script_case_init, do_ajax_form_funding_i_event_are_you_onclick_cb);
  } // do_ajax_form_funding_i_event_are_you_onclick

  function do_ajax_form_funding_i_event_are_you_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "are_you";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funding_i_event_are_you_onclick_cb_after_alert);
  } // do_ajax_form_funding_i_event_are_you_onclick_cb
  function do_ajax_form_funding_i_event_are_you_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funding_i_event_are_you_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_funding_i_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funding_i_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_are_you = scAjaxGetFieldRadio("are_you");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funding_i_submit_form(var_are_you, var_apply_for_loan, var_t_eligibility, var_loan_eligibility, var_m_eligibility, var_maintenance_loan_eligibility, var_funding_support, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_funding_i_submit_form_cb);
  } // do_ajax_form_funding_i_submit_form

  function do_ajax_form_funding_i_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_funding_i_submit_form_cb_after_alert);
  } // do_ajax_form_funding_i_submit_form_cb
  function do_ajax_form_funding_i_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_funding_i_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_funding_i_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funding_i_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funding_i_navigate_form_cb);
  } // do_ajax_form_funding_i_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_funding_i_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_funding_i_navigate_form_cb_after_alert);
  } // do_ajax_form_funding_i_navigate_form_cb
  function do_ajax_form_funding_i_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_funding_i_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_funding_i_navigate_form_cb_after_alert
  function sc_hide_form_funding_i_form()
  {
