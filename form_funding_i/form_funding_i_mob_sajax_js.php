  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funding_i_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_funding_i_mob_form();
	}

  // ---------- Validate are_you
  function do_ajax_form_funding_i_mob_validate_are_you()
  {
    var nomeCampo_are_you = "are_you";
    var var_are_you = scAjaxGetFieldRadio(nomeCampo_are_you);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_mob_validate_are_you(var_are_you, var_script_case_init, do_ajax_form_funding_i_mob_validate_are_you_cb);
  } // do_ajax_form_funding_i_mob_validate_are_you

  function do_ajax_form_funding_i_mob_validate_are_you_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_are_you_cb

  // ---------- Validate apply_for_loan
  function do_ajax_form_funding_i_mob_validate_apply_for_loan()
  {
    var nomeCampo_apply_for_loan = "apply_for_loan";
    var var_apply_for_loan = scAjaxGetFieldRadio(nomeCampo_apply_for_loan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_mob_validate_apply_for_loan(var_apply_for_loan, var_script_case_init, do_ajax_form_funding_i_mob_validate_apply_for_loan_cb);
  } // do_ajax_form_funding_i_mob_validate_apply_for_loan

  function do_ajax_form_funding_i_mob_validate_apply_for_loan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apply_for_loan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_apply_for_loan_cb

  // ---------- Validate t_eligibility
  function do_ajax_form_funding_i_mob_validate_t_eligibility()
  {
  } // do_ajax_form_funding_i_mob_validate_t_eligibility

  function do_ajax_form_funding_i_mob_validate_t_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "t_eligibility";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_t_eligibility_cb

  // ---------- Validate loan_eligibility
  function do_ajax_form_funding_i_mob_validate_loan_eligibility()
  {
    var nomeCampo_loan_eligibility = "loan_eligibility";
    var var_loan_eligibility = scAjaxGetFieldRadio(nomeCampo_loan_eligibility);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_mob_validate_loan_eligibility(var_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_mob_validate_loan_eligibility_cb);
  } // do_ajax_form_funding_i_mob_validate_loan_eligibility

  function do_ajax_form_funding_i_mob_validate_loan_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "loan_eligibility";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_loan_eligibility_cb

  // ---------- Validate m_eligibility
  function do_ajax_form_funding_i_mob_validate_m_eligibility()
  {
  } // do_ajax_form_funding_i_mob_validate_m_eligibility

  function do_ajax_form_funding_i_mob_validate_m_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m_eligibility";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_m_eligibility_cb

  // ---------- Validate maintenance_loan_eligibility
  function do_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility()
  {
    var nomeCampo_maintenance_loan_eligibility = "maintenance_loan_eligibility";
    var var_maintenance_loan_eligibility = scAjaxGetFieldRadio(nomeCampo_maintenance_loan_eligibility);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility(var_maintenance_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility_cb);
  } // do_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility

  function do_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "maintenance_loan_eligibility";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_maintenance_loan_eligibility_cb

  // ---------- Validate funding_support
  function do_ajax_form_funding_i_mob_validate_funding_support()
  {
    var nomeCampo_funding_support = "funding_support";
    var var_funding_support = scAjaxGetFieldText(nomeCampo_funding_support);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funding_i_mob_validate_funding_support(var_funding_support, var_script_case_init, do_ajax_form_funding_i_mob_validate_funding_support_cb);
  } // do_ajax_form_funding_i_mob_validate_funding_support

  function do_ajax_form_funding_i_mob_validate_funding_support_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "funding_support";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funding_i_mob_validate_funding_support_cb

  // ---------- Event onclick apply_for_loan
  function do_ajax_form_funding_i_mob_event_apply_for_loan_onclick()
  {
    var var_apply_for_loan = scAjaxGetFieldRadio("apply_for_loan");
    var var_t_eligibility = scAjaxGetFieldHidden("t_eligibility");
    var var_m_eligibility = scAjaxGetFieldHidden("m_eligibility");
    var var_loan_eligibility = scAjaxGetFieldRadio("loan_eligibility");
    var var_maintenance_loan_eligibility = scAjaxGetFieldRadio("maintenance_loan_eligibility");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funding_i_mob_event_apply_for_loan_onclick(var_apply_for_loan, var_t_eligibility, var_m_eligibility, var_loan_eligibility, var_maintenance_loan_eligibility, var_script_case_init, do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb);
  } // do_ajax_form_funding_i_mob_event_apply_for_loan_onclick

  function do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apply_for_loan";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb_after_alert);
  } // do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb
  function do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funding_i_mob_event_apply_for_loan_onclick_cb_after_alert

  // ---------- Event onclick are_you
  function do_ajax_form_funding_i_mob_event_are_you_onclick()
  {
    var var_are_you = scAjaxGetFieldRadio("are_you");
    var var_apply_for_loan = scAjaxGetFieldRadio("apply_for_loan");
    var var_loan_eligibility = scAjaxGetFieldRadio("loan_eligibility");
    var var_maintenance_loan_eligibility = scAjaxGetFieldRadio("maintenance_loan_eligibility");
    var var_t_eligibility = scAjaxGetFieldHidden("t_eligibility");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funding_i_mob_event_are_you_onclick(var_are_you, var_apply_for_loan, var_loan_eligibility, var_maintenance_loan_eligibility, var_t_eligibility, var_m_eligibility, var_script_case_init, do_ajax_form_funding_i_mob_event_are_you_onclick_cb);
  } // do_ajax_form_funding_i_mob_event_are_you_onclick

  function do_ajax_form_funding_i_mob_event_are_you_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "are_you";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funding_i_mob_event_are_you_onclick_cb_after_alert);
  } // do_ajax_form_funding_i_mob_event_are_you_onclick_cb
  function do_ajax_form_funding_i_mob_event_are_you_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_funding_i_mob_event_are_you_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_funding_i_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funding_i_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_are_you = scAjaxGetFieldRadio("are_you");
    ...
    var var_m_eligibility = scAjaxGetFieldHidden("m_eligibility");
    var var_maintenance_loan_eligibility = scAjaxGetFieldRadio("maintenance_loan_eligibility");
    var var_funding_support = scAjaxGetFieldText("funding_support");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funding_i_mob_submit_form(var_are_you, var_apply_for_loan, var_t_eligibility, var_loan_eligibility, var_m_eligibility, var_maintenance_loan_eligibility, var_funding_support, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_funding_i_mob_submit_form_cb);
  } // do_ajax_form_funding_i_mob_submit_form

  function do_ajax_form_funding_i_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("are_you");
      scAjaxHideErrorDisplay("apply_for_loan");
      scAjaxHideErrorDisplay("t_eligibility");
      scAjaxHideErrorDisplay("loan_eligibility");
      scAjaxHideErrorDisplay("m_eligibility");
      scAjaxHideErrorDisplay("maintenance_loan_eligibility");
      scAjaxHideErrorDisplay("funding_support");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_funding_i_mob_submit_form_cb_after_alert);
  } // do_ajax_form_funding_i_mob_submit_form_cb
  function do_ajax_form_funding_i_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_funding_i_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_funding_i_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funding_i_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funding_i_mob_navigate_form_cb);
  } // do_ajax_form_funding_i_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funding_i_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_funding_i_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_funding_i_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_funding_i_mob_navigate_form_cb
  function do_ajax_form_funding_i_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_funding_i_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_funding_i_mob_navigate_form_cb_after_alert
  function sc_hide_form_funding_i_mob_form()
  {
  ...
  ajax_field_list[0] = "are_you";
  ajax_field_list[1] = "apply_for_loan";
  ajax_field_list[2] = "t_eligibility";
  ajax_field_list[3] = "loan_eligibility";
  ajax_field_list[4] = "m_eligibility";
  ajax_field_list[5] = "maintenance_loan_eligibility";
  ajax_field_list[6] = "funding_support";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "are_you": {"label": "Are you ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apply_for_loan": {"label": "Will you apply for a Student Loan? <a href=\"http://www.londonstudiocentre.org/students/funding-scholarships\" target=\"_blank\">More information..</a>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "t_eligibility": {"label": "<hr>Tuition Fee Loan Eligibility", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "loan_eligibility": {"label": "Tuition Fee Loan Eligibility", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "m_eligibility": {"label": " Maintenance Loan Eligibility", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "maintenance_loan_eligibility": {"label": "Maintenance Loan Eligibility", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "funding_support": {"label": "How will you fund the course?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "are_you": new Array(),
    "apply_for_loan": new Array(),
    "t_eligibility": new Array(),
    "loan_eligibility": new Array(),
    "m_eligibility": new Array(),
    "maintenance_loan_eligibility": new Array(),
    "funding_support": new Array()
  };
  ajax_field_mult["are_you"][1] = "are_you";
  ajax_field_mult["apply_for_loan"][1] = "apply_for_loan";
  ajax_field_mult["t_eligibility"][1] = "t_eligibility";
  ajax_field_mult["loan_eligibility"][1] = "loan_eligibility";
  ajax_field_mult["m_eligibility"][1] = "m_eligibility";
  ajax_field_mult["maintenance_loan_eligibility"][1] = "maintenance_loan_eligibility";
  ajax_field_mult["funding_support"][1] = "funding_support";

  var ajax_field_id = {
    "are_you": new Array("hidden_field_label_are_you", "hidden_field_data_are_you"),
    "apply_for_loan": new Array("hidden_field_label_apply_for_loan", "hidden_field_data_apply_for_loan"),
    "t_eligibility": new Array("hidden_field_label_t_eligibility", "hidden_field_data_t_eligibility"),
    "loan_eligibility": new Array("hidden_field_label_loan_eligibility", "hidden_field_data_loan_eligibility"),
    "m_eligibility": new Array("hidden_field_label_m_eligibility", "hidden_field_data_m_eligibility"),
    "maintenance_loan_eligibility": new Array("hidden_field_label_maintenance_loan_eligibility", "hidden_field_data_maintenance_loan_eligibility"),
    "funding_support": new Array("hidden_field_label_funding_support", "hidden_field_data_funding_support")
  };
  ...
  var ajax_read_only = {
    ...
    "apply_for_loan": "off",
    "t_eligibility": "off",
    "loan_eligibility": "off",
    "m_eligibility": "off",
    "maintenance_loan_eligibility": "off",
    "funding_support": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("maintenance_loan_eligibility" == sIndex)
    {
      scAjaxSetFieldRadio(sIndex, aValue, null, 1, null, "", false, true);
      updateHeaderFooter(sIndex, aValue);
