<?php
@session_start() ;
$_SESSION['scriptcase']['applicant_auditions_search']['sc_process_barr'] = true;
require_once('../applicant_auditions_search/index.php');
unset($_SESSION['scriptcase']['applicant_auditions_search']['sc_process_barr']);
$ExportCtrl = new applicant_auditions_search_export_control;
$ExportCtrl->Export_barr();

class applicant_auditions_search_export_control
{
