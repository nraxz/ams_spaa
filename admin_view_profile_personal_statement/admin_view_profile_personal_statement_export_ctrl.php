<?php
@session_start() ;
$_SESSION['scriptcase']['admin_view_profile_personal_statement']['sc_process_barr'] = true;
require_once('../admin_view_profile_personal_statement/index.php');
unset($_SESSION['scriptcase']['admin_view_profile_personal_statement']['sc_process_barr']);
$ExportCtrl = new admin_view_profile_personal_statement_export_control;
$ExportCtrl->Export_barr();

class admin_view_profile_personal_statement_export_control
{
...
<HEAD>
 <TITLE>Personal Statement :: Excel</TITLE>
