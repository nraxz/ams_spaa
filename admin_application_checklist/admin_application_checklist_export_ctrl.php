<?php
@session_start() ;
$_SESSION['scriptcase']['admin_application_checklist']['sc_process_barr'] = true;
require_once('../admin_application_checklist/index.php');
unset($_SESSION['scriptcase']['admin_application_checklist']['sc_process_barr']);
$ExportCtrl = new admin_application_checklist_export_control;
$ExportCtrl->Export_barr();

class admin_application_checklist_export_control
{
