<?php
@session_start() ;
$_SESSION['scriptcase']['grid_additional_information']['sc_process_barr'] = true;
require_once('../grid_additional_information/index.php');
unset($_SESSION['scriptcase']['grid_additional_information']['sc_process_barr']);
$ExportCtrl = new grid_additional_information_export_control;
$ExportCtrl->Export_barr();

class grid_additional_information_export_control
{
