...
$old_error_handler = set_error_handler("admin_application_payment_verify_scriptcase_error_handler");

function admin_application_payment_verify_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['admin_application_payment_verify']['contr_erro']) && $_SESSION['scriptcase']['admin_application_payment_verify']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_admin_application_payment_verify->contr_admin_application_payment_verify->Apl_com_erro = true;
            if ($inicial_admin_application_payment_verify->contr_admin_application_payment_verify->NM_ajax_flag)
            {
                $inicial_admin_application_payment_verify->contr_admin_application_payment_verify->NM_ajax_info['errList']['geral_admin_application_payment_verify'][] = $msg;
                return;
            }
            admin_application_payment_verify_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function admin_application_payment_verify_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['admin_application_payment_verify'])  && '' != $_SESSION['scriptcase']['error_icon']['admin_application_payment_verify'])  ? $_SESSION['scriptcase']['error_icon']['admin_application_payment_verify']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['admin_application_payment_verify']) && '' != $_SESSION['scriptcase']['error_span_title']['admin_application_payment_verify']) ? $_SESSION['scriptcase']['error_span_title']['admin_application_payment_verify'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['admin_application_payment_verify']) && '' != $_SESSION['scriptcase']['error_icon_title']['admin_application_payment_verify']) ? $_SESSION['scriptcase']['error_icon_title']['admin_application_payment_verify'] : '';
?>
