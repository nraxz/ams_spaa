  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_admin_form_marking_categories_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_admin_form_marking_categories_mob_form();
	}

  // ---------- Validate id
  function do_ajax_admin_form_marking_categories_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_marking_categories_mob_validate_id(var_id, var_script_case_init, do_ajax_admin_form_marking_categories_mob_validate_id_cb);
  } // do_ajax_admin_form_marking_categories_mob_validate_id

  function do_ajax_admin_form_marking_categories_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_marking_categories_mob_validate_id_cb

  // ---------- Validate category
  function do_ajax_admin_form_marking_categories_mob_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldText(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_marking_categories_mob_validate_category(var_category, var_script_case_init, do_ajax_admin_form_marking_categories_mob_validate_category_cb);
  } // do_ajax_admin_form_marking_categories_mob_validate_category

  function do_ajax_admin_form_marking_categories_mob_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_marking_categories_mob_validate_category_cb

  // ---------- Validate short
  function do_ajax_admin_form_marking_categories_mob_validate_short()
  {
    var nomeCampo_short = "short";
    var var_short = scAjaxGetFieldText(nomeCampo_short);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_marking_categories_mob_validate_short(var_short, var_script_case_init, do_ajax_admin_form_marking_categories_mob_validate_short_cb);
  } // do_ajax_admin_form_marking_categories_mob_validate_short

  function do_ajax_admin_form_marking_categories_mob_validate_short_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "short";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_marking_categories_mob_validate_short_cb

  // ---------- Validate type_of_audition
  function do_ajax_admin_form_marking_categories_mob_validate_type_of_audition()
  {
    var nomeCampo_type_of_audition = "type_of_audition";
    var var_type_of_audition = scAjaxGetFieldSelect(nomeCampo_type_of_audition);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_marking_categories_mob_validate_type_of_audition(var_type_of_audition, var_script_case_init, do_ajax_admin_form_marking_categories_mob_validate_type_of_audition_cb);
  } // do_ajax_admin_form_marking_categories_mob_validate_type_of_audition

  function do_ajax_admin_form_marking_categories_mob_validate_type_of_audition_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_marking_categories_mob_validate_type_of_audition_cb

  // ---------- Validate active
  function do_ajax_admin_form_marking_categories_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_admin_form_marking_categories_mob_validate_active(var_active, var_script_case_init, do_ajax_admin_form_marking_categories_mob_validate_active_cb);
  } // do_ajax_admin_form_marking_categories_mob_validate_active

  function do_ajax_admin_form_marking_categories_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_admin_form_marking_categories_mob_validate_active_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_admin_form_marking_categories_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_admin_form_marking_categories_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_admin_form_marking_categories_mob_submit_form(var_id, var_category, var_short, var_type_of_audition, var_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_admin_form_marking_categories_mob_submit_form_cb);
  } // do_ajax_admin_form_marking_categories_mob_submit_form

  function do_ajax_admin_form_marking_categories_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_admin_form_marking_categories_mob_submit_form_cb_after_alert);
  } // do_ajax_admin_form_marking_categories_mob_submit_form_cb
  function do_ajax_admin_form_marking_categories_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_admin_form_marking_categories_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_admin_form_marking_categories_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_admin_form_marking_categories_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_admin_form_marking_categories_mob_navigate_form_cb);
  } // do_ajax_admin_form_marking_categories_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['admin_form_marking_categories_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_admin_form_marking_categories_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_admin_form_marking_categories_mob_navigate_form_cb_after_alert);
  } // do_ajax_admin_form_marking_categories_mob_navigate_form_cb
  function do_ajax_admin_form_marking_categories_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_admin_form_marking_categories_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_admin_form_marking_categories_mob_navigate_form_cb_after_alert
  function sc_hide_admin_form_marking_categories_mob_form()
  {
