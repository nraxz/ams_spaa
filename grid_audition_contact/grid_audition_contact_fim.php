...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_audition_contact"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_audition_contact"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_audition_contact</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_audition_contact']['embutida_filho'] as $ind => $sc_init)
          {
