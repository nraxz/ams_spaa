<?php
@session_start() ;
$_SESSION['scriptcase']['grid_audition_contact']['sc_process_barr'] = true;
require_once('../grid_audition_contact/index.php');
unset($_SESSION['scriptcase']['grid_audition_contact']['sc_process_barr']);
$ExportCtrl = new grid_audition_contact_export_control;
$ExportCtrl->Export_barr();

class grid_audition_contact_export_control
{
