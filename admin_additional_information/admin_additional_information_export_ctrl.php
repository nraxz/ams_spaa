<?php
@session_start() ;
$_SESSION['scriptcase']['admin_additional_information']['sc_process_barr'] = true;
require_once('../admin_additional_information/index.php');
unset($_SESSION['scriptcase']['admin_additional_information']['sc_process_barr']);
$ExportCtrl = new admin_additional_information_export_control;
$ExportCtrl->Export_barr();

class admin_additional_information_export_control
{
...
<HEAD>
 <TITLE>Additional Information :: Excel</TITLE>
