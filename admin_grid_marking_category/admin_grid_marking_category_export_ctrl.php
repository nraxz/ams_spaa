<?php
@session_start() ;
$_SESSION['scriptcase']['admin_grid_marking_category']['sc_process_barr'] = true;
require_once('../admin_grid_marking_category/index.php');
unset($_SESSION['scriptcase']['admin_grid_marking_category']['sc_process_barr']);
$ExportCtrl = new admin_grid_marking_category_export_control;
$ExportCtrl->Export_barr();

class admin_grid_marking_category_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> category :: Excel</TITLE>
