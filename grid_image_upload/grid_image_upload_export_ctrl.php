<?php
@session_start() ;
$_SESSION['scriptcase']['grid_image_upload']['sc_process_barr'] = true;
require_once('../grid_image_upload/index.php');
unset($_SESSION['scriptcase']['grid_image_upload']['sc_process_barr']);
$ExportCtrl = new grid_image_upload_export_control;
$ExportCtrl->Export_barr();

class grid_image_upload_export_control
{
