...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_image_upload"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____grid_image_upload"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_image_upload']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_image_upload']['opc_psq']) || $fecha_janela)
   {
       ...
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_image_upload']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_image_upload']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_image_upload']['embutida_filho'] as $ind => $sc_init)
          {
