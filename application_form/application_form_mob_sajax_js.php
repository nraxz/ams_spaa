  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_application_form_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_application_form_mob_form();
	}

  // ---------- Validate venue_id
  function do_ajax_application_form_mob_validate_venue_id()
  {
    var nomeCampo_venue_id = "venue_id";
    var var_venue_id = scAjaxGetFieldSelect(nomeCampo_venue_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_venue_id(var_venue_id, var_script_case_init, do_ajax_application_form_mob_validate_venue_id_cb);
  } // do_ajax_application_form_mob_validate_venue_id

  function do_ajax_application_form_mob_validate_venue_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_venue_id_cb

  // ---------- Validate audition_id
  function do_ajax_application_form_mob_validate_audition_id()
  {
    var nomeCampo_audition_id = "audition_id";
    var var_audition_id = scAjaxGetFieldSelect(nomeCampo_audition_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_audition_id(var_audition_id, var_script_case_init, do_ajax_application_form_mob_validate_audition_id_cb);
  } // do_ajax_application_form_mob_validate_audition_id

  function do_ajax_application_form_mob_validate_audition_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_audition_id_cb

  // ---------- Validate course_id
  function do_ajax_application_form_mob_validate_course_id()
  {
    var nomeCampo_course_id = "course_id";
    var var_course_id = scAjaxGetFieldSelect(nomeCampo_course_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_course_id(var_course_id, var_script_case_init, do_ajax_application_form_mob_validate_course_id_cb);
  } // do_ajax_application_form_mob_validate_course_id

  function do_ajax_application_form_mob_validate_course_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_course_id_cb

  // ---------- Validate firstname
  function do_ajax_application_form_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_application_form_mob_validate_firstname_cb);
  } // do_ajax_application_form_mob_validate_firstname

  function do_ajax_application_form_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_application_form_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_application_form_mob_validate_lastname_cb);
  } // do_ajax_application_form_mob_validate_lastname

  function do_ajax_application_form_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_lastname_cb

  // ---------- Validate nationality
  function do_ajax_application_form_mob_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldSelect(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_nationality(var_nationality, var_script_case_init, do_ajax_application_form_mob_validate_nationality_cb);
  } // do_ajax_application_form_mob_validate_nationality

  function do_ajax_application_form_mob_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_nationality_cb

  // ---------- Validate dateofbirth
  function do_ajax_application_form_mob_validate_dateofbirth()
  {
    ...
    setTimeout(function() {
      ...
      var var_dateofbirth_mes = scAjaxGetFieldText(nomeCampo_dateofbirth_mes);
      var var_dateofbirth_ano = scAjaxGetFieldText(nomeCampo_dateofbirth_ano);
      x_ajax_application_form_mob_validate_dateofbirth(var_dateofbirth, var_dateofbirth_dia, var_dateofbirth_mes, var_dateofbirth_ano, var_script_case_init, do_ajax_application_form_mob_validate_dateofbirth_cb);
    }, 200);
  } // do_ajax_application_form_mob_validate_dateofbirth

  function do_ajax_application_form_mob_validate_dateofbirth_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_dateofbirth_cb

  // ---------- Validate gender
  function do_ajax_application_form_mob_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldRadio(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_gender(var_gender, var_script_case_init, do_ajax_application_form_mob_validate_gender_cb);
  } // do_ajax_application_form_mob_validate_gender

  function do_ajax_application_form_mob_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_gender_cb

  // ---------- Validate resident
  function do_ajax_application_form_mob_validate_resident()
  {
    var nomeCampo_resident = "resident";
    var var_resident = scAjaxGetFieldRadio(nomeCampo_resident);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_resident(var_resident, var_script_case_init, do_ajax_application_form_mob_validate_resident_cb);
  } // do_ajax_application_form_mob_validate_resident

  function do_ajax_application_form_mob_validate_resident_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_resident_cb

  // ---------- Validate email
  function do_ajax_application_form_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_email(var_email, var_script_case_init, do_ajax_application_form_mob_validate_email_cb);
  } // do_ajax_application_form_mob_validate_email

  function do_ajax_application_form_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_email_cb

  // ---------- Validate password
  function do_ajax_application_form_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_password(var_password, var_script_case_init, do_ajax_application_form_mob_validate_password_cb);
  } // do_ajax_application_form_mob_validate_password

  function do_ajax_application_form_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_password_cb

  // ---------- Validate confirm_password
  function do_ajax_application_form_mob_validate_confirm_password()
  {
    var nomeCampo_confirm_password = "confirm_password";
    var var_confirm_password = scAjaxGetFieldText(nomeCampo_confirm_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_confirm_password(var_confirm_password, var_script_case_init, do_ajax_application_form_mob_validate_confirm_password_cb);
  } // do_ajax_application_form_mob_validate_confirm_password

  function do_ajax_application_form_mob_validate_confirm_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_confirm_password_cb

  // ---------- Validate accept_tnc
  function do_ajax_application_form_mob_validate_accept_tnc()
  {
    var nomeCampo_accept_tnc = "accept_tnc";
    var var_accept_tnc = scAjaxGetFieldCheckbox(nomeCampo_accept_tnc, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_application_form_mob_validate_accept_tnc(var_accept_tnc, var_script_case_init, do_ajax_application_form_mob_validate_accept_tnc_cb);
  } // do_ajax_application_form_mob_validate_accept_tnc

  function do_ajax_application_form_mob_validate_accept_tnc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_application_form_mob_validate_accept_tnc_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_application_form_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_application_form_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_application_form_mob_submit_form(var_venue_id, var_audition_id, var_course_id, var_firstname, var_lastname, var_nationality, var_dateofbirth_mes, var_dateofbirth_dia, var_dateofbirth_ano, var_gender, var_resident, var_email, var_password, var_confirm_password, var_accept_tnc, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_application_form_mob_submit_form_cb);
  } // do_ajax_application_form_mob_submit_form

  function do_ajax_application_form_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_application_form_mob_submit_form_cb_after_alert);
  } // do_ajax_application_form_mob_submit_form_cb
  function do_ajax_application_form_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_application_form_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_application_form_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_application_form_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_application_form_mob_navigate_form_cb);
  } // do_ajax_application_form_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_application_form_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_application_form_mob_navigate_form_cb_after_alert);
  } // do_ajax_application_form_mob_navigate_form_cb
  function do_ajax_application_form_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_application_form_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_application_form_mob_navigate_form_cb_after_alert
  function sc_hide_application_form_mob_form()
  {
