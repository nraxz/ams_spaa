...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("application_form_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('application_form_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("application_form_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['application_form'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['application_form'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_venue_id_line" id="hidden_field_data_venue_id" style="<?php echo $sStyleHidden_venue_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_venue_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_venue_id_label"><span id="id_label_venue_id"><?php echo $this->nm_new_label['venue_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['venue_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['venue_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_course_id_line" id="hidden_field_data_course_id" style="<?php echo $sStyleHidden_course_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_course_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_course_id_label"><span id="id_label_course_id"><?php echo $this->nm_new_label['course_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['course_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['course_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_firstname_line" id="hidden_field_data_firstname" style="<?php echo $sStyleHidden_firstname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_firstname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_firstname_label"><span id="id_label_firstname"><?php echo $this->nm_new_label['firstname']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['firstname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['firstname'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nationality_line" id="hidden_field_data_nationality" style="<?php echo $sStyleHidden_nationality; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nationality_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nationality_label"><span id="id_label_nationality"><?php echo $this->nm_new_label['nationality']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['nationality']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['nationality'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dateofbirth_line" id="hidden_field_data_dateofbirth" style="<?php echo $sStyleHidden_dateofbirth; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dateofbirth_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dateofbirth_label"><span id="id_label_dateofbirth"><?php echo $this->nm_new_label['dateofbirth']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['dateofbirth']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['dateofbirth'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?><span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gender_line" id="hidden_field_data_gender" style="<?php echo $sStyleHidden_gender; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gender_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gender_label"><span id="id_label_gender"><?php echo $this->nm_new_label['gender']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['gender']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['gender'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_email_line" id="hidden_field_data_email" style="<?php echo $sStyleHidden_email; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_email_label"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?><span class="scFormPopupBubble" style="display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirm_password_line" id="hidden_field_data_confirm_password" style="<?php echo $sStyleHidden_confirm_password; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_confirm_password_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_confirm_password_label"><span id="id_label_confirm_password"><?php echo $this->nm_new_label['confirm_password']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['confirm_password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['confirm_password'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_accept_tnc" style="<?php echo $sStyleHidden_accept_tnc; ?>">
   <?php
...
<?php } else { $sc_hidden_no++; ?>
<table style="border-width: 0px; border-collapse: collapse"><tr><td style="padding: 0px; spacing: 0px; <?php echo $sStyleHidden_accept_tnc?>"><?php 
...
?> 
   ...
   <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_accept_tnc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_accept_tnc_label"><span id="id_label_accept_tnc"><?php echo $this->nm_new_label['accept_tnc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['accept_tnc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['php_cmp_required']['accept_tnc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span>&nbsp;
...
<?php $tempOptionId = "id-opt-accept_tnc" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['Lookup_accept_tnc'][] = 'Yes'; ?>
<?php  if (in_array("Yes", $this->accept_tnc_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">I agree</label> </div>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_accept_tnc_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_accept_tnc_text"></span></td></tr></table></td></tr></table>
   </td></tr></table><?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_b", "", "Submit", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-5", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("application_form");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("application_form");
 parent.scAjaxDetailHeight("application_form", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['application_form']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
