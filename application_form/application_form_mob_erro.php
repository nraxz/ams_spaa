...
$old_error_handler = set_error_handler("application_form_mob_scriptcase_error_handler");

function application_form_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['application_form_mob']['contr_erro']) && $_SESSION['scriptcase']['application_form_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_application_form_mob->contr_application_form_mob->Apl_com_erro = true;
            if ($inicial_application_form_mob->contr_application_form_mob->NM_ajax_flag)
            {
                $inicial_application_form_mob->contr_application_form_mob->NM_ajax_info['errList']['geral_application_form_mob'][] = $msg;
                return;
            }
            application_form_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function application_form_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['application_form_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['application_form_mob'])  ? $_SESSION['scriptcase']['error_icon']['application_form_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['application_form_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['application_form_mob']) ? $_SESSION['scriptcase']['error_span_title']['application_form_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['application_form_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['application_form_mob']) ? $_SESSION['scriptcase']['error_icon_title']['application_form_mob'] : '';
?>
