<?php
//
class application_form_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['application_form_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['application_form_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['application_form_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['application_form_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['application_form_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['application_form_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->vid)) 
          {
              $_SESSION['vid'] = $this->vid;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['application_form_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['application_form_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['application_form_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new application_form_mob_ini(); 
          $this->Ini->init();
...
$_SESSION['scriptcase']['application_form_mob']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['application_form_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['application_form_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['application_form_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_form_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_form_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('application_form_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['application_form_mob']['label'] = "Basic Information";
      ...
      $_SESSION['scriptcase']['error_icon']['application_form_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['application_form_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['application_form_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['application_form_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['application_form_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("application_form_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'application_form/application_form_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'application_form_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'application_form_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'application_form_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'application_form/application_form_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "application_form_mob_erro.class.php"); 
      }
      $this->Erro      = new application_form_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao']))
         { 
             if ($this->login != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['application_form_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      { 
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select']['venue_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->venue_id = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select']['venue_id'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select']['audition_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->audition_id = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select']['audition_id'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['recarga'] = $this->nmgp_opcao;
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'application_form_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'application_form_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'application_form_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_application_form_mob']) || !is_array($this->NM_ajax_info['errList']['geral_application_form_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_application_form_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_application_form_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if ($this->password  !== $this->confirm_password )
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_application_form_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['application_form_mob']['contr_erro'] = 'off'; 
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->venue_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['venue_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['venue_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->venue_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_venue_id']) && !in_array($this->venue_id, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_venue_id']))
          {
              $hasError = true;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->audition_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['audition_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['audition_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->audition_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_audition_id']) && !in_array($this->audition_id, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_audition_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['audition_id']))
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->course_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['course_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['course_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->course_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_course_id']) && !in_array($this->course_id, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_course_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['course_id']))
    ...
    function ValidateField_firstname(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['firstname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['firstname'] == "on")) 
      { 
          if ($this->firstname == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_lastname(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['lastname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['lastname'] == "on")) 
      { 
          if ($this->lastname == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nationality(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nationality == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['nationality']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['nationality'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->nationality) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_nationality']) && !in_array($this->nationality, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_nationality']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['nationality']))
    ...
    function ValidateField_dateofbirth(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['dateofbirth']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['dateofbirth'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_gender(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['gender']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['gender'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Gender" ; 
      ...
      if ($this->gender != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_gender']) && !in_array($this->gender, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_gender']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['gender']))
    ...
    function ValidateField_resident(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['resident']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['resident'] == "on")
        { 
          $hasError = true;
      ...
      if ($this->resident != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_resident']) && !in_array($this->resident, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_resident']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['resident']))
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_email' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['email'] == "on"))
      { 
          if ($this->email == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_password(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_password' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['password'] == "on"))
      { 
          if ($this->password == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_confirm_password(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_confirm_password' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['confirm_password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['confirm_password'] == "on"))
      { 
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['accept_tnc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['php_cmp_required']['accept_tnc'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "T&C" ; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['login']['keyVal'] = application_form_mob_pack_protect_string($this->nmgp_dados_form['login']);
          }
   } // ajax_return_values
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(application_form_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', application_form_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['venue_id']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['audition_id']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(application_form_mob_pack_protect_string('') => application_form_mob_pack_protect_string(' '));
$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_course_id'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['course_id']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_nationality'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nationality']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['gender']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['resident']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(application_form_mob_pack_protect_string('Yes') => application_form_mob_pack_protect_string("I agree"));
$_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['Lookup_accept_tnc'][] = 'Yes';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['accept_tnc']['valList'][$i] = application_form_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_login($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = '';
...
$_SESSION['scriptcase']['application_form_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->gender = $this->gender_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['application_form_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['parms'] = "login?#?$this->login?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("application_form_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_application_form_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['total'] = $qt_geral_reg_application_form_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          application_form_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "application_form_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "application_form_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['application_form_mob']['retorno_edit'] = "";
   }
