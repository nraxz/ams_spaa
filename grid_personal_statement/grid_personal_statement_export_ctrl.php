<?php
@session_start() ;
$_SESSION['scriptcase']['grid_personal_statement']['sc_process_barr'] = true;
require_once('../grid_personal_statement/index.php');
unset($_SESSION['scriptcase']['grid_personal_statement']['sc_process_barr']);
$ExportCtrl = new grid_personal_statement_export_control;
$ExportCtrl->Export_barr();

class grid_personal_statement_export_control
{
