<?php
@session_start() ;
$_SESSION['scriptcase']['applicant_information_grid']['sc_process_barr'] = true;
require_once('../applicant_information_grid/index.php');
unset($_SESSION['scriptcase']['applicant_information_grid']['sc_process_barr']);
$ExportCtrl = new applicant_information_grid_export_control;
$ExportCtrl->Export_barr();

class applicant_information_grid_export_control
{
