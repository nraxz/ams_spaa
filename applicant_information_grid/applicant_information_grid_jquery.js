...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_applicant_information_grid').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_applicant_information_grid').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_applicant_information_grid').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_applicant_information_grid').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_applicant_information_grid').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicant_information_grid').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicant_information_grid').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicant_information_grid').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_applicant_information_grid').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicant_information_grid').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicant_information_grid').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicant_information_grid').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
