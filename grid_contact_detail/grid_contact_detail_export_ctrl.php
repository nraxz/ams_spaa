<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contact_detail']['sc_process_barr'] = true;
require_once('../grid_contact_detail/index.php');
unset($_SESSION['scriptcase']['grid_contact_detail']['sc_process_barr']);
$ExportCtrl = new grid_contact_detail_export_control;
$ExportCtrl->Export_barr();

class grid_contact_detail_export_control
{
