...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____applicant_upcomming_auditions"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____applicant_upcomming_auditions"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>applicant_upcomming_auditions</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['embutida_filho'] as $ind => $sc_init)
          {
