 ...
 */
    ...
    $SC_apl_proc = "applicant_upcomming_auditions";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['applicant_upcomming_auditions']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['applicant_upcomming_auditions']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['applicant_upcomming_auditions']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['applicant_upcomming_auditions']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['applicant_upcomming_auditions']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
