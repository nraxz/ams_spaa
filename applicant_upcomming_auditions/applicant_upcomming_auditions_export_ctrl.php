<?php
@session_start() ;
$_SESSION['scriptcase']['applicant_upcomming_auditions']['sc_process_barr'] = true;
require_once('../applicant_upcomming_auditions/index.php');
unset($_SESSION['scriptcase']['applicant_upcomming_auditions']['sc_process_barr']);
$ExportCtrl = new applicant_upcomming_auditions_export_control;
$ExportCtrl->Export_barr();

class applicant_upcomming_auditions_export_control
{
...
<HEAD>
 <TITLE>SPAA upcoming auditions :: Excel</TITLE>
