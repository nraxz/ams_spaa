  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_upload_image" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_upload_image_form();
	}

  // ---------- Validate lbl
  function do_ajax_form_upload_image_validate_lbl()
  {
  } // do_ajax_form_upload_image_validate_lbl

  function do_ajax_form_upload_image_validate_lbl_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_validate_lbl_cb

  // ---------- Validate image_headshot
  function do_ajax_form_upload_image_validate_image_headshot()
  {
    var nomeCampo_image_headshot = "image_headshot";
    var var_image_headshot = scAjaxGetFieldText(nomeCampo_image_headshot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_upload_image_validate_image_headshot(var_image_headshot, var_script_case_init, do_ajax_form_upload_image_validate_image_headshot_cb);
  } // do_ajax_form_upload_image_validate_image_headshot

  function do_ajax_form_upload_image_validate_image_headshot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_validate_image_headshot_cb

  // ---------- Validate full_length
  function do_ajax_form_upload_image_validate_full_length()
  {
    var nomeCampo_full_length = "full_length";
    var var_full_length = scAjaxGetFieldText(nomeCampo_full_length);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_upload_image_validate_full_length(var_full_length, var_script_case_init, do_ajax_form_upload_image_validate_full_length_cb);
  } // do_ajax_form_upload_image_validate_full_length

  function do_ajax_form_upload_image_validate_full_length_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_validate_full_length_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_upload_image_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_upload_image_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_upload_image_submit_form(var_lbl, var_image_headshot, var_full_length, var_image_headshot_ul_name, var_image_headshot_ul_type, var_full_length_ul_name, var_full_length_ul_type, var_image_headshot_salva, var_image_headshot_limpa, var_full_length_salva, var_full_length_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_upload_image_submit_form_cb);
  } // do_ajax_form_upload_image_submit_form

  function do_ajax_form_upload_image_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_upload_image_submit_form_cb_after_alert);
  } // do_ajax_form_upload_image_submit_form_cb
  function do_ajax_form_upload_image_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_upload_image_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_upload_image_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_upload_image_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_upload_image_navigate_form_cb);
  } // do_ajax_form_upload_image_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_upload_image']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_upload_image_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_upload_image_navigate_form_cb_after_alert);
  } // do_ajax_form_upload_image_navigate_form_cb
  function do_ajax_form_upload_image_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_upload_image_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_upload_image_navigate_form_cb_after_alert
  function sc_hide_form_upload_image_form()
  {
