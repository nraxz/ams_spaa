...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['sc_redir_atualiz']);
   ...
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_upload_image']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_upload_image']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_upload_image']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal']);
               }
               else
               {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_upload_image']['db_changed'])
           {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['form_upload_image']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
?>
   ...
   { 
       parent.del_aba_td('form_upload_image');
   } 
   else 
   { 
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_upload_image']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['form_upload_image']['embutida_filho'] as $ind => $sc_init)
          {
