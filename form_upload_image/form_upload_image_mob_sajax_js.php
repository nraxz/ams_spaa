  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_upload_image_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_upload_image_mob_form();
	}

  // ---------- Validate lbl
  function do_ajax_form_upload_image_mob_validate_lbl()
  {
  } // do_ajax_form_upload_image_mob_validate_lbl

  function do_ajax_form_upload_image_mob_validate_lbl_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_mob_validate_lbl_cb

  // ---------- Validate image_headshot
  function do_ajax_form_upload_image_mob_validate_image_headshot()
  {
    var nomeCampo_image_headshot = "image_headshot";
    var var_image_headshot = scAjaxGetFieldText(nomeCampo_image_headshot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_upload_image_mob_validate_image_headshot(var_image_headshot, var_script_case_init, do_ajax_form_upload_image_mob_validate_image_headshot_cb);
  } // do_ajax_form_upload_image_mob_validate_image_headshot

  function do_ajax_form_upload_image_mob_validate_image_headshot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "image_headshot";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_mob_validate_image_headshot_cb

  // ---------- Validate full_length
  function do_ajax_form_upload_image_mob_validate_full_length()
  {
    var nomeCampo_full_length = "full_length";
    var var_full_length = scAjaxGetFieldText(nomeCampo_full_length);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_upload_image_mob_validate_full_length(var_full_length, var_script_case_init, do_ajax_form_upload_image_mob_validate_full_length_cb);
  } // do_ajax_form_upload_image_mob_validate_full_length

  function do_ajax_form_upload_image_mob_validate_full_length_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "full_length";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_upload_image_mob_validate_full_length_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_upload_image_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_upload_image_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lbl = scAjaxGetFieldHidden("lbl");
    var var_image_headshot = scAjaxGetFieldText("image_headshot");
    var var_full_length = scAjaxGetFieldText("full_length");
    var var_login = scAjaxGetFieldText("login");
    var var_image_headshot_ul_name = scAjaxSpecCharProtect(document.F1.image_headshot_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_image_headshot_ul_type = document.F1.image_headshot_ul_type.value;
    var var_full_length_ul_name = scAjaxSpecCharProtect(document.F1.full_length_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_full_length_ul_type = document.F1.full_length_ul_type.value;
    var var_image_headshot_salva = scAjaxSpecCharProtect(document.F1.image_headshot_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_image_headshot_limpa = document.F1.image_headshot_limpa.checked ? "S" : "N";
    var var_full_length_salva = scAjaxSpecCharProtect(document.F1.full_length_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_full_length_limpa = document.F1.full_length_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_upload_image_mob_submit_form(var_lbl, var_image_headshot, var_full_length, var_login, var_image_headshot_ul_name, var_image_headshot_ul_type, var_full_length_ul_name, var_full_length_ul_type, var_image_headshot_salva, var_image_headshot_limpa, var_full_length_salva, var_full_length_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_upload_image_mob_submit_form_cb);
  } // do_ajax_form_upload_image_mob_submit_form

  function do_ajax_form_upload_image_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("lbl");
      scAjaxHideErrorDisplay("image_headshot");
      scAjaxHideErrorDisplay("full_length");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.image_headshot_limpa && document.F1.image_headshot_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("image_headshot", oImgTemp, "", "", "", "N");
      }
      if (document.F1.full_length_limpa && document.F1.full_length_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("full_length", oImgTemp, "", "", "", "N");
      }
    document.F1.image_headshot_ul_name.value = '';
    document.F1.image_headshot_ul_type.value = '';
    document.F1.full_length_ul_name.value = '';
    document.F1.full_length_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_upload_image_mob_submit_form_cb_after_alert);
  } // do_ajax_form_upload_image_mob_submit_form_cb
  function do_ajax_form_upload_image_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_upload_image_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_upload_image_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_upload_image_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_upload_image_mob_navigate_form_cb);
  } // do_ajax_form_upload_image_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_upload_image_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_upload_image_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_upload_image_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_upload_image_mob_navigate_form_cb
  function do_ajax_form_upload_image_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_upload_image_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_upload_image_mob_navigate_form_cb_after_alert
  function sc_hide_form_upload_image_mob_form()
  {
  ...
  ajax_field_list[0] = "lbl";
  ajax_field_list[1] = "image_headshot";
  ajax_field_list[2] = "full_length";
  ...
  var ajax_error_list = {
    "lbl": {"label": "Label", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "image_headshot": {"label": "Headshot", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "full_length": {"label": "Full Length", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "lbl": new Array(),
    "image_headshot": new Array(),
    "full_length": new Array()
  };
  ajax_field_mult["lbl"][1] = "lbl";
  ajax_field_mult["image_headshot"][1] = "image_headshot";
  ajax_field_mult["full_length"][1] = "full_length";

  var ajax_field_id = {
    "lbl": new Array("hidden_field_label_lbl", "hidden_field_data_lbl"),
    "image_headshot": new Array("hidden_field_label_image_headshot", "hidden_field_data_image_headshot"),
    "full_length": new Array("hidden_field_label_full_length", "hidden_field_data_full_length")
  };
