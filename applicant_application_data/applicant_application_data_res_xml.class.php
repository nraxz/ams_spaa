...
class applicant_application_data_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xml()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arq_zip       = $this->Arquivo . "_applicant_application_data.zip";
      $this->Arquivo      .= "_applicant_application_data";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_grid']))
      {
      ...
      $this->Arquivo      .= ".xml";
      $this->Tit_doc       = "applicant_application_data.xml";
      $this->Tit_zip       = "applicant_application_data.zip";
      $this->Grava_view   = false;
      if (strtolower($_SESSION['scriptcase']['charset']) != strtolower($_SESSION['scriptcase']['charset_html']))
      {
          $this->Grava_view = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_return']);
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<applicant_application_data>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<applicant_application_data>\r\n");
          }
      }
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_file']['xml'] = $this->Xml_f;
          if ($this->Grava_view)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_res_file']['view'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo_view;
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<applicant_application_data";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['applicant_application_data']['xml_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
