...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_applicant_application_data').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_applicant_application_data').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_applicant_application_data').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_applicant_application_data').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_applicant_application_data').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicant_application_data').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicant_application_data').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicant_application_data').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_applicant_application_data').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_applicant_application_data').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_applicant_application_data').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_applicant_application_data').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
