<?php
@session_start() ;
$_SESSION['scriptcase']['applicant_application_data']['sc_process_barr'] = true;
require_once('../applicant_application_data/index.php');
unset($_SESSION['scriptcase']['applicant_application_data']['sc_process_barr']);
$ExportCtrl = new applicant_application_data_export_control;
$ExportCtrl->Export_barr();

class applicant_application_data_export_control
{
