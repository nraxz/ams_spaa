<?php
@session_start() ;
$_SESSION['scriptcase']['grid_audition_detail']['sc_process_barr'] = true;
require_once('../grid_audition_detail/index.php');
unset($_SESSION['scriptcase']['grid_audition_detail']['sc_process_barr']);
$ExportCtrl = new grid_audition_detail_export_control;
$ExportCtrl->Export_barr();

class grid_audition_detail_export_control
{
