  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_academic_i" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_academic_i_form();
	}

  // ---------- Validate level
  function do_ajax_form_academic_i_validate_level()
  {
    var nomeCampo_level = "level";
    var var_level = scAjaxGetFieldSelect(nomeCampo_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_validate_level(var_level, var_script_case_init, do_ajax_form_academic_i_validate_level_cb);
  } // do_ajax_form_academic_i_validate_level

  function do_ajax_form_academic_i_validate_level_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_validate_level_cb

  // ---------- Validate institution_name
  function do_ajax_form_academic_i_validate_institution_name()
  {
    var nomeCampo_institution_name = "institution_name";
    var var_institution_name = scAjaxGetFieldText(nomeCampo_institution_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_validate_institution_name(var_institution_name, var_script_case_init, do_ajax_form_academic_i_validate_institution_name_cb);
  } // do_ajax_form_academic_i_validate_institution_name

  function do_ajax_form_academic_i_validate_institution_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_validate_institution_name_cb

  // ---------- Validate address
  function do_ajax_form_academic_i_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_validate_address(var_address, var_script_case_init, do_ajax_form_academic_i_validate_address_cb);
  } // do_ajax_form_academic_i_validate_address

  function do_ajax_form_academic_i_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_validate_address_cb

  // ---------- Validate date_start
  function do_ajax_form_academic_i_validate_date_start()
  {
    var nomeCampo_date_start = "date_start";
    var var_date_start = scAjaxGetFieldText(nomeCampo_date_start);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_validate_date_start(var_date_start, var_script_case_init, do_ajax_form_academic_i_validate_date_start_cb);
  } // do_ajax_form_academic_i_validate_date_start

  function do_ajax_form_academic_i_validate_date_start_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_validate_date_start_cb

  // ---------- Validate date_to
  function do_ajax_form_academic_i_validate_date_to()
  {
    var nomeCampo_date_to = "date_to";
    var var_date_to = scAjaxGetFieldText(nomeCampo_date_to);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_validate_date_to(var_date_to, var_script_case_init, do_ajax_form_academic_i_validate_date_to_cb);
  } // do_ajax_form_academic_i_validate_date_to

  function do_ajax_form_academic_i_validate_date_to_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_to";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_validate_date_to_cb

  // ---------- Event onblur date_to
  function do_ajax_form_academic_i_event_date_to_onblur()
  {
    var var_date_start = scAjaxGetFieldText("date_start");
    var var_date_to = scAjaxGetFieldText("date_to");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_academic_i_event_date_to_onblur(var_date_start, var_date_to, var_script_case_init, do_ajax_form_academic_i_event_date_to_onblur_cb);
  } // do_ajax_form_academic_i_event_date_to_onblur

  function do_ajax_form_academic_i_event_date_to_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "date_to";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_academic_i_event_date_to_onblur_cb_after_alert);
  } // do_ajax_form_academic_i_event_date_to_onblur_cb
  function do_ajax_form_academic_i_event_date_to_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_academic_i_event_date_to_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_academic_i_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_academic_i_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_academic_i_submit_form(var_level, var_institution_name, var_address, var_date_start, var_date_to, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_academic_i_submit_form_cb);
  } // do_ajax_form_academic_i_submit_form

  function do_ajax_form_academic_i_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_academic_i_submit_form_cb_after_alert);
  } // do_ajax_form_academic_i_submit_form_cb
  function do_ajax_form_academic_i_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_academic_i_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_academic_i_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_academic_i_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_academic_i_navigate_form_cb);
  } // do_ajax_form_academic_i_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_academic_i']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_academic_i_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_academic_i_navigate_form_cb_after_alert);
  } // do_ajax_form_academic_i_navigate_form_cb
  function do_ajax_form_academic_i_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_academic_i_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_academic_i_navigate_form_cb_after_alert
  function sc_hide_form_academic_i_form()
  {
