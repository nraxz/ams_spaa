  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_academic_i_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_academic_i_mob_form();
	}

  // ---------- Validate level
  function do_ajax_form_academic_i_mob_validate_level()
  {
    var nomeCampo_level = "level";
    var var_level = scAjaxGetFieldSelect(nomeCampo_level);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_mob_validate_level(var_level, var_script_case_init, do_ajax_form_academic_i_mob_validate_level_cb);
  } // do_ajax_form_academic_i_mob_validate_level

  function do_ajax_form_academic_i_mob_validate_level_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_mob_validate_level_cb

  // ---------- Validate institution_name
  function do_ajax_form_academic_i_mob_validate_institution_name()
  {
    var nomeCampo_institution_name = "institution_name";
    var var_institution_name = scAjaxGetFieldText(nomeCampo_institution_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_mob_validate_institution_name(var_institution_name, var_script_case_init, do_ajax_form_academic_i_mob_validate_institution_name_cb);
  } // do_ajax_form_academic_i_mob_validate_institution_name

  function do_ajax_form_academic_i_mob_validate_institution_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "institution_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_mob_validate_institution_name_cb

  // ---------- Validate address
  function do_ajax_form_academic_i_mob_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_mob_validate_address(var_address, var_script_case_init, do_ajax_form_academic_i_mob_validate_address_cb);
  } // do_ajax_form_academic_i_mob_validate_address

  function do_ajax_form_academic_i_mob_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_mob_validate_address_cb

  // ---------- Validate date_start
  function do_ajax_form_academic_i_mob_validate_date_start()
  {
    var nomeCampo_date_start = "date_start";
    var var_date_start = scAjaxGetFieldText(nomeCampo_date_start);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_mob_validate_date_start(var_date_start, var_script_case_init, do_ajax_form_academic_i_mob_validate_date_start_cb);
  } // do_ajax_form_academic_i_mob_validate_date_start

  function do_ajax_form_academic_i_mob_validate_date_start_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_start";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_mob_validate_date_start_cb

  // ---------- Validate date_to
  function do_ajax_form_academic_i_mob_validate_date_to()
  {
    var nomeCampo_date_to = "date_to";
    var var_date_to = scAjaxGetFieldText(nomeCampo_date_to);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_academic_i_mob_validate_date_to(var_date_to, var_script_case_init, do_ajax_form_academic_i_mob_validate_date_to_cb);
  } // do_ajax_form_academic_i_mob_validate_date_to

  function do_ajax_form_academic_i_mob_validate_date_to_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_to";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_academic_i_mob_validate_date_to_cb

  // ---------- Event onblur date_to
  function do_ajax_form_academic_i_mob_event_date_to_onblur()
  {
    var var_date_start = scAjaxGetFieldText("date_start");
    var var_date_to = scAjaxGetFieldText("date_to");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_academic_i_mob_event_date_to_onblur(var_date_start, var_date_to, var_script_case_init, do_ajax_form_academic_i_mob_event_date_to_onblur_cb);
  } // do_ajax_form_academic_i_mob_event_date_to_onblur

  function do_ajax_form_academic_i_mob_event_date_to_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "date_to";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_academic_i_mob_event_date_to_onblur_cb_after_alert);
  } // do_ajax_form_academic_i_mob_event_date_to_onblur_cb
  function do_ajax_form_academic_i_mob_event_date_to_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_academic_i_mob_event_date_to_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_academic_i_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_academic_i_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_level = scAjaxGetFieldSelect("level");
    var var_institution_name = scAjaxGetFieldText("institution_name");
    ...
    scAjaxProcOn();
    x_ajax_form_academic_i_mob_submit_form(var_level, var_institution_name, var_address, var_date_start, var_date_to, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_academic_i_mob_submit_form_cb);
  } // do_ajax_form_academic_i_mob_submit_form

  function do_ajax_form_academic_i_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("institution_name");
      scAjaxHideErrorDisplay("address");
      scAjaxHideErrorDisplay("date_start");
      scAjaxHideErrorDisplay("date_to");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_academic_i_mob_submit_form_cb_after_alert);
  } // do_ajax_form_academic_i_mob_submit_form_cb
  function do_ajax_form_academic_i_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_academic_i_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_academic_i_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_academic_i_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_academic_i_mob_navigate_form_cb);
  } // do_ajax_form_academic_i_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_academic_i_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_academic_i_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_academic_i_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_academic_i_mob_navigate_form_cb
  function do_ajax_form_academic_i_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_academic_i_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_academic_i_mob_navigate_form_cb_after_alert
  function sc_hide_form_academic_i_mob_form()
  {
  ...
  ajax_field_list[1] = "institution_name";
  ajax_field_list[2] = "address";
  ajax_field_list[3] = "date_start";
  ajax_field_list[4] = "date_to";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "level": {"label": "Qualification level <br/>(Please include qualifications to be completed)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "institution_name": {"label": "College or School Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "address": {"label": "Address (Include City & Country)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_start": {"label": "Start Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_to": {"label": "End Date (To be completed)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "level": new Array(),
    "institution_name": new Array(),
    "address": new Array(),
    "date_start": new Array(),
    "date_to": new Array()
  };
  ajax_field_mult["level"][1] = "level";
  ajax_field_mult["institution_name"][1] = "institution_name";
  ajax_field_mult["address"][1] = "address";
  ajax_field_mult["date_start"][1] = "date_start";
  ajax_field_mult["date_to"][1] = "date_to";

  var ajax_field_id = {
    "level": new Array("hidden_field_label_level", "hidden_field_data_level"),
    "institution_name": new Array("hidden_field_label_institution_name", "hidden_field_data_institution_name"),
    "address": new Array("hidden_field_label_address", "hidden_field_data_address"),
    "date_start": new Array("hidden_field_label_date_start", "hidden_field_data_date_start"),
    "date_to": new Array("hidden_field_label_date_to", "hidden_field_data_date_to")
  };

  var ajax_read_only = {
    "level": "off",
    "institution_name": "off",
    "address": "off",
    "date_start": "off",
    "date_to": "off"
  };
