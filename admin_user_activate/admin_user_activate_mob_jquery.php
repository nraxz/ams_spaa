...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_active' + iSeqRow).bind('blur', function() { sc_admin_user_activate_active_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_admin_user_activate_active_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_admin_user_activate_active_onblur(oThis, iSeqRow) {
  do_ajax_admin_user_activate_mob_validate_active();
  scCssBlur(oThis);
}

function sc_admin_user_activate_active_onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_admin_user_activate_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_created_at" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_admin_user_activate_mob_validate_created_at(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
