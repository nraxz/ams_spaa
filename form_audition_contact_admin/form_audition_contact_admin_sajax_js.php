  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_audition_contact_admin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_audition_contact_admin_form();
	}

  // ---------- Validate contact_person
  function do_ajax_form_audition_contact_admin_validate_contact_person()
  {
    var nomeCampo_contact_person = "contact_person";
    var var_contact_person = scAjaxGetFieldText(nomeCampo_contact_person);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_contact_admin_validate_contact_person(var_contact_person, var_script_case_init, do_ajax_form_audition_contact_admin_validate_contact_person_cb);
  } // do_ajax_form_audition_contact_admin_validate_contact_person

  function do_ajax_form_audition_contact_admin_validate_contact_person_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_contact_admin_validate_contact_person_cb

  // ---------- Validate email
  function do_ajax_form_audition_contact_admin_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_contact_admin_validate_email(var_email, var_script_case_init, do_ajax_form_audition_contact_admin_validate_email_cb);
  } // do_ajax_form_audition_contact_admin_validate_email

  function do_ajax_form_audition_contact_admin_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_contact_admin_validate_email_cb

  // ---------- Validate phone
  function do_ajax_form_audition_contact_admin_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_contact_admin_validate_phone(var_phone, var_script_case_init, do_ajax_form_audition_contact_admin_validate_phone_cb);
  } // do_ajax_form_audition_contact_admin_validate_phone

  function do_ajax_form_audition_contact_admin_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_contact_admin_validate_phone_cb

  // ---------- Validate website
  function do_ajax_form_audition_contact_admin_validate_website()
  {
    var nomeCampo_website = "website";
    var var_website = scAjaxGetFieldText(nomeCampo_website);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_audition_contact_admin_validate_website(var_website, var_script_case_init, do_ajax_form_audition_contact_admin_validate_website_cb);
  } // do_ajax_form_audition_contact_admin_validate_website

  function do_ajax_form_audition_contact_admin_validate_website_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "website";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_audition_contact_admin_validate_website_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_audition_contact_admin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_audition_contact_admin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_audition_contact_admin_submit_form(var_contact_person, var_email, var_phone, var_website, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_audition_contact_admin_submit_form_cb);
  } // do_ajax_form_audition_contact_admin_submit_form

  function do_ajax_form_audition_contact_admin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_audition_contact_admin_submit_form_cb_after_alert);
  } // do_ajax_form_audition_contact_admin_submit_form_cb
  function do_ajax_form_audition_contact_admin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_audition_contact_admin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_audition_contact_admin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_audition_contact_admin_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_audition_contact_admin_navigate_form_cb);
  } // do_ajax_form_audition_contact_admin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_audition_contact_admin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_audition_contact_admin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_audition_contact_admin_navigate_form_cb_after_alert);
  } // do_ajax_form_audition_contact_admin_navigate_form_cb
  function do_ajax_form_audition_contact_admin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_audition_contact_admin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_audition_contact_admin_navigate_form_cb_after_alert
  function sc_hide_form_audition_contact_admin_form()
  {
