  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_performing_arts_i_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_performing_arts_i_mob_form();
	}

  // ---------- Validate training_examination
  function do_ajax_form_performing_arts_i_mob_validate_training_examination()
  {
    ...
    x_ajax_form_performing_arts_i_mob_validate_training_examination(var_training_examination, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_training_examination_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_training_examination

  function do_ajax_form_performing_arts_i_mob_validate_training_examination_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_training_examination_cb

  // ---------- Validate technical_skills
  function do_ajax_form_performing_arts_i_mob_validate_technical_skills()
  {
    var nomeCampo_technical_skills = "technical_skills";
    var var_technical_skills = scAjaxGetFieldText(nomeCampo_technical_skills);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_technical_skills(var_technical_skills, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_technical_skills_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_technical_skills

  function do_ajax_form_performing_arts_i_mob_validate_technical_skills_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_technical_skills_cb

  // ---------- Validate interest_hobbies
  function do_ajax_form_performing_arts_i_mob_validate_interest_hobbies()
  {
    var nomeCampo_interest_hobbies = "interest_hobbies";
    var var_interest_hobbies = scAjaxGetFieldText(nomeCampo_interest_hobbies);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_interest_hobbies(var_interest_hobbies, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_interest_hobbies_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_interest_hobbies

  function do_ajax_form_performing_arts_i_mob_validate_interest_hobbies_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_interest_hobbies_cb

  // ---------- Validate professional_goal
  function do_ajax_form_performing_arts_i_mob_validate_professional_goal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_professional_goal(var_professional_goal, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_professional_goal_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_professional_goal

  function do_ajax_form_performing_arts_i_mob_validate_professional_goal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_professional_goal_cb

  // ---------- Validate info
  function do_ajax_form_performing_arts_i_mob_validate_info()
  {
  } // do_ajax_form_performing_arts_i_mob_validate_info

  function do_ajax_form_performing_arts_i_mob_validate_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "info";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_info_cb

  // ---------- Validate youtube
  function do_ajax_form_performing_arts_i_mob_validate_youtube()
  {
    var nomeCampo_youtube = "youtube";
    var var_youtube = scAjaxGetFieldText(nomeCampo_youtube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_youtube(var_youtube, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_youtube_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_youtube

  function do_ajax_form_performing_arts_i_mob_validate_youtube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "youtube";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_youtube_cb

  // ---------- Validate other_links
  function do_ajax_form_performing_arts_i_mob_validate_other_links()
  {
    var nomeCampo_other_links = "other_links";
    var var_other_links = scAjaxGetFieldText(nomeCampo_other_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_other_links(var_other_links, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_other_links_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_other_links

  function do_ajax_form_performing_arts_i_mob_validate_other_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_other_links_cb

  // ---------- Validate file_upload
  function do_ajax_form_performing_arts_i_mob_validate_file_upload()
  {
    var nomeCampo_file_upload = "file_upload";
    var var_file_upload = scAjaxGetFieldText(nomeCampo_file_upload);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_mob_validate_file_upload(var_file_upload, var_script_case_init, do_ajax_form_performing_arts_i_mob_validate_file_upload_cb);
  } // do_ajax_form_performing_arts_i_mob_validate_file_upload

  function do_ajax_form_performing_arts_i_mob_validate_file_upload_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_mob_validate_file_upload_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_performing_arts_i_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_performing_arts_i_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_performing_arts_i_mob_submit_form(var_training_examination, var_technical_skills, var_interest_hobbies, var_professional_goal, var_info, var_youtube, var_other_links, var_file_upload, var_login, var_ul_info_file_upload, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_performing_arts_i_mob_submit_form_cb);
  } // do_ajax_form_performing_arts_i_mob_submit_form

  function do_ajax_form_performing_arts_i_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_performing_arts_i_mob_submit_form_cb_after_alert);
  } // do_ajax_form_performing_arts_i_mob_submit_form_cb
  function do_ajax_form_performing_arts_i_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_performing_arts_i_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_performing_arts_i_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_performing_arts_i_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_performing_arts_i_mob_navigate_form_cb);
  } // do_ajax_form_performing_arts_i_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_performing_arts_i_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_performing_arts_i_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_performing_arts_i_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_performing_arts_i_mob_navigate_form_cb
  function do_ajax_form_performing_arts_i_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_performing_arts_i_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_performing_arts_i_mob_navigate_form_cb_after_alert
  function sc_hide_form_performing_arts_i_mob_form()
  {
