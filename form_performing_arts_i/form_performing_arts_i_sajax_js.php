  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_performing_arts_i" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_performing_arts_i_form();
	}

  // ---------- Validate training_examination
  function do_ajax_form_performing_arts_i_validate_training_examination()
  {
    var nomeCampo_training_examination = "training_examination";
    var var_training_examination = scAjaxGetFieldText(nomeCampo_training_examination);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_training_examination(var_training_examination, var_script_case_init, do_ajax_form_performing_arts_i_validate_training_examination_cb);
  } // do_ajax_form_performing_arts_i_validate_training_examination

  function do_ajax_form_performing_arts_i_validate_training_examination_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "training_examination";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_training_examination_cb

  // ---------- Validate technical_skills
  function do_ajax_form_performing_arts_i_validate_technical_skills()
  {
    var nomeCampo_technical_skills = "technical_skills";
    var var_technical_skills = scAjaxGetFieldText(nomeCampo_technical_skills);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_technical_skills(var_technical_skills, var_script_case_init, do_ajax_form_performing_arts_i_validate_technical_skills_cb);
  } // do_ajax_form_performing_arts_i_validate_technical_skills

  function do_ajax_form_performing_arts_i_validate_technical_skills_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "technical_skills";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_technical_skills_cb

  // ---------- Validate interest_hobbies
  function do_ajax_form_performing_arts_i_validate_interest_hobbies()
  {
    var nomeCampo_interest_hobbies = "interest_hobbies";
    var var_interest_hobbies = scAjaxGetFieldText(nomeCampo_interest_hobbies);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_interest_hobbies(var_interest_hobbies, var_script_case_init, do_ajax_form_performing_arts_i_validate_interest_hobbies_cb);
  } // do_ajax_form_performing_arts_i_validate_interest_hobbies

  function do_ajax_form_performing_arts_i_validate_interest_hobbies_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "interest_hobbies";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_interest_hobbies_cb

  // ---------- Validate professional_goal
  function do_ajax_form_performing_arts_i_validate_professional_goal()
  {
    var nomeCampo_professional_goal = "professional_goal";
    var var_professional_goal = scAjaxGetFieldText(nomeCampo_professional_goal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_professional_goal(var_professional_goal, var_script_case_init, do_ajax_form_performing_arts_i_validate_professional_goal_cb);
  } // do_ajax_form_performing_arts_i_validate_professional_goal

  function do_ajax_form_performing_arts_i_validate_professional_goal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "professional_goal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_professional_goal_cb

  // ---------- Validate info
  function do_ajax_form_performing_arts_i_validate_info()
  {
  } // do_ajax_form_performing_arts_i_validate_info

  function do_ajax_form_performing_arts_i_validate_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "info";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_info_cb

  // ---------- Validate youtube
  function do_ajax_form_performing_arts_i_validate_youtube()
  {
    var nomeCampo_youtube = "youtube";
    var var_youtube = scAjaxGetFieldText(nomeCampo_youtube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_youtube(var_youtube, var_script_case_init, do_ajax_form_performing_arts_i_validate_youtube_cb);
  } // do_ajax_form_performing_arts_i_validate_youtube

  function do_ajax_form_performing_arts_i_validate_youtube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "youtube";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_youtube_cb

  // ---------- Validate other_links
  function do_ajax_form_performing_arts_i_validate_other_links()
  {
    var nomeCampo_other_links = "other_links";
    var var_other_links = scAjaxGetFieldText(nomeCampo_other_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_other_links(var_other_links, var_script_case_init, do_ajax_form_performing_arts_i_validate_other_links_cb);
  } // do_ajax_form_performing_arts_i_validate_other_links

  function do_ajax_form_performing_arts_i_validate_other_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "other_links";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_other_links_cb

  // ---------- Validate file_upload
  function do_ajax_form_performing_arts_i_validate_file_upload()
  {
    var nomeCampo_file_upload = "file_upload";
    var var_file_upload = scAjaxGetFieldText(nomeCampo_file_upload);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_performing_arts_i_validate_file_upload(var_file_upload, var_script_case_init, do_ajax_form_performing_arts_i_validate_file_upload_cb);
  } // do_ajax_form_performing_arts_i_validate_file_upload

  function do_ajax_form_performing_arts_i_validate_file_upload_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "file_upload";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_performing_arts_i_validate_file_upload_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_performing_arts_i_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_performing_arts_i_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_training_examination = scAjaxGetFieldText("training_examination");
    var var_technical_skills = scAjaxGetFieldText("technical_skills");
    var var_interest_hobbies = scAjaxGetFieldText("interest_hobbies");
    var var_professional_goal = scAjaxGetFieldText("professional_goal");
    var var_info = scAjaxGetFieldHidden("info");
    var var_youtube = scAjaxGetFieldText("youtube");
    var var_other_links = scAjaxGetFieldText("other_links");
    var var_file_upload = "";
    var var_ul_info_file_upload = scJQMultiUploadPrepare_file_upload();
    ...
    scAjaxProcOn();
    x_ajax_form_performing_arts_i_submit_form(var_training_examination, var_technical_skills, var_interest_hobbies, var_professional_goal, var_info, var_youtube, var_other_links, var_file_upload, var_ul_info_file_upload, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_performing_arts_i_submit_form_cb);
  } // do_ajax_form_performing_arts_i_submit_form

  function do_ajax_form_performing_arts_i_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("training_examination");
      scAjaxHideErrorDisplay("technical_skills");
      scAjaxHideErrorDisplay("interest_hobbies");
      scAjaxHideErrorDisplay("professional_goal");
      scAjaxHideErrorDisplay("info");
      scAjaxHideErrorDisplay("youtube");
      scAjaxHideErrorDisplay("other_links");
      scAjaxHideErrorDisplay("file_upload");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scClearUploadQueue_file_upload('queue');
      scUploadQueue_file_upload = new Array();
      $("#id_sc_upload_done_file_upload" ).html("");
      $("#id_sc_upload_todo_file_upload" ).html("");
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_performing_arts_i_submit_form_cb_after_alert);
  } // do_ajax_form_performing_arts_i_submit_form_cb
  function do_ajax_form_performing_arts_i_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_performing_arts_i_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_performing_arts_i_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_performing_arts_i_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_performing_arts_i_navigate_form_cb);
  } // do_ajax_form_performing_arts_i_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_performing_arts_i']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_performing_arts_i_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scClearUploadQueue_file_upload('all');
    scAjaxSetFields(false);
    scAjaxSetVariables();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_performing_arts_i_navigate_form_cb_after_alert);
  } // do_ajax_form_performing_arts_i_navigate_form_cb
  function do_ajax_form_performing_arts_i_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_performing_arts_i_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_performing_arts_i_navigate_form_cb_after_alert
  function sc_hide_form_performing_arts_i_form()
  {
  ...
  function scClearUploadQueue_file_upload(clearMode)
  {
     if ("all" == clearMode)
     {
        $("#id_sc_upload_done_file_upload").html("");
        $("#id_sc_upload_todo_file_upload").html("");
        $("#id_sc_loaded_file_upload").html("");
     }
     scUploadQueue_file_upload.length = 0;
     var $elemSubmit = $("#id_sc_submit_file_upload");
  ...
  ajax_field_list[0] = "training_examination";
  ajax_field_list[1] = "technical_skills";
  ajax_field_list[2] = "interest_hobbies";
  ajax_field_list[3] = "professional_goal";
  ajax_field_list[4] = "info";
  ajax_field_list[5] = "youtube";
  ajax_field_list[6] = "other_links";
  ajax_field_list[7] = "file_upload";
  ...
  var ajax_error_list = {
    "training_examination": {"label": "Please give details on other training/examination experiences you have had other than schooling? ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "technical_skills": {"label": "Please state any performance or production technical skills you have had?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "interest_hobbies": {"label": "What are your interests/hobbies outside of theatre?  ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "professional_goal": {"label": "Please tell us your professional goals", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "info": {"label": "info", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "youtube": {"label": "Youtube", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "other_links": {"label": "Other Links", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "file_upload": {"label": "Supporting Documents", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "training_examination": new Array(),
    "technical_skills": new Array(),
    "interest_hobbies": new Array(),
    "professional_goal": new Array(),
    "info": new Array(),
    "youtube": new Array(),
    "other_links": new Array(),
    "file_upload": new Array()
  };
  ajax_field_mult["training_examination"][1] = "training_examination";
  ajax_field_mult["technical_skills"][1] = "technical_skills";
  ajax_field_mult["interest_hobbies"][1] = "interest_hobbies";
  ajax_field_mult["professional_goal"][1] = "professional_goal";
  ajax_field_mult["info"][1] = "info";
  ajax_field_mult["youtube"][1] = "youtube";
  ajax_field_mult["other_links"][1] = "other_links";
  ajax_field_mult["file_upload"][1] = "file_upload";

  var ajax_field_id = {
    "training_examination": new Array("hidden_field_label_training_examination", "hidden_field_data_training_examination"),
    "technical_skills": new Array("hidden_field_label_technical_skills", "hidden_field_data_technical_skills"),
    "interest_hobbies": new Array("hidden_field_label_interest_hobbies", "hidden_field_data_interest_hobbies"),
    "professional_goal": new Array("hidden_field_label_professional_goal", "hidden_field_data_professional_goal"),
    ...
    "other_links": new Array("hidden_field_label_other_links", "hidden_field_data_other_links"),
    "file_upload": new Array("hidden_field_label_file_upload", "hidden_field_data_file_upload")
  };

  var ajax_read_only = {
    "training_examination": "off",
    "technical_skills": "off",
    "interest_hobbies": "off",
    "professional_goal": "off",
    "info": "off",
    "youtube": "off",
    "other_links": "off",
    "file_upload": "off"
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("training_examination" == sIndex)
    {
