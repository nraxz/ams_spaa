<?php
@session_start() ;
$_SESSION['scriptcase']['my_audition_examiner']['sc_process_barr'] = true;
require_once('../my_audition_examiner/index.php');
unset($_SESSION['scriptcase']['my_audition_examiner']['sc_process_barr']);
$ExportCtrl = new my_audition_examiner_export_control;
$ExportCtrl->Export_barr();

class my_audition_examiner_export_control
{
