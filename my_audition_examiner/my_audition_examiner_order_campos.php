...
<?php
   ...
   $Ord_Cmp = new my_audition_examiner_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class my_audition_examiner_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select_orig'] = array();
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['my_audition_examiner']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['my_audition_examiner']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['my_audition_examiner']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select']))
   {
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_cmp']    = "";
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "my_audition_examiner_order_campos.php",
    data: {
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['my_audition_examiner']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
