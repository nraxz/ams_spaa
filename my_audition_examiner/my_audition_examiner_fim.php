...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____my_audition_examiner"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SPAA_AMS_____my_audition_examiner"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>my_audition_examiner</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['my_audition_examiner']['embutida_filho'] as $ind => $sc_init)
          {
